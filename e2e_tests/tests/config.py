...
DEFAULT_TF2_CPU_IMAGE = "determinedai/environments-dev:py-3.9-pytorch-1.12-tf-2.11-cpu-2efee6a"
DEFAULT_TF1_GPU_IMAGE = "determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-6eceaca"
DEFAULT_TF2_GPU_IMAGE = "determinedai/environments-dev:cuda-11.3-pytorch-1.12-tf-2.11-gpu-2efee6a"
DEFAULT_PT_CPU_IMAGE = "determinedai/environments-dev:py-3.9-pytorch-1.12-cpu-2efee6a"
DEFAULT_PT_GPU_IMAGE = "determinedai/environments-dev:cuda-11.3-pytorch-1.12-gpu-2efee6a"
DEFAULT_PT2_CPU_IMAGE = "determinedai/environments-dev:py-3.10-pytorch-2.0-cpu-2efee6a"
DEFAULT_PT2_GPU_IMAGE = "determinedai/environments-dev:cuda-11.8-pytorch-2.0-gpu-2efee6a"
