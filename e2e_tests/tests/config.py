...
DEFAULT_TF1_CPU_IMAGE = "determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-254d511"
DEFAULT_TF2_CPU_IMAGE = (
    "determinedai/environments:py-3.7-pytorch-1.7-lightning-1.2-tf-2.4-cpu-254d511"
)
DEFAULT_TF1_GPU_IMAGE = "determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-254d511"
DEFAULT_TF2_GPU_IMAGE = (
    "determinedai/environments:cuda-11.0-pytorch-1.7-lightning-1.2-tf-2.4-gpu-254d511"
)
