...
def test_agent_resource_pool_change(
    managed_cluster_multi_resource_pools: managed_cluster.ManagedCluster,
) -> None:
    admin = api_utils.admin_session()
    try:
        managed_cluster_multi_resource_pools.kill_agent()
        managed_cluster_multi_resource_pools.dc.restart_stage("agent10")
        ...
        managed_cluster_multi_resource_pools.dc.kill_stage("agent10")
...
def test_agent_resource_pool_unchanged(
    ...
    try:
        managed_cluster_multi_resource_pools.kill_agent()
        managed_cluster_multi_resource_pools.dc.restart_stage("agent20")
        ...
        managed_cluster_multi_resource_pools.dc.kill_stage("agent20")
        managed_cluster_multi_resource_pools.restart_agent()
