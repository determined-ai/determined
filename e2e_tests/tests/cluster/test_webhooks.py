   ...
   "blocks":[
      {
         ...
         "text":{
            "type":"plain_text",
            "text":"Your experiment completed successfully 🎉"
         }
      }
   ],
   "attachments":[
    ...
    assert expected_payload["attachments"][0]["color"] == request_to_webhook_endpoint["attachments"][0]["color"]
