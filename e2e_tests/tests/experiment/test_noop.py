...
def do_test_pause_and_nan_validations(time_scale: int) -> None:
    ...
    # Wait at most 20 seconds for the experiment to clear all workloads.
    for _ in range(200):
        ...
        raise ValueError("The experiment cannot be paused within 20 seconds.")
    ...
    for _ in range(200):
        ...
        raise ValueError("The experiment did not reactivate within 20 seconds.")
