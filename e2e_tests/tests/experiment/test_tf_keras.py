...
def test_tf_keras_const_warm_start(tf2: bool, profile_test: Callable[[int], None]) -> None:
...
def test_tf_keras_parallel(
    aggregation_frequency: int, tf2: bool, profile_test: Callable[[int], None]
) -> None:
    config = conf.load_config(conf.cv_examples_path("cifar10_tf_keras/const.yaml"))
...
def test_tf_keras_single_gpu(tf2: bool, profile_test: Callable[[int], None]) -> None:
    config = conf.load_config(conf.cv_examples_path("cifar10_tf_keras/const.yaml"))
...
@pytest.mark.parallel  # type: ignore
def test_tf_keras_mnist_parallel(profile_test: Callable[[int], None]) -> None:
...
def test_tf_keras_tf2_disabled(profile_test: Callable[[int], None]) -> None:
...
def test_tf_keras_mnist_data_layer_lfs(tf2: bool, profile_test: Callable[[int], None]) -> None:
...
def test_tf_keras_mnist_data_layer_s3(
    tf2: bool, storage_type: str, profile_test: Callable[[int], None]
) -> None:
...
@pytest.mark.parallel  # type: ignore
def run_tf_keras_dcgan_example(profile_test: Callable[[int], None]) -> None:
