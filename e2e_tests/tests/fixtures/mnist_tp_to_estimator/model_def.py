...
from determined.estimator import EstimatorTrial, EstimatorTrialContext, RunHook
...
class MnistTensorpackInEstimator(EstimatorTrial):
    ...
    def build_train_spec(self) -> tf.estimator.TrainSpec:
        return tf.estimator.TrainSpec(
            lambda: self._dataflow_to_dataset(True), hooks=[MyHook(self.context)]
        )
