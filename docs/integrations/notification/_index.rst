...
-  Trigger: the experiment state change you want to monitor, either ``Completed``, ``Error``, or ``Tasklog``.
-  Regex: If the webhook is configured to trigger on Tasklog, define a regex using `Golang Regex Syntax <https://pkg.go.dev/regexp/syntax>`
