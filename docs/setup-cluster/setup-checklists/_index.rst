...
.. note::
   ...
   For basic installation instructions, visit :ref:`basic`.

***************
 Prerequisites
***************

To follow this checklist, your system must first meet :ref:`requirements
...
configuring checkpoint storage, setting up resource pools (SAME AS COMPUTE RESOURCES?), and
...
-  Configure the :ref:`agents <agent-config-reference>` to establish a connection to the Determined
   master.
-  Link the agents with their respective resource pools. For details, visit
...
connect to the Determined master. Now you can explore Determined's features!
