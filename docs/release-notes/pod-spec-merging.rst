...
-  Kubernetes: When a pod spec is specified in both ``task_container_defaults`` and in the experiment/job
   configuration, the pod spec is merged according to `strategic merge patch
