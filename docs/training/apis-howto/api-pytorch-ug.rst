...
periods, validation periods, and checkpointing policy. See the :doc:`Pytorch Trainer API reference
document </reference/reference-training/training/api-pytorch-trainer-reference>` for the full list
of arguments.
