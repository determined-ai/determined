...
-  ``determinedai/environments:cuda-11.3-pytorch-1.12-tf-2.8-gpu-0.19.11`` (default)
-  ``determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-0.19.11``
-  ``determinedai/environments:cuda-11.2-pytorch-1.12-tf-2.7-gpu-0.19.11``

We also provide lightweight CPU-only counterparts:

-  ``determinedai/environments:py-3.8-pytorch-1.12-tf-2.8-cpu-0.19.11``
-  ``determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-0.19.11``
-  ``determinedai/environments:py-3.8-pytorch-1.12-tf-2.7-cpu-0.19.11``
...
-  ``determinedai/environments:rocm-5.0-pytorch-1.10-tf-2.7-rocm-0.19.11``
