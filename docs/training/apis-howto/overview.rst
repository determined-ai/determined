...
-  ``determinedai/environments:cuda-11.3-pytorch-1.10-tf-2.8-gpu-0.18.5`` (default)
-  ``determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-0.18.5``
-  ``determinedai/environments:cuda-11.2-tf-2.5-gpu-0.18.5``
-  ``determinedai/environments:cuda-11.2-tf-2.6-gpu-0.18.5``
-  ``determinedai/environments:cuda-11.2-tf-2.7-gpu-0.18.5``

We also provide lightweight CPU-only counterparts:

-  ``determinedai/environments:py-3.8-pytorch-1.10-tf-2.8-cpu-0.18.5``
-  ``determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-0.18.5``
-  ``determinedai/environments:py-3.8-tf-2.5-cpu-0.18.5``
-  ``determinedai/environments:py-3.8-tf-2.6-cpu-0.18.5``
-  ``determinedai/environments:py-3.8-tf-2.7-cpu-0.18.5``
...
-  ``determinedai/environments:rocm-4.2-pytorch-1.9-tf-2.5-rocm-0.18.5``
