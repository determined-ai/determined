...
with a Determined cluster. The CLI should be installed on any machine where a user would like to access Determined. To install the CLI, follow the :ref:`installation <install-cli>` instructions.
