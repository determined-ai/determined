...
.. code::
   ...
   det deploy gcp up --cluster-id CLUSTER_ID --project-id PROJECT_ID \
      ...
      --gpu-env-image determinedai/environments:cuda-11.3-pytorch-1.12-tf-2.12-gpu-0.21.2 \
      --cpu-env-image determinedai/environments:py-3.8-pytorch-1.12-tf-2.12-cpu-0.21.2
