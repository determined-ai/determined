...
Reference documentation: `Determined API <../../rest-api/index.html>`__.
...
The :doc:`/intro/det-if/rest-api` user guide shows a basic example of how to authenticate and use the API. You can also log in using the WebUI.
