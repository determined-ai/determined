...
.. code::
   ...
   det deploy gcp up --cluster-id CLUSTER_ID --project-id PROJECT_ID \
      ...
      --gpu-env-image determinedai/environments:cuda-11.3-pytorch-1.10-lightning-1.5-tf-2.8-gpu-0.18.2 \
      --cpu-env-image determinedai/environments:py-3.8-pytorch-1.10-lightning-1.5-tf-2.8-cpu-0.18.2
