...
#. Click the **Experiment** tile to view the experiment’s trial display. The loss curve is similar
...
#. The experiment can take some time to complete. You can monitor progress in the WebUI Dashboard by
   clicking the **Experiment** tile. Notice that more trials have started:
