...
+=============+===================================================================================+
| CPUs        | ``determinedai/environments:py-3.8-pytorch-1.12-tf-2.11-cpu-0.23.3``              |
+-------------+-----------------------------------------------------------------------------------+
| NVIDIA GPUs | ``determinedai/environments:cuda-11.3-pytorch-1.12-tf-2.11-gpu-0.23.3``           |
+-------------+-----------------------------------------------------------------------------------+
| AMD GPUs    | ``determinedai/environments:rocm-5.0-pytorch-1.10-tf-2.7-rocm-0.23.3``            |
+-------------+-----------------------------------------------------------------------------------+
...
.. code:: bash
   ...
   # Determined Image
   FROM determinedai/environments:cuda-11.3-pytorch-1.12-tf-2.11-gpu-0.23.3
...
.. code:: bash
   ...
   # Determined Image
   FROM determinedai/environments:py-3.8-pytorch-1.12-tf-2.11-cpu-0.23.3
