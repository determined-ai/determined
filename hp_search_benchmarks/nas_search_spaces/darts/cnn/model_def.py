...
# These imports will be from the darts/cnn module.
# The darts repo will be cloned in the startup-hooks.sh script.
...
class DARTSCNNTrial(PyTorchTrial):
    ...
    def train_batch(
        ...
        model.drop_path_prob = (
            self.hparams["drop_path_prob"] * epoch_idx / self.hparams["train_epochs"]
        )
