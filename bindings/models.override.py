...
#     job_summary: "Optional[V1JobSummary]" = Field(None, alias="jobSummary")
...
#     uuid: "Optional[str]" = Field(None, alias="uuid")
#     type: "Optional[Determineddevicev1Type]" = Field(None, alias="type")
...
class V1GetJobQueueStatsResponse(BaseModel):
    results: "Optional[List[V1RPQueueStat]]" = Field(None, alias="results")


class V1GetJobsResponse(BaseModel):
    pagination: "Optional[V1Pagination]" = Field(None, alias="pagination")
    jobs: "Optional[List[V1Job]]" = Field(None, alias="jobs")
...
class V1Job(BaseModel):
    summary: "Optional[V1JobSummary]" = Field(None, alias="summary")
    type: "Optional[Determinedjobv1Type]" = Field(None, alias="type")
    submission_time: "Optional[datetime]" = Field(None, alias="submissionTime")
    user: "Optional[str]" = Field(None, alias="user")
    resource_pool: "Optional[str]" = Field(None, alias="resourcePool")
    is_preemptible: "Optional[bool]" = Field(None, alias="isPreemptible")
...
class V1JobSummary(BaseModel):
    ...
    state: "Optional[Determinedjobv1State]" = Field(None, alias="state")


# class V1K8PriorityClass(BaseModel):
#     priority_class: "Optional[str]" = Field(None, alias="priorityClass")
#     priority_value: "Optional[int]" = Field(None, alias="priorityValue")
...
class V1QueueStats(BaseModel):
    queued_count: "Optional[int]" = Field(None, alias="queuedCount")
    scheduled_count: "Optional[int]" = Field(None, alias="scheduledCount")
    preemptible_count: "Optional[int]" = Field(None, alias="preemptibleCount")
...
#     slot_type: "Determineddevicev1Type" = Field(..., alias="slotType")
...
#     k8_priorities: "Optional[List[V1K8PriorityClass]]" = Field(None, alias="k8Priorities")
...
class V1RPQueueStat(BaseModel):
    stats: "Optional[V1QueueStats]" = Field(None, alias="stats")
    resource_pool: "Optional[str]" = Field(None, alias="resourcePool")
