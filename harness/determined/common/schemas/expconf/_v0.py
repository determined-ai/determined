...
class EnvironmentImageV0(schemas.SchemaBase):
    ...
    def runtime_defaults(self) -> None:
        if self.cpu is None:
            self.cpu = "determinedai/environments:py-3.7-pytorch-1.7-lightning-1.2-tf-2.4-cpu-da845fc"
        if self.gpu is None:
            self.gpu = "determinedai/environments:cuda-11.0-pytorch-1.7-lightning-1.2-tf-2.4-gpu-da845fc"
