...
class Determined:
    ...
    def create_experiment(
        ...
        Arguments:
            ...
            project_id(int, optional): The id of the project this experiment should belong to. (default: ``None``)
            template(string, optional): The name of the tamplate for the experiment. (default: ``None``)
        """
