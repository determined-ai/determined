...
def _add_samples(collection: Collection, reading: Reading, timestamp: float) -> None:
...
class _MetricGroupCollector(metaclass=abc.ABCMeta):
    ...
    def add_sample(self) -> None:
        """Take a reading and add it to metric samples."""
        _add_samples(self.metric_samples, self.take_reading(), time.time())
