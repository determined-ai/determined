...
class DeterminedCallback(callbacks.ProgbarLogger):  # type: ignore
    ...
    def __init__(
        ...
        *,
        ...
        self._is_verbose = 0  # Configured by .set_params().
    ...
    def set_params(self, params: Dict[str, Any]) -> None:
        ...
        self._is_verbose = params.get("verbose", 0) != 0
    ...
    def on_epoch_end(self, epoch: int, logs: Optional[Dict[str, Any]]) -> None:
        ...
        if self._is_chief and self._report_period == "epoch":
            ...
            train_only = {k: v for k, v in logs.items() if not k.startswith("val_")}
            self._core.train.report_metrics("training", self._steps_completed, train_only)
    ...
    def on_test_end(self, logs: Optional[Dict[str, Any]]) -> None:
        ...
        assert logs
        self._core.train.report_metrics("validation", self._steps_completed, logs)
