...
from determined import debug, log, workload
...
class ProfilingLayer(workload.Source):
    ...
    def __init__(
        ...
        self.profiler = debug.Profiler(system_level_metrics, process_level_metrics)

        # Start profiling immediately, to capture behavior of startup costs (importing tensorflow,
        # for instance).
        self.thread = debug.ProfilingThread(self.period, self.profile)
        self.thread.start()
