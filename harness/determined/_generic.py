...
class _GenericContext:
    ...
    Today, _GenericContext is a storage place for objects which will probably be needed for the
    Generic API but which are also used in the old layers architecture.
    """
