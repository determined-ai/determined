...
class TestDeepSpeedTrial:
    ...
    def test_manual_init_distributed(self):
        updated_hparams = copy.deepcopy(self.hparams)
        ...
        os.environ["MANUAL_INIT_DISTRIBUTED"] = ""
    ...
    def test_fail_multiple_wrap_mpu(self):
        def make_workloads() -> workload.Stream:
            trainer = utils.TrainAndValidate()
...
def test_fail_overwrite_deepspeed_config() -> None:
    base_ds_config = deepspeed_config
    source_ds_config = {
        "train_micro_batch_size_per_gpu": 2,
        "optimizer": {"params": {"lr": 0.001}},
