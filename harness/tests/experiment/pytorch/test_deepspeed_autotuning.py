...
from determined.pytorch.deepspeed.dsat import autotune
...
def test_autotune_config(
    ...
    # Test the autotune.py functionality to set up the RemoteSearcher
    ...
    called_config = create_experiment_mock.call_args_list[0].kwargs["config"]
    # The Search Runner should be defaulted to a "single" searcher
    assert called_config.get("searcher", {}).get("name", "") == "single"
    # TODO: Assert some more things


def test_simple_search_method() -> None:
    pass
