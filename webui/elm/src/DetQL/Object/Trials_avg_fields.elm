...
module DetQL.Object.Trials_avg_fields exposing (..)
...
experiment_id : SelectionSet (Maybe Float) DetQL.Object.Trials_avg_fields
experiment_id =
    Object.selectionForField "(Maybe Float)" "experiment_id" [] (Decode.float |> Decode.nullable)


id : SelectionSet (Maybe Float) DetQL.Object.Trials_avg_fields
id =
    Object.selectionForField "(Maybe Float)" "id" [] (Decode.float |> Decode.nullable)


seed : SelectionSet (Maybe Float) DetQL.Object.Trials_avg_fields
seed =
    Object.selectionForField "(Maybe Float)" "seed" [] (Decode.float |> Decode.nullable)


warm_start_checkpoint_id : SelectionSet (Maybe Float) DetQL.Object.Trials_avg_fields
