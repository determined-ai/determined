...
module DetQL.Object.Steps_var_pop_fields exposing (..)
...
id : SelectionSet (Maybe Float) DetQL.Object.Steps_var_pop_fields
id =
    Object.selectionForField "(Maybe Float)" "id" [] (Decode.float |> Decode.nullable)


trial_id : SelectionSet (Maybe Float) DetQL.Object.Steps_var_pop_fields
trial_id =
