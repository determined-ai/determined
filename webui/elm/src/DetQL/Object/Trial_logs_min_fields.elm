...
module DetQL.Object.Trial_logs_min_fields exposing (..)
...
id : SelectionSet (Maybe Int) DetQL.Object.Trial_logs_min_fields
id =
    Object.selectionForField "(Maybe Int)" "id" [] (Decode.int |> Decode.nullable)


trial_id : SelectionSet (Maybe Int) DetQL.Object.Trial_logs_min_fields
trial_id =
