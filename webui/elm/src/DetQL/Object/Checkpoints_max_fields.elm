...
module DetQL.Object.Checkpoints_max_fields exposing (..)
...
end_time : SelectionSet (Maybe CustomScalarCodecs.Timestamptz) DetQL.Object.Checkpoints_max_fields
end_time =
...
id : SelectionSet (Maybe Int) DetQL.Object.Checkpoints_max_fields
id =
    Object.selectionForField "(Maybe Int)" "id" [] (Decode.int |> Decode.nullable)


start_time : SelectionSet (Maybe CustomScalarCodecs.Timestamptz) DetQL.Object.Checkpoints_max_fields
start_time =
...
step_id : SelectionSet (Maybe Int) DetQL.Object.Checkpoints_max_fields
step_id =
    Object.selectionForField "(Maybe Int)" "step_id" [] (Decode.int |> Decode.nullable)


trial_id : SelectionSet (Maybe Int) DetQL.Object.Checkpoints_max_fields
trial_id =
