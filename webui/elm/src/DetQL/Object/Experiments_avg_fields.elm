...
module DetQL.Object.Experiments_avg_fields exposing (..)
...
id : SelectionSet (Maybe Float) DetQL.Object.Experiments_avg_fields
id =
    Object.selectionForField "(Maybe Float)" "id" [] (Decode.float |> Decode.nullable)


owner_id : SelectionSet (Maybe Float) DetQL.Object.Experiments_avg_fields
owner_id =
    Object.selectionForField "(Maybe Float)" "owner_id" [] (Decode.float |> Decode.nullable)


parent_id : SelectionSet (Maybe Float) DetQL.Object.Experiments_avg_fields
parent_id =
    Object.selectionForField "(Maybe Float)" "parent_id" [] (Decode.float |> Decode.nullable)


progress : SelectionSet (Maybe Float) DetQL.Object.Experiments_avg_fields
progress =
