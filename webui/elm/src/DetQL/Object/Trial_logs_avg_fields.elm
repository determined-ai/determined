...
module DetQL.Object.Trial_logs_avg_fields exposing (..)
...
id : SelectionSet (Maybe Float) DetQL.Object.Trial_logs_avg_fields
id =
    Object.selectionForField "(Maybe Float)" "id" [] (Decode.float |> Decode.nullable)


trial_id : SelectionSet (Maybe Float) DetQL.Object.Trial_logs_avg_fields
trial_id =
