...
const initState: State = {
  ...
  userRoles: [{
      ...
      "permissions": [
        {
          "id": "PERMISSION_TYPE_CREATE_EXPERIMENT",
          "name": "create experiment",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_UPDATE_EXPERIMENT",
          "name": "update experiment",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_VIEW_PROJECT",
          "name": "view project",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_UPDATE_ROLES",
          "name": "update roles",
          "isGlobal": true
        },
        {
          "id": "PERMISSION_TYPE_UPDATE_EXPERIMENT_METADATA",
          "name": "update experiment metadata",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_UPDATE_GROUP",
          "name": "update group",
          "isGlobal": true
        },
        {
        ...
        {
          "id": "PERMISSION_TYPE_DELETE_WORKSPACE",
          "name": "delete workspace",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_UPDATE_PROJECT",
          "name": "update project",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_DELETE_PROJECT",
          "name": "delete project",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_ASSIGN_ROLES",
          "name": "assign roles",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_ADMINISTRATE_USER",
          "name": "administrate user",
          "isGlobal": true
        },
        {
          "id": "PERMISSION_TYPE_VIEW_EXPERIMENT_ARTIFACTS",
          "name": "view experiment artifacts",
          "isGlobal": false
        },
        {
        ...
        {
          "id": "PERMISSION_TYPE_VIEW_EXPERIMENT_METADATA",
          "name": "view experiment metadata",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_DELETE_EXPERIMENT",
          "name": "delete experiment",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_VIEW_WORKSPACE",
          "name": "view workspace",
          "isGlobal": false
        },
        {
          "id": "PERMISSION_TYPE_CREATE_PROJECT",
          "name": "create project",
          "isGlobal": false
        }
      ]
