  ...
  const columns = useMemo(() => {
    ...
    return [
      ...
      },
      {
        ...
        key: V1GetExperimentsRequestSortBy.FORKED_FROM,
        onCell: onRightClickableCell,
      ...
      },
      {
        ...
        key: V1GetExperimentsRequestSortBy.START_TIME,
        onCell: onRightClickableCell,
      ...
      },
      {
        ...
        key: V1GetExperimentsRequestSortBy.NUM_TRIALS,
        onCell: onRightClickableCell,
        sorter: true,
        title: 'Trials',
      },
      ...
      },
      {
        ...
        key: V1GetExperimentsRequestSortBy.RESOURCE_POOL,
        onCell: onRightClickableCell,
        sorter: true,
        title: 'Resource Pool',
      },
