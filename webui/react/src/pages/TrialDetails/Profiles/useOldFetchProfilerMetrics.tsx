...
const DEFAULT_DATA: OldMetricsAggregateInterface = {
  isEmpty: true,
  isLoading: true,
  names: ['batch'],
};
...
export const useOldFetchProfilerMetrics = (
  trialId: number,
  trialState: RunState,
...
): OldMetricsAggregateInterface => {
  const { ui } = useUI();
  const [data, setData] = useState<OldMetricsAggregateInterface>(clone(DEFAULT_DATA));
