...
test.describe('Workspaces', () => {
  ...
  test.describe('Workspace with Button', () => {
    ...
    test.describe('Project', () => {
      ...
      // test('Projects archival and pinning', async ({ authedPage }) => {
  ...
  test('Workspace with Sidebar', async ({ authedPage }) => {
    ...
    await test.step('Create a Workspace from Sidebar', async () => {
      ...
      await workspaceList.cardByName(wsCreatedWithSidebar).pwLocator.waitFor();
    });
