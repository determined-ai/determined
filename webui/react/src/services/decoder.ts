...
export const mapV1Model = (model: Sdk.V1Model): types.ModelItem => {
  return {
    ...
    metadata: model.metadata as types.Metadata,
    name: model.name,
    notes: model.notes,
...
export const mapV1ModelVersion = (modelVersion: Sdk.V1ModelVersion): types.ModelVersion => {
  return {
    ...
    metadata: modelVersion.metadata as types.Metadata,
...
const experimentStateMap = {
  ...
  [Sdk.Determinedexperimentv1State.STOPPING_CANCELED]: types.RunState.StoppingCanceled,
  [Sdk.Determinedexperimentv1State.STOPPING_COMPLETED]: types.RunState.StoppingCompleted,
  [Sdk.Determinedexperimentv1State.STOPPING_ERROR]: types.RunState.StoppingError,
  ...
  [Sdk.Determinedexperimentv1State.DELETE_FAILED]: types.RunState.DeleteFailed,
  [Sdk.Determinedexperimentv1State.STOPPING_KILLED]: types.RunState.StoppingCanceled,
...
export const decodeCheckpoint = (data: Sdk.V1Checkpoint): types.CoreApiGenericCheckpoint => {
  ...
  return {
    ...
    experimentConfig: data.training.experimentConfig as types.ExperimentConfig,
    experimentId: data.training.experimentId,
    hparams: data.training.hparams as types.TrialHyperparameters,
    metadata: data.metadata as types.Metadata,
    ...
    taskId: data.taskId,
    totalBatches: (data.metadata as Record<string, any>)['steps_completed'] ?? 0,
...
export const decodeV1TrialToTrialItem = (data: Sdk.Trialv1Trial): types.TrialItem => {
  return {
    ...
    hyperparameters: flattenObject(data.hparams as types.TrialHyperparameters),
    id: data.id,
...
export const mapWorkspaceState = (state: Sdk.V1WorkspaceState): types.WorkspaceState => {
  return {
    ...
    [Sdk.V1WorkspaceState.DELETE_FAILED]: types.WorkspaceState.DeleteFailed,
