...
/**
 * Check if a given object implements the V1GetTrialCheckpointsResponse interface.
 */
export function instanceOfV1GetTrialCheckpointsResponse(value: object): boolean {
    let isInstance = true;
...
export function V1GetTrialCheckpointsResponseFromJSON(json: any): V1GetTrialCheckpointsResponse {
    return V1GetTrialCheckpointsResponseFromJSONTyped(json, false);
}

export function V1GetTrialCheckpointsResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1GetTrialCheckpointsResponse {
...
export function V1GetTrialCheckpointsResponseToJSON(value?: V1GetTrialCheckpointsResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
