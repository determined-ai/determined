...
/**
 * Check if a given object implements the V1GetRolesAssignedToGroupResponse interface.
 */
export function instanceOfV1GetRolesAssignedToGroupResponse(value: object): boolean {
    let isInstance = true;
...
export function V1GetRolesAssignedToGroupResponseFromJSON(json: any): V1GetRolesAssignedToGroupResponse {
    return V1GetRolesAssignedToGroupResponseFromJSONTyped(json, false);
}

export function V1GetRolesAssignedToGroupResponseFromJSONTyped(json: any, ignoreDiscriminator: boolean): V1GetRolesAssignedToGroupResponse {
...
export function V1GetRolesAssignedToGroupResponseToJSON(value?: V1GetRolesAssignedToGroupResponse | null): any {
    if (value === undefined) {
        return undefined;
    }
    if (value === null) {
