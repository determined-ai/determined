...
describe("ExperimentsApi", () => {
  ...
  test("trialLogs", () => {
    ...
    const rankIds: Array<string> = undefined
    return expect(instance.trialLogs(trialId, limit, follow, agentIds, containerIds, levels, stdtypes, sources, timestampBefore, timestampAfter, orderBy, searchText, rankIds, {})).resolves.toBe(null)
  })
...
describe("JobsApi", () => {
  ...
  test("taskLogs", () => {
    ...
    const searchText: string = "searchText_example"
    const rankIds: Array<string> = undefined
    return expect(instance.taskLogs(taskId, limit, follow, allocationIds, agentIds, containerIds, levels, stdtypes, sources, timestampBefore, timestampAfter, orderBy, searchText, rankIds, {})).resolves.toBe(null)
  })
  test("taskLogsFields", () => {
    const taskId: string = "taskId_example"
    const follow: boolean = true
...
describe("ModelsApi", () => {
  ...
  test("deleteModelVersion", () => {
    const modelName: string = "modelName_example"
    const modelVersionId: number = 56
    return expect(instance.deleteModelVersion(modelName, modelVersionId, {})).resolves.toBe(null)
  })
  test("getModel", () => {
    const modelName: string = "modelName_example"
  ...
  test("getModelVersion", () => {
    const modelName: string = "modelName_example"
    const modelVersion: number = 56
    return expect(instance.getModelVersion(modelName, modelVersion, {})).resolves.toBe(null)
  })
  ...
  test("patchModelVersion", () => {
    ...
    const modelName: string = "modelName_example"
    const modelVersionId: number = 56
    return expect(instance.patchModelVersion(body, modelName, modelVersionId, {})).resolves.toBe(null)
  })
  test("postModel", () => {
