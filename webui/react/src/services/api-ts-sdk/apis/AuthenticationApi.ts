...
export class AuthenticationApi extends runtime.BaseAPI {
     ...
     * Login the user.
     */
    async login(body: V1LoginRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1LoginResponse> {
        const response = await this.loginRaw({ body: body }, initOverrides);
        return await response.value();
    }
