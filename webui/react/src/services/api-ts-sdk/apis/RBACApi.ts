...
export class RBACApi extends runtime.BaseAPI {
     ...
     * AssignRoles adds a set of role assignments to the system.
     */
    async assignRoles(body: V1AssignRolesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.assignRolesRaw({ body: body }, initOverrides);
     ...
     * Get groups and users assigned to a given workspace with what roles are assigned.
     */
    async getGroupsAndUsersAssignedToWorkspace(workspaceId: number, name?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetGroupsAndUsersAssignedToWorkspaceResponse> {
        const response = await this.getGroupsAndUsersAssignedToWorkspaceRaw({ workspaceId: workspaceId, name: name }, initOverrides);
        return await response.value();
    }
     ...
     * Get the roles which are assigned to a group.
     */
    async getRolesAssignedToGroup(groupId: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetRolesAssignedToGroupResponse> {
        const response = await this.getRolesAssignedToGroupRaw({ groupId: groupId }, initOverrides);
        return await response.value();
    }
     ...
     * Get the roles which are assigned to a user.
     */
    async getRolesAssignedToUser(userId: number, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetRolesAssignedToUserResponse> {
        const response = await this.getRolesAssignedToUserRaw({ userId: userId }, initOverrides);
        return await response.value();
    }
     ...
     * Get a set of roles with the corresponding IDs.
     */
    async getRolesByID(body: V1GetRolesByIDRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetRolesByIDResponse> {
        const response = await this.getRolesByIDRaw({ body: body }, initOverrides);
        return await response.value();
    }
     ...
     * ListRoles returns roles and groups/users granted that role.
     */
    async listRoles(body: V1ListRolesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1ListRolesResponse> {
        const response = await this.listRolesRaw({ body: body }, initOverrides);
        return await response.value();
    }
     ...
     * RemoveAssignments removes a set of role assignments from the system.
     */
    async removeAssignments(body: V1RemoveAssignmentsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.removeAssignmentsRaw({ body: body }, initOverrides);
        return await response.value();
    }
     ...
     * Search for roles assignable to a given scope.
     */
    async searchRolesAssignableToScope(body: V1SearchRolesAssignableToScopeRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SearchRolesAssignableToScopeResponse> {
        const response = await this.searchRolesAssignableToScopeRaw({ body: body }, initOverrides);
        return await response.value();
    }
