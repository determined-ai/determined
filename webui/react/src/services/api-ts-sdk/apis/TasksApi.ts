...
import {
    ...
    V1GetActiveTasksCountResponseFromJSON,
    V1GetActiveTasksCountResponseToJSON,
    V1GetTaskResponseFromJSON,
    V1GetTaskResponseToJSON,
} from '../models';
...
export class TasksApi extends runtime.BaseAPI {
     ...
     */
    async getActiveTasksCountRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1GetActiveTasksCountResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1GetActiveTasksCountResponseFromJSON(jsonValue));
    }

    /**
     * Get a count of active tasks.
     */
    async getActiveTasksCount(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetActiveTasksCountResponse> {
        const response = await this.getActiveTasksCountRaw(initOverrides);
     ...
     */
    async getTaskRaw(requestParameters: GetTaskRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<V1GetTaskResponse>> {
        ...
        return new runtime.JSONApiResponse(response, (jsonValue) => V1GetTaskResponseFromJSON(jsonValue));
    }

    /**
     * Check the status of a requested task.
     */
    async getTask(requestParameters: GetTaskRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetTaskResponse> {
