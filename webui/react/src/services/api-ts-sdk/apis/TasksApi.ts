...
export class TasksApi extends runtime.BaseAPI {
     ...
     * Check the status of a requested task.
     */
    async getTask(taskId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetTaskResponse> {
        const response = await this.getTaskRaw({ taskId: taskId }, initOverrides);
        return await response.value();
    }
