...
export class WebhooksApi extends runtime.BaseAPI {
     ...
     * Create a webhook. TODO(???): Simplify req/response structs?
     */
    async postWebhook(requestParameters: PostWebhookRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PostWebhookResponse> {
     ...
     * Test a webhook.
     */
    async testWebhook(requestParameters: TestWebhookRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1TestWebhookResponse> {
