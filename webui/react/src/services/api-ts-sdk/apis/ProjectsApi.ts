...
export class ProjectsApi extends runtime.BaseAPI {
     ...
     * Add a note to a project.
     */
    async addProjectNote(requestParameters: AddProjectNoteRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1AddProjectNoteResponse> {
        const response = await this.addProjectNoteRaw(requestParameters, initOverrides);
     ...
     * Archive a project.
     */
    async archiveProject(requestParameters: ArchiveProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     * Delete a project.
     */
    async deleteProject(requestParameters: DeleteProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1DeleteProjectResponse> {
     ...
     * Get the requested project.
     */
    async getProject(requestParameters: GetProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetProjectResponse> {
     ...
     * Move a project into a workspace.
     */
    async moveProject(requestParameters: MoveProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.moveProjectRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update a project.
     */
    async patchProject(requestParameters: PatchProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PatchProjectResponse> {
     ...
     * Create a project.
     */
    async postProject(requestParameters: PostProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PostProjectResponse> {
     ...
     * Set project notes.
     */
    async putProjectNotes(requestParameters: PutProjectNotesRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PutProjectNotesResponse> {
        const response = await this.putProjectNotesRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Unarchive a project.
     */
    async unarchiveProject(requestParameters: UnarchiveProjectRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.unarchiveProjectRaw(requestParameters, initOverrides);
        return await response.value();
    }
