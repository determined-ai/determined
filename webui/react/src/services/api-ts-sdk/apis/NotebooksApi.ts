...
export class NotebooksApi extends runtime.BaseAPI {
     ...
     * Get the requested notebook.
     */
    async getNotebook(notebookId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetNotebookResponse> {
        const response = await this.getNotebookRaw({ notebookId: notebookId }, initOverrides);
     ...
     * Get a list of notebooks.
     */
    async getNotebooks(sortBy?: GetNotebooksSortByEnum, orderBy?: GetNotebooksOrderByEnum, offset?: number, limit?: number, users?: Array<string>, userIds?: Array<number>, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetNotebooksResponse> {
        const response = await this.getNotebooksRaw({ sortBy: sortBy, orderBy: orderBy, offset: offset, limit: limit, users: users, userIds: userIds }, initOverrides);
        return await response.value();
    }
     ...
     * Kill the requested notebook.
     */
    async killNotebook(notebookId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1KillNotebookResponse> {
        const response = await this.killNotebookRaw({ notebookId: notebookId }, initOverrides);
        return await response.value();
    }
     ...
     * Launch a notebook.
     */
    async launchNotebook(body: V1LaunchNotebookRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1LaunchNotebookResponse> {
        const response = await this.launchNotebookRaw({ body: body }, initOverrides);
        return await response.value();
    }
     ...
     * Set the priority of the requested notebook.
     */
    async setNotebookPriority(notebookId: string, body: V1SetNotebookPriorityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SetNotebookPriorityResponse> {
        const response = await this.setNotebookPriorityRaw({ notebookId: notebookId, body: body }, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetNotebooksSortByEnum = {
    UNSPECIFIED: 'SORT_BY_UNSPECIFIED',
    ID: 'SORT_BY_ID',
    DESCRIPTION: 'SORT_BY_DESCRIPTION',
    START_TIME: 'SORT_BY_START_TIME'
} as const;
export type GetNotebooksSortByEnum = typeof GetNotebooksSortByEnum[keyof typeof GetNotebooksSortByEnum];
/**
 * @export
 */
export const GetNotebooksOrderByEnum = {
    UNSPECIFIED: 'ORDER_BY_UNSPECIFIED',
    ASC: 'ORDER_BY_ASC',
    DESC: 'ORDER_BY_DESC'
} as const;
export type GetNotebooksOrderByEnum = typeof GetNotebooksOrderByEnum[keyof typeof GetNotebooksOrderByEnum];
