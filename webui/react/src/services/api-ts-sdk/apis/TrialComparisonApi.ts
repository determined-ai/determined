...
export class TrialComparisonApi extends runtime.BaseAPI {
     ...
     * Create a Trial Collection for a set of TrialFilters.
     */
    async createTrialsCollection(requestParameters: CreateTrialsCollectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1CreateTrialsCollectionResponse> {
        const response = await this.createTrialsCollectionRaw(requestParameters, initOverrides);
     ...
     * Removes a TrialCollection.
     */
    async deleteTrialsCollection(requestParameters: DeleteTrialsCollectionRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.deleteTrialsCollectionRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Return all collectiions for a specific project.
     */
    async getTrialsCollections(requestParameters: GetTrialsCollectionsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetTrialsCollectionsResponse> {
        const response = await this.getTrialsCollectionsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Modify collection attributes: name, filters, etc.
     */
    async patchTrialsCollection(requestParameters: PatchTrialsCollectionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PatchTrialsCollectionResponse> {
        const response = await this.patchTrialsCollectionRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Return trials matching a set of TrialFilters.
     */
    async queryTrials(requestParameters: QueryTrialsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1QueryTrialsResponse> {
        const response = await this.queryTrialsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Update tags for trials by IDs or filters.
     */
    async updateTrialTags(requestParameters: UpdateTrialTagsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1UpdateTrialTagsResponse> {
        const response = await this.updateTrialTagsRaw(requestParameters, initOverrides);
        return await response.value();
    }
