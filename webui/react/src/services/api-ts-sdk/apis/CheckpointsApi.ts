...
export class CheckpointsApi extends runtime.BaseAPI {
     ...
     * Delete Checkpoints.
     */
    async deleteCheckpoints(requestParameters: DeleteCheckpointsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.deleteCheckpointsRaw(requestParameters, initOverrides);
     ...
     * Get the requested checkpoint.
     */
    async getCheckpoint(requestParameters: GetCheckpointRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetCheckpointResponse> {
     ...
     * Get a checkpoint\'s contents in a tgz or zip file.
     */
    async getCheckpoint_1(requestParameters: GetCheckpoint0Request, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getCheckpoint_1Raw(requestParameters, initOverrides);
    }
     ...
     * Update checkpoint metadata.
     */
    async postCheckpointMetadata(requestParameters: PostCheckpointMetadataRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PostCheckpointMetadataResponse> {
        const response = await this.postCheckpointMetadataRaw(requestParameters, initOverrides);
        return await response.value();
    }
