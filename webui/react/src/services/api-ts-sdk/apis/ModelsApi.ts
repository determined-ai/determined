...
export class ModelsApi extends runtime.BaseAPI {
     ...
     * Archive a model
     */
    async archiveModel(requestParameters: ArchiveModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.archiveModelRaw(requestParameters, initOverrides);
     ...
     * Delete a model version
     */
    async deleteModelVersion(requestParameters: DeleteModelVersionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     * Get the requested model.
     */
    async getModel(requestParameters: GetModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetModelResponse> {
     ...
     * Get the requested model version.
     */
    async getModelVersion(requestParameters: GetModelVersionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetModelVersionResponse> {
     ...
     * Get a list of versions for the requested model.
     */
    async getModelVersions(requestParameters: GetModelVersionsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetModelVersionsResponse> {
        const response = await this.getModelVersionsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Get a list of models.
     */
    async getModels(requestParameters: GetModelsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetModelsResponse> {
     ...
     * Patch a model\'s fields.
     */
    async patchModel(requestParameters: PatchModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PatchModelResponse> {
     ...
     * Patch a model version\'s fields.
     */
    async patchModelVersion(requestParameters: PatchModelVersionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PatchModelVersionResponse> {
     ...
     * Create a model in the registry.
     */
    async postModel(requestParameters: PostModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PostModelResponse> {
        const response = await this.postModelRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Create a model version.
     */
    async postModelVersion(requestParameters: PostModelVersionRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PostModelVersionResponse> {
        const response = await this.postModelVersionRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Unarchive a model
     */
    async unarchiveModel(requestParameters: UnarchiveModelRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.unarchiveModelRaw(requestParameters, initOverrides);
        return await response.value();
    }
...
/**
  ...
  * @enum {string}
  */
export enum GetModelVersionsSortByEnum {
...
/**
  ...
  * @enum {string}
  */
export enum GetModelVersionsOrderByEnum {
...
/**
  ...
  * @enum {string}
  */
export enum GetModelsSortByEnum {
    Unspecified = 'SORT_BY_UNSPECIFIED',
    Name = 'SORT_BY_NAME',
...
/**
  ...
  * @enum {string}
  */
export enum GetModelsOrderByEnum {
    Unspecified = 'ORDER_BY_UNSPECIFIED',
    Asc = 'ORDER_BY_ASC',
    Desc = 'ORDER_BY_DESC'
}
