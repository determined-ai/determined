...
export class ClusterApi extends runtime.BaseAPI {
     ...
     * Disable the agent.
     */
    async disableAgent(agentId: string, body: V1DisableAgentRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1DisableAgentResponse> {
        const response = await this.disableAgentRaw({ agentId: agentId, body: body }, initOverrides);
     ...
     * Disable the slot.
     */
    async disableSlot(agentId: string, slotId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1DisableSlotResponse> {
        const response = await this.disableSlotRaw({ agentId: agentId, slotId: slotId }, initOverrides);
        return await response.value();
    }
     ...
     * Enable the agent.
     */
    async enableAgent(agentId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1EnableAgentResponse> {
        const response = await this.enableAgentRaw({ agentId: agentId }, initOverrides);
        return await response.value();
    }
     ...
     * Enable the slot.
     */
    async enableSlot(agentId: string, slotId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1EnableSlotResponse> {
        const response = await this.enableSlotRaw({ agentId: agentId, slotId: slotId }, initOverrides);
        return await response.value();
    }
     ...
     * Get the requested agent.
     */
    async getAgent(agentId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetAgentResponse> {
     ...
     * Get a set of agents from the cluster.
     */
    async getAgents(sortBy?: GetAgentsSortByEnum, orderBy?: GetAgentsOrderByEnum, offset?: number, limit?: number, label?: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetAgentsResponse> {
        const response = await this.getAgentsRaw({ sortBy: sortBy, orderBy: orderBy, offset: offset, limit: limit, label: label }, initOverrides);
        return await response.value();
    }
     ...
     * Get an aggregated view of resource allocation during the given time period (CSV).
     */
    async getAggregatedResourceAllocationCsv(startDate: string, endDate: string, period: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getAggregatedResourceAllocationCsvRaw({ startDate: startDate, endDate: endDate, period: period }, initOverrides);
    }
     ...
     * Get a detailed view of resource allocation during the given time period (CSV).
     */
    async getRawResourceAllocationCsv(timestampAfter: string, timestampBefore: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<void> {
        await this.getRawResourceAllocationCsvRaw({ timestampAfter: timestampAfter, timestampBefore: timestampBefore }, initOverrides);
    }
     ...
     * Get the requested slot for an agent.
     */
    async getSlot(agentId: string, slotId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetSlotResponse> {
        const response = await this.getSlotRaw({ agentId: agentId, slotId: slotId }, initOverrides);
        return await response.value();
    }
     ...
     * Get all the slots for an agent.
     */
    async getSlots(agentId: string, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetSlotsResponse> {
        const response = await this.getSlotsRaw({ agentId: agentId }, initOverrides);
        return await response.value();
    }
     ...
     * Stream master logs.
     */
    async masterLogs(offset?: number, limit?: number, follow?: boolean, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<StreamResultOfV1MasterLogsResponse> {
        const response = await this.masterLogsRaw({ offset: offset, limit: limit, follow: follow }, initOverrides);
        return await response.value();
    }
     ...
     * Get an aggregated view of resource allocation during the given time period.
     */
    async resourceAllocationAggregated(startDate?: string, endDate?: string, period?: ResourceAllocationAggregatedPeriodEnum, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1ResourceAllocationAggregatedResponse> {
        const response = await this.resourceAllocationAggregatedRaw({ startDate: startDate, endDate: endDate, period: period }, initOverrides);
        return await response.value();
    }
     ...
     * Get a detailed view of resource allocation during the given time period.
     */
    async resourceAllocationRaw(timestampAfter?: Date, timestampBefore?: Date, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1ResourceAllocationRawResponse> {
        const response = await this.resourceAllocationRawRaw({ timestampAfter: timestampAfter, timestampBefore: timestampBefore }, initOverrides);
        return await response.value();
    }
 ...
 * @export
 */
export const GetAgentsOrderByEnum = {
    UNSPECIFIED: 'ORDER_BY_UNSPECIFIED',
    ASC: 'ORDER_BY_ASC',
    DESC: 'ORDER_BY_DESC'
} as const;
export type GetAgentsOrderByEnum = typeof GetAgentsOrderByEnum[keyof typeof GetAgentsOrderByEnum];
/**
 * @export
 */
export const ResourceAllocationAggregatedPeriodEnum = {
...
export type ResourceAllocationAggregatedPeriodEnum = typeof ResourceAllocationAggregatedPeriodEnum[keyof typeof ResourceAllocationAggregatedPeriodEnum];
