...
export class TensorboardsApi extends runtime.BaseAPI {
     ...
     * Get the requested tensorboard.
     */
    async getTensorboard(requestParameters: GetTensorboardRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetTensorboardResponse> {
        const response = await this.getTensorboardRaw(requestParameters, initOverrides);
     ...
     * Get a list of tensorboards.
     */
    async getTensorboards(requestParameters: GetTensorboardsRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetTensorboardsResponse> {
        const response = await this.getTensorboardsRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Kill the requested tensorboard.
     */
    async killTensorboard(requestParameters: KillTensorboardRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1KillTensorboardResponse> {
        const response = await this.killTensorboardRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Launch a tensorboard.
     */
    async launchTensorboard(requestParameters: LaunchTensorboardRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1LaunchTensorboardResponse> {
        const response = await this.launchTensorboardRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Set the priority of the requested TensorBoard.
     */
    async setTensorboardPriority(requestParameters: SetTensorboardPriorityRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1SetTensorboardPriorityResponse> {
        const response = await this.setTensorboardPriorityRaw(requestParameters, initOverrides);
        return await response.value();
    }
...
/**
  ...
  * @enum {string}
  */
export enum GetTensorboardsSortByEnum {
...
/**
  ...
  * @enum {string}
  */
export enum GetTensorboardsOrderByEnum {
