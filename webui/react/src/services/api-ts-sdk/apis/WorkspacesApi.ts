...
export class WorkspacesApi extends runtime.BaseAPI {
     ...
     * Archive a workspace.
     */
    async archiveWorkspace(requestParameters: ArchiveWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
     ...
     * Delete a workspace.
     */
    async deleteWorkspace(requestParameters: DeleteWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1DeleteWorkspaceResponse> {
     ...
     * Get the requested workspace.
     */
    async getWorkspace(requestParameters: GetWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetWorkspaceResponse> {
     ...
     * Get projects associated with a workspace.
     */
    async getWorkspaceProjects(requestParameters: GetWorkspaceProjectsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetWorkspaceProjectsResponse> {
     ...
     * Get a list of workspaces.
     */
    async getWorkspaces(requestParameters: GetWorkspacesRequest = {}, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1GetWorkspacesResponse> {
     ...
     * Update a workspace.
     */
    async patchWorkspace(requestParameters: PatchWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PatchWorkspaceResponse> {
        const response = await this.patchWorkspaceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Pin a workspace.
     */
    async pinWorkspace(requestParameters: PinWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.pinWorkspaceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Create a workspace.
     */
    async postWorkspace(requestParameters: PostWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<V1PostWorkspaceResponse> {
        const response = await this.postWorkspaceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Unarchive a workspace.
     */
    async unarchiveWorkspace(requestParameters: UnarchiveWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.unarchiveWorkspaceRaw(requestParameters, initOverrides);
        return await response.value();
    }
     ...
     * Unpin a workspace.
     */
    async unpinWorkspace(requestParameters: UnpinWorkspaceRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<object> {
        const response = await this.unpinWorkspaceRaw(requestParameters, initOverrides);
        return await response.value();
    }
...
/**
  ...
  * @enum {string}
  */
export enum GetWorkspaceProjectsSortByEnum {
...
/**
  ...
  * @enum {string}
  */
export enum GetWorkspaceProjectsOrderByEnum {
...
/**
  ...
  * @enum {string}
  */
export enum GetWorkspacesSortByEnum {
    Unspecified = 'SORT_BY_UNSPECIFIED',
    Id = 'SORT_BY_ID',
    Name = 'SORT_BY_NAME'
}
/**
  ...
  * @enum {string}
  */
export enum GetWorkspacesOrderByEnum {
    Unspecified = 'ORDER_BY_UNSPECIFIED',
    Asc = 'ORDER_BY_ASC',
    Desc = 'ORDER_BY_DESC'
}
