...
const UPlotChart: React.FC<Props> = forwardRef(
  ({ data, options }: Props, uPlotRef: React.Ref<uPlot|undefined>) => {
    ...
    // expose uPlot to the parent component to allow custom uPlot operations
    useImperativeHandle(uPlotRef, () => chart, [ chart ]);
