...
const ColumnPickerList: React.FC<ColumnListProps> = ({
  columnState,
  handleShowSuggested,
  projectId,
  searchString,
  ...
  const filteredColumns = useMemo(() => {
    ...
    return totalColumns.filter(
      (col) => regex.test(col.displayName || col.column) && col.location === V1LocationType.EXPERIMENT,
    );
  }, [searchString, totalColumns]);
