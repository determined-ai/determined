...
import Message, { MessageType, Props } from 'components/kit/Message';
...
describe('Message', () => {
  it('should display Error title, message and image', () => {
    setup({ description: 'Error message', title: 'Error title', type: MessageType.Error });
  ...
  it('should display Warning title, message and image', () => {
    setup({ description: 'Warning message', title: 'Warning title', type: MessageType.Warning });
  ...
  it('should display Info title, message and image', () => {
    setup({ description: 'Info message', title: 'Info title', type: MessageType.Info });
