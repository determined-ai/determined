...
def read_only_tasks(resources: Resources) -> LocustTasksWithMeta:
    ...
    tasks.append(LocustGetTaskWithMeta('''/api/v1/trials/time-series?&trialIds=216
    &trialIds=218
    &trialIds=219
    &trialIds=220
    &trialIds=221
    ...
    &trialIds=328
    &trialIds=329
    &trialIds=330&maxDatapoints=1500&startBatches=0&metricType=METRIC_TYPE_UNSPECIFIED&metricIds=training.categorical_accuracy&metricIds=training.loss&metricIds=validation.val_categorical_accuracy&metricIds=validation.val_loss''', test_name="compare runs"))
    if resources.project_id is not None:
