...
func (r ApiListAllTerminatedRequest) Execute() ([]DispatchInfo, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []DispatchInfo
func (a *TerminatedApiService) ListAllTerminatedExecute(r ApiListAllTerminatedRequest) ([]DispatchInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
...
func (r ApiListOwnedTerminatedRequest) Execute() ([]DispatchInfo, *_nethttp.Response, error) {
...
// Execute executes the request
//  @return []DispatchInfo
func (a *TerminatedApiService) ListOwnedTerminatedExecute(r ApiListOwnedTerminatedRequest) ([]DispatchInfo, *_nethttp.Response, error) {
	var (
		localVarHTTPMethod   = _nethttp.MethodGet
		localVarPostBody     interface{}
		formFiles            []formFile
