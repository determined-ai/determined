...
// APIClient manages communication with the Dispatch Centre API API v2.7.12
...
type APIClient struct {
	...
	RunningApi *RunningApiService

	TerminatedApi *TerminatedApiService
}
...
func NewAPIClient(cfg *Configuration) *APIClient {
	...
	c.RunningApi = (*RunningApiService)(&c.common)
	c.TerminatedApi = (*TerminatedApiService)(&c.common)
