...
# NEW: pass epochs_completed through to metrics, for the ASHA searcher to use.
def test(args, model, device, test_loader, core_context, steps_completed, epochs_completed):
    ...
    core_context.train.report_validation_metrics(
        ...
        metrics={"test_loss": test_loss, "epoch": epochs_completed},
    )
...
def main(core_context):
    ...
    for epoch_idx in range(epochs_completed, args.epochs):
        ...
        test(args, model, device, test_loader, core_context, steps_completed, epochs_completed)
