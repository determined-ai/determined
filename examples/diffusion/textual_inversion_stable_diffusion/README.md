...
Diffusion which we will fine-tune to correspond to the concept of the Determined AI logo, as represented
through
...
The images in `det_logos/` use filenames which describe the background 
