...
if __name__ == "__main__":
    ...
    parser.add_argument(
        "--load", help="load a model to start training from. Can overwrite BACKBONE.WEIGHTS"
    )
    ...
    callbacks = [
        PeriodicCallback(
            ModelSaver(max_to_keep=10, keep_checkpoint_every_n_hours=1), every_k_epochs=20
        ),
        # linear warmup
