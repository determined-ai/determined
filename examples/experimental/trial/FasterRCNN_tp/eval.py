...
class EvalCallback(Callback):
    ...
    def _setup_graph(self):
        ...
        if cfg.TRAINER == "replicated":
            ...
            self.dataflows = [
                get_eval_dataflow(self._eval_dataset, shard=k, num_shards=self.num_predictor)
            ...
            if self._horovod_run_eval:
                ...
                self.dataflow = get_eval_dataflow(
                    self._eval_dataset, shard=hvd.local_rank(), num_shards=hvd.local_size()
                )
    ...
    def _eval(self):
        ...
        if cfg.TRAINER == "replicated":
            ...
            filenames = [
                os.path.join(logdir, "outputs{}-part{}.json".format(self.global_step, rank))
