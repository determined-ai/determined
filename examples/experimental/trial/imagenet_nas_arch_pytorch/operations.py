...
OPS = {
    ...
    "avg_pool_3x3": lambda C, stride, affine, activation_function: nn.AvgPool2d(
        3, stride=stride, padding=1, count_include_pad=False
    ),
    "max_pool_3x3": lambda C, stride, affine, activation_function: nn.MaxPool2d(
    ...
    "conv_7x1_1x7": lambda C, stride, affine, activation_function: nn.Sequential(
        activation_function(),
