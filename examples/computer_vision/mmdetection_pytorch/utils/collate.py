"""
Overwrite collate function from mmcv to return dictionary instead of DataContainer 
objects to speed up dataloading in Determined.

Source: https://github.com/open-mmlab/mmcv/blob/master/mmcv/parallel/collate.py
"""
