...
def insert_test_result_to_db(conn, info, test_cases):
   with conn.cursor() as cursor:
        ...
        run_sql_query = sql.SQL("""
            ...
            RETURNING id;
        """).format(
            commit=sql.Literal(info["commit"]),
            branch=sql.Literal(info["branch"])
        )
...
def parse_test_run_results(file_name):
    # TODO path param it.
