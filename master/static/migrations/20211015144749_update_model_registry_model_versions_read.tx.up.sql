...
CREATE SEQUENCE public.model_versions_id_seq OWNED BY public.model_versions.id START WITH 1
INCREMENT BY 1
NO MINVALUE
NO MAXVALUE
CACHE 1;
...
ALTER TABLE public.model_versions
    ALTER COLUMN id SET DEFAULT nextval('public.model_versions_id_seq');

UPDATE
    public.model_versions
SET
    id = nextval('public.model_versions_id_seq');
