...
begin
  -- This part isn't reversable.
  UPDATE raw_checkpoints SET state = 'ERROR' WHERE state = 'PARTIALLY_DELETED';
  UPDATE checkpoints_v2 SET state = 'ERROR' WHERE state = 'PARTIALLY_DELETED';
