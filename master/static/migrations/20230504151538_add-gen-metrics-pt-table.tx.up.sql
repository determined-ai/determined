...
ALTER TABLE raw_validations ADD COLUMN partition_type metric_partition_type NOT NULL DEFAULT 'validation';
...
CREATE UNIQUE INDEX validations_trial_id_total_batches_run_id_type_unique ON raw_validations (
    trial_id, total_batches, trial_run_id, partition_type
);
DROP INDEX validations_trial_id_total_batches_run_id_unique_old;

ALTER TABLE raw_steps ADD COLUMN partition_type metric_partition_type NOT NULL DEFAULT 'training';
