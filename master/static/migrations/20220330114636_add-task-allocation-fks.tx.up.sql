...
ALTER TABLE trials
    ADD CONSTRAINT task_id_fkey FOREIGN KEY (task_id) REFERENCES tasks (task_id);
...
ALTER TABLE allocation_sessions
    ADD CONSTRAINT allocation_id_fkey FOREIGN KEY (allocation_id) REFERENCES allocations (allocation_id);
