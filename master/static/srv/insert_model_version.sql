WITH mv AS (
INSERT INTO model_versions (model_id, version, checkpoint_uuid, name, comment, metadata, labels, notes, user_id, creation_time, last_updated_time)
        VALUES ($1, (
                SELECT
...
FROM
    ...
    u
WHERE
    c.uuid = mv.checkpoint_uuid::text;
