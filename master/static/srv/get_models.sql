SELECT m.id, m.name, m.description, m.metadata, m.creation_time, m.last_updated_time, m.labels, m.readme, u.username, m.archived, COUNT(mv.version) as num_versions FROM models as m
