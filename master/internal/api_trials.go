...
func (a *apiServer) GetTrialProfilerSummary(
	...
	resp := &apiv1.GetTrialProfilerSummaryResponse{}

	switch summary, err := a.m.db.GetTrialProfilerMetricSummary(ctx,
		&trialv1.TrialProfilerMetricLabels{
			TrialId:    req.TrialId,
