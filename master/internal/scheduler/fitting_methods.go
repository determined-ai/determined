...
func slotsSatisfied(req *AssignRequest, agent *agentState) bool {
	return req.SlotsNeeded <= agent.numEmptySlots()
}

func labelSatisfied(req *AssignRequest, agent *agentState) bool {
...
// applications.
func BestFit(_ *AssignRequest, agent *agentState) float64 {
...
func WorstFit(_ *AssignRequest, agent *agentState) float64 {
