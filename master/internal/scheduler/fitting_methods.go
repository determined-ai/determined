...
func slotsSatisfied(req *AddTask, agent *agentState) bool {
	return req.SlotsNeeded <= agent.numEmptySlots()
}

func labelSatisfied(req *AddTask, agent *agentState) bool {
...
// applications.
func BestFit(_ *AddTask, agent *agentState) float64 {
...
func WorstFit(_ *AddTask, agent *agentState) float64 {
