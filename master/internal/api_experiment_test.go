...
func TestExperimentSearchApiFilterParsing(t *testing.T) {
	...
	validTestCases := [][2]string{
		...
		{`{"filterGroup":{"children":[{"columnName":"description","id":"fc9571f7-d6a6-4c5a-a2f0-1f2c1df1a3ae","kind":"field","operator":"contains","value":"t\\set"}],"conjunction":"and","id":"ROOT","kind":"group"},"showArchived":false}`, `e.archived = false AND (e.config->>'description' LIKE '%t\set%')`},
		{`{"filterGroup":{"children":[{"columnName":"description","id":"fc9571f7-d6a6-4c5a-a2f0-1f2c1df1a3ae","kind":"field","operator":"contains","value":"t\"set"}],"conjunction":"and","id":"ROOT","kind":"group"},"showArchived":false}`, `e.archived = false AND (e.config->>'description' LIKE '%t"set%')`},
