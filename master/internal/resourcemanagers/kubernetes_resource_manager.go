...
func (k *kubernetesResourceManager) summarizeDummyResourcePool(
	...
	return &resourcepoolv1.ResourcePool{
		...
		Type:                         resourcepoolv1.ResourcePoolType_K8S,
		NumAgents:                    1,
		...
		SchedulerType:                resourcepoolv1.SchedulerType_KUBERNETES_SCHEDULER,
		SchedulerFittingPolicy:       resourcepoolv1.FittingPolicyType_KUBERNETES,
		Location:                     "kubernetes",
		ImageId:                      "N/A",
