...
func newTrialWorkloadSequencer(
	experimentID int, create searcher.Create, firstCheckpoint *model.Checkpoint,
...
func (s *trialWorkloadSequencer) WorkloadCompleted(msg searcher.CompletedMessage) error {
