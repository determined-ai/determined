...
// ProxyHTTPAuth process a proxy request, returning true if the request should terminate
...
func (p *Proxy) getService(serviceName string) *Service {
	...
	return &Service{
		...
		UseHTTPAuth:   service.UseHTTPAuth,
	}
}
