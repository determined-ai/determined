...
// AddTask provides a mock function with given fields: jobType, jobTypeFkID, taskID
func (_m *DB) AddTask(jobType model.JobType, jobTypeFkID int, taskID sproto.TaskID) error {
	ret := _m.Called(jobType, jobTypeFkID, taskID)

	var r0 error
	if rf, ok := ret.Get(0).(func(model.JobType, int, sproto.TaskID) error); ok {
		r0 = rf(jobType, jobTypeFkID, taskID)
	} else {
		r0 = ret.Error(0)
	}
...
// CompleteTask provides a mock function with given fields: jobType, jobTypeFkID, taskID
func (_m *DB) CompleteTask(jobType model.JobType, jobTypeFkID int, taskID sproto.TaskID) error {
	ret := _m.Called(jobType, jobTypeFkID, taskID)
...
// DeleteTaskSessionByTaskID provides a mock function with given fields: taskID
func (_m *DB) DeleteTaskSessionByTaskID(taskID string) error {
...
// EndTasks provides a mock function with given fields: jobType, jobTypeFkID
func (_m *DB) EndTasks(jobType model.JobType, jobTypeFkID int) error {
	ret := _m.Called(jobType, jobTypeFkID)

	var r0 error
	if rf, ok := ret.Get(0).(func(model.JobType, int) error); ok {
		r0 = rf(jobType, jobTypeFkID)
	} else {
		r0 = ret.Error(0)
	}
...
// StartTaskSession provides a mock function with given fields: taskID
func (_m *DB) StartTaskSession(taskID string) (string, error) {
	ret := _m.Called(taskID)
...
// TaskSessionByToken provides a mock function with given fields: token
func (_m *DB) TaskSessionByToken(token string) (*model.TaskSession, error) {
	ret := _m.Called(token)

	var r0 *model.TaskSession
	if rf, ok := ret.Get(0).(func(string) *model.TaskSession); ok {
		r0 = rf(token)
	} else {
		if ret.Get(0) != nil {
			r0 = ret.Get(0).(*model.TaskSession)
		}
	}
