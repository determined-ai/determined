...
// CanOverwriteUsersOwnSettings provides a mock function with given fields: ctx, curUser, settings
func (_m *UserAuthZ) CanOverwriteUsersOwnSettings(ctx context.Context, curUser model.User, settings []*userv1.UserWebSetting) error {
	ret := _m.Called(ctx, curUser, settings)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, model.User, []*userv1.UserWebSetting) error); ok {
