...
// Allocation is an autogenerated mock type for the Allocation type
type Allocation struct {
	mock.Mock
}

// Kill provides a mock function with given fields: ctx
func (_m *Allocation) Kill(ctx *actor.Context) {
	_m.Called(ctx)
}

// Start provides a mock function with given fields: ctx, spec, rank
func (_m *Allocation) Start(ctx *actor.Context, spec tasks.TaskSpec, rank int) {
	_m.Called(ctx, spec, rank)
}

// Summary provides a mock function with given fields:
func (_m *Allocation) Summary() sproto.ContainerSummary {
	ret := _m.Called()
