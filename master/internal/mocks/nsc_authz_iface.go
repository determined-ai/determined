...
// AccessibleScopesTB provides a mock function with given fields: ctx, curUser, requestedScope
func (_m *NSCAuthZ) AccessibleScopesTB(ctx context.Context, curUser model.User, requestedScope model.AccessScopeID) (map[model.AccessScopeID]bool, error) {
	ret := _m.Called(ctx, curUser, requestedScope)
