...
// AccessibleScopes provides a mock function with given fields: ctx, curUser, scopes
func (_m *NSCAuthZ) AccessibleScopes(ctx context.Context, curUser model.User, scopes map[model.AccessScopeID]bool) (map[model.AccessScopeID]bool, error) {
	ret := _m.Called(ctx, curUser, scopes)
...
// CanTerminateTensorboard provides a mock function with given fields: ctx, curUser, tb
func (_m *NSCAuthZ) CanTerminateTensorboard(ctx context.Context, curUser model.User, tb *tensorboardv1.Tensorboard) error {
	ret := _m.Called(ctx, curUser, tb)

	var r0 error
	if rf, ok := ret.Get(0).(func(context.Context, model.User, *tensorboardv1.Tensorboard) error); ok {
		r0 = rf(ctx, curUser, tb)
	} else {
		r0 = ret.Error(0)
	}
