...
// UnwatchRendezvous provides a mock function with given fields: ctx, id, rID
func (_m *AllocationService) UnwatchRendezvous(ctx context.Context, id model.AllocationID, rID sproto.ResourcesID) error {
	ret := _m.Called(ctx, id, rID)
...
// WaitForRestore provides a mock function with given fields: ctx, id
func (_m *AllocationService) WaitForRestore(ctx context.Context, id model.AllocationID) error {
	ret := _m.Called(ctx, id)
...
func (_m *AllocationService) WatchRendezvous(ctx context.Context, id model.AllocationID, rID sproto.ResourcesID) (task.RendezvousWatcher, error) {
	ret := _m.Called(ctx, id, rID)

	var r0 task.RendezvousWatcher
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.AllocationID, sproto.ResourcesID) (task.RendezvousWatcher, error)); ok {
		return rf(ctx, id, rID)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.AllocationID, sproto.ResourcesID) task.RendezvousWatcher); ok {
		r0 = rf(ctx, id, rID)
	} else {
		r0 = ret.Get(0).(task.RendezvousWatcher)
	}
