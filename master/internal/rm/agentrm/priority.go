...
func (p priorityScheduler) Schedule(ctx *actor.Context, rp *resourcePool) ([]*sproto.AllocateRequest, []*actor.Ref) {
...
func (p priorityScheduler) JobQInfo(ctx *actor.Context, rp *resourcePool) map[model.JobID]*sproto.RMJobInfo {
