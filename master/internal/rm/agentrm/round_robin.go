...
func (p *roundRobinScheduler) Schedule(ctx *actor.Context, rp *resourcePool) ([]*sproto.AllocateRequest, []*actor.Ref) {
...
func (p *roundRobinScheduler) JobQInfo(ctx *actor.Context, rp *resourcePool) map[model.JobID]*sproto.RMJobInfo {
	// not supported
