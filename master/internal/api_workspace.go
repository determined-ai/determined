...
const (
	...
	staleLabel                 = "(stale)"
	detNamespaceEnvVar         = "DET_INSTALLATION_NAMESPACE"
...
func generateNamespaceName(clusterID string, workspace string, wkspID int) string {
	...
	detInstallationNamespace := os.Getenv(detNamespaceEnvVar)
...
func (a *apiServer) DeleteWorkspace(
	...
	namespaceName := generateNamespaceName(clusterID, wsToDelete.Name, wsToDelete.ID)
