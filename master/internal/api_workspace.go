...
func (a *apiServer) PatchWorkspace(
	...
	if req.Workspace.DefaultCompute != nil {
		updatedWorkspace.DefaultComputePool = *req.Workspace.DefaultCompute
		insertColumns = append(insertColumns, "default_compute_pool")
	}
	if req.Workspace.DefaultAux != nil {
		updatedWorkspace.DefaultAuxPool = *req.Workspace.DefaultAux
