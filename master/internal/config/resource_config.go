...
func (r ResourceConfig) DefaultResourcePools() (computePool, auxPool string, err error) {
	...
	if r.ResourceManager.KubernetesRM != nil {
		return r.ResourceManager.KubernetesRM.DefaultComputeResourcePool, r.ResourceManager.KubernetesRM.DefaultComputeResourcePool, nil
	}
	return r.ResourceManager.AgentRM.DefaultComputeResourcePool, r.ResourceManager.AgentRM.DefaultComputeResourcePool, nil
}
