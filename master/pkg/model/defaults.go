...
const (
	defaultCPUImage = "determinedai/environments:py-3.6.9-pytorch-1.7-tf-1.15-cpu-412f759"
	defaultGPUImage = "determinedai/environments:cuda-10.1-pytorch-1.7-tf-1.15-gpu-412f759"
)
