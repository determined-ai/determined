...
const (
	//SharedFSContainerPath is the mount point of shared_fs inside the
	//Determined trial/command container.
	SharedFSContainerPath = "/determined_shared_fs"
	// SharedFSPropagation is the propagation type of the bind mount for
	// shared_fs
