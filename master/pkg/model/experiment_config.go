...
// DebugConfig represents which subsystems will be debugged in the harness. Unlike other parts of
// the experiment config, the default values are actually filled in by the harness, and the full
// version of this struct is not expanded when it is saved to the database. This greatly reduces
// the cost of changing the struct, as we will be breaking only user experiments with debug enabled
