...
type CheckpointStorageConfig = CheckpointStorageConfigV1
...
type ExperimentConfig = ExperimentConfigV1
type GCSConfig = GCSConfigV0
type GCSDataLayerConfig = GCSDataLayerConfigV0
type GridConfig = GridConfigV0
type HDFSConfig = HDFSConfigV0
...
type OptimizationsConfig = OptimizationsConfigV1
...
type S3DataLayerConfig = S3DataLayerConfigV0
type SearcherConfig = SearcherConfigV0
type SharedFSConfig = SharedFSConfigV1
