			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						...
						RawROCM: ptrs.Ptr("determinedai/environments:rocm-5.0-pytorch-1.10-tf-2.7-rocm-606e7f2"),
					},
		...
		// Test case with a 0.15.5 experiment config.
		{
			...
			Bytes: []byte(`
                ...
                environment:
                  ...
                  force_pull_image: false
                  image:
                    cpu: determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-606e7f2
                    gpu: determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-606e7f2
                  ports: {}
                  registry_auth: null
                hyperparameters:
                  global_batch_size:
			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						RawCPU:  ptrs.Ptr("determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-606e7f2"),
						RawCUDA: ptrs.Ptr("determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-606e7f2"),
						RawROCM: ptrs.Ptr("determinedai/environments:rocm-5.0-pytorch-1.10-tf-2.7-rocm-606e7f2"),
					},
					RawPorts:            map[string]int{},
					RawProxyPorts:       &ProxyPortsConfigV0{},
