			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						...
						RawROCM: ptrs.Ptr("determinedai/environments-dev:rocm-5.0-pytorch-1.10-tf-2.7-rocm-f6f599d"),
					},
		...
		// Test case with a 0.15.5 experiment config.
		{
			...
			Bytes: []byte(`
                ...
                environment:
                  ...
                  force_pull_image: false
                  image:
                    cpu: determinedai/environments-dev:py-3.7-pytorch-1.7-tf-1.15-cpu-f6f599d
                    gpu: determinedai/environments-dev:cuda-10.2-pytorch-1.7-tf-1.15-gpu-f6f599d
                  ports: {}
                  registry_auth: null
                hyperparameters:
                  global_batch_size:
			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						RawCPU:  ptrs.Ptr("determinedai/environments-dev:py-3.7-pytorch-1.7-tf-1.15-cpu-f6f599d"),
						RawCUDA: ptrs.Ptr("determinedai/environments-dev:cuda-10.2-pytorch-1.7-tf-1.15-gpu-f6f599d"),
						RawROCM: ptrs.Ptr("determinedai/environments-dev:rocm-5.0-pytorch-1.10-tf-2.7-rocm-f6f599d"),
					},
					RawPorts:            map[string]int{},
					RawProxyPorts:       &ProxyPortsConfigV0{},
