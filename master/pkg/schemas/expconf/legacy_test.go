			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						...
						RawROCM: ptrs.Ptr("determinedai/environments:rocm-5.0-pytorch-1.10-tf-2.7-rocm-cc5289c"),
					},
		...
		// Test case with a 0.15.5 experiment config.
		{
			...
			Bytes: []byte(`
                ...
                environment:
                  ...
                  force_pull_image: false
                  image:
                    cpu: determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-cc5289c
                    gpu: determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-cc5289c
                  ports: {}
                  registry_auth: null
                hyperparameters:
                  global_batch_size:
			...
			Expected: LegacyConfig{
				...
				Environment: EnvironmentConfig{
					...
					RawImage: &EnvironmentImageMap{
						RawCPU:  ptrs.Ptr("determinedai/environments:py-3.7-pytorch-1.7-tf-1.15-cpu-cc5289c"),
						RawCUDA: ptrs.Ptr("determinedai/environments:cuda-10.2-pytorch-1.7-tf-1.15-gpu-cc5289c"),
						RawROCM: ptrs.Ptr("determinedai/environments:rocm-5.0-pytorch-1.10-tf-2.7-rocm-cc5289c"),
					},
					RawPorts:            map[string]int{},
					RawProxyPorts:       &ProxyPortsConfigV0{},
