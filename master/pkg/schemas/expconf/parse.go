...
func ParseAnyExperimentConfigJSON(byts []byte) (ExperimentConfig, error) {
	...
	case 0:
		...
		if err != nil {
			return v1, errors.Wrap(err, "version 0 experiment config is invalid")
		}
		err = json.Unmarshal(byts, &v0)
		if err != nil {
			return v1, errors.Wrap(err, "unable to unmarshal experiment config as version 0")
		}

	case 1:
		err = schemas.SaneBytes(&v1, byts)
		if err != nil {
			return v1, errors.Wrap(err, "version 1 experiment config is invalid")
		}
		err = json.Unmarshal(byts, &v1)
		if err != nil {
			return v1, errors.Wrap(err, "unable to unmarshal experiment config as version 1")
		}
