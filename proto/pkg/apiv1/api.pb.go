...
var file_determined_api_v1_api_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x92, 0xaa, 0x02, 0x0a, 0x0a, 0x44, 0x65, 0x74, 0x65,
	...
	0x65, 0x92, 0x41, 0x0a, 0x0a, 0x08, 0x49, 0x6e, 0x74, 0x65, 0x72, 0x6e, 0x61, 0x6c, 0x12, 0x7c,
	0x0a, 0x0a, 0x53, 0x65, 0x61, 0x72, 0x63, 0x68, 0x52, 0x75, 0x6e, 0x73, 0x12, 0x24, 0x2e, 0x64,
	0x65, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x65, 0x64, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31,
...
var file_determined_api_v1_api_proto_goTypes = []interface{}{
	...
	(*SearchRunsRequest)(nil),                            // 225: determined.api.v1.SearchRunsRequest
	...
	(*GetPachydermRepoURLResponse)(nil),                  // 364: determined.api.v1.GetPachydermRepoURLResponse
	(*GetActiveTasksCountResponse)(nil),                  // 365: determined.api.v1.GetActiveTasksCountResponse
	(*GetTaskResponse)(nil),                              // 366: determined.api.v1.GetTaskResponse
	(*GetTasksResponse)(nil),                             // 367: determined.api.v1.GetTasksResponse
	(*GetModelResponse)(nil),                             // 368: determined.api.v1.GetModelResponse
	(*PostModelResponse)(nil),                            // 369: determined.api.v1.PostModelResponse
	(*PatchModelResponse)(nil),                           // 370: determined.api.v1.PatchModelResponse
	(*ArchiveModelResponse)(nil),                         // 371: determined.api.v1.ArchiveModelResponse
	(*UnarchiveModelResponse)(nil),                       // 372: determined.api.v1.UnarchiveModelResponse
	(*MoveModelResponse)(nil),                            // 373: determined.api.v1.MoveModelResponse
	(*DeleteModelResponse)(nil),                          // 374: determined.api.v1.DeleteModelResponse
	(*GetModelsResponse)(nil),                            // 375: determined.api.v1.GetModelsResponse
	(*GetModelLabelsResponse)(nil),                       // 376: determined.api.v1.GetModelLabelsResponse
	(*GetModelVersionResponse)(nil),                      // 377: determined.api.v1.GetModelVersionResponse
	(*GetModelVersionsResponse)(nil),                     // 378: determined.api.v1.GetModelVersionsResponse
	(*PostModelVersionResponse)(nil),                     // 379: determined.api.v1.PostModelVersionResponse
	(*PatchModelVersionResponse)(nil),                    // 380: determined.api.v1.PatchModelVersionResponse
	(*DeleteModelVersionResponse)(nil),                   // 381: determined.api.v1.DeleteModelVersionResponse
	(*GetTrialMetricsByModelVersionResponse)(nil),        // 382: determined.api.v1.GetTrialMetricsByModelVersionResponse
	(*GetCheckpointResponse)(nil),                        // 383: determined.api.v1.GetCheckpointResponse
	(*PostCheckpointMetadataResponse)(nil),               // 384: determined.api.v1.PostCheckpointMetadataResponse
	(*CheckpointsRemoveFilesResponse)(nil),               // 385: determined.api.v1.CheckpointsRemoveFilesResponse
	(*PatchCheckpointsResponse)(nil),                     // 386: determined.api.v1.PatchCheckpointsResponse
	(*DeleteCheckpointsResponse)(nil),                    // 387: determined.api.v1.DeleteCheckpointsResponse
	(*GetTrialMetricsByCheckpointResponse)(nil),          // 388: determined.api.v1.GetTrialMetricsByCheckpointResponse
	(*GetSearcherEventsResponse)(nil),                    // 389: determined.api.v1.GetSearcherEventsResponse
	(*PostSearcherOperationsResponse)(nil),               // 390: determined.api.v1.PostSearcherOperationsResponse
	(*ExpMetricNamesResponse)(nil),                       // 391: determined.api.v1.ExpMetricNamesResponse
	(*MetricBatchesResponse)(nil),                        // 392: determined.api.v1.MetricBatchesResponse
	(*TrialsSnapshotResponse)(nil),                       // 393: determined.api.v1.TrialsSnapshotResponse
	(*TrialsSampleResponse)(nil),                         // 394: determined.api.v1.TrialsSampleResponse
	(*GetResourcePoolsResponse)(nil),                     // 395: determined.api.v1.GetResourcePoolsResponse
	(*ResourceAllocationRawResponse)(nil),                // 396: determined.api.v1.ResourceAllocationRawResponse
	(*ResourceAllocationAggregatedResponse)(nil),         // 397: determined.api.v1.ResourceAllocationAggregatedResponse
	(*GetWorkspaceResponse)(nil),                         // 398: determined.api.v1.GetWorkspaceResponse
	(*GetWorkspaceProjectsResponse)(nil),                 // 399: determined.api.v1.GetWorkspaceProjectsResponse
	(*GetWorkspacesResponse)(nil),                        // 400: determined.api.v1.GetWorkspacesResponse
	(*PostWorkspaceResponse)(nil),                        // 401: determined.api.v1.PostWorkspaceResponse
	(*PatchWorkspaceResponse)(nil),                       // 402: determined.api.v1.PatchWorkspaceResponse
	(*DeleteWorkspaceResponse)(nil),                      // 403: determined.api.v1.DeleteWorkspaceResponse
	(*ArchiveWorkspaceResponse)(nil),                     // 404: determined.api.v1.ArchiveWorkspaceResponse
	(*UnarchiveWorkspaceResponse)(nil),                   // 405: determined.api.v1.UnarchiveWorkspaceResponse
	(*PinWorkspaceResponse)(nil),                         // 406: determined.api.v1.PinWorkspaceResponse
	(*UnpinWorkspaceResponse)(nil),                       // 407: determined.api.v1.UnpinWorkspaceResponse
	(*GetProjectResponse)(nil),                           // 408: determined.api.v1.GetProjectResponse
	(*GetProjectColumnsResponse)(nil),                    // 409: determined.api.v1.GetProjectColumnsResponse
	(*GetProjectNumericMetricsRangeResponse)(nil),        // 410: determined.api.v1.GetProjectNumericMetricsRangeResponse
	(*PostProjectResponse)(nil),                          // 411: determined.api.v1.PostProjectResponse
	(*AddProjectNoteResponse)(nil),                       // 412: determined.api.v1.AddProjectNoteResponse
	(*PutProjectNotesResponse)(nil),                      // 413: determined.api.v1.PutProjectNotesResponse
	(*PatchProjectResponse)(nil),                         // 414: determined.api.v1.PatchProjectResponse
	(*DeleteProjectResponse)(nil),                        // 415: determined.api.v1.DeleteProjectResponse
	(*ArchiveProjectResponse)(nil),                       // 416: determined.api.v1.ArchiveProjectResponse
	(*UnarchiveProjectResponse)(nil),                     // 417: determined.api.v1.UnarchiveProjectResponse
	(*MoveProjectResponse)(nil),                          // 418: determined.api.v1.MoveProjectResponse
	(*MoveExperimentResponse)(nil),                       // 419: determined.api.v1.MoveExperimentResponse
	(*MoveExperimentsResponse)(nil),                      // 420: determined.api.v1.MoveExperimentsResponse
	(*GetWebhooksResponse)(nil),                          // 421: determined.api.v1.GetWebhooksResponse
	(*PostWebhookResponse)(nil),                          // 422: determined.api.v1.PostWebhookResponse
	(*DeleteWebhookResponse)(nil),                        // 423: determined.api.v1.DeleteWebhookResponse
	(*TestWebhookResponse)(nil),                          // 424: determined.api.v1.TestWebhookResponse
	(*GetGroupResponse)(nil),                             // 425: determined.api.v1.GetGroupResponse
	(*GetGroupsResponse)(nil),                            // 426: determined.api.v1.GetGroupsResponse
	(*CreateGroupResponse)(nil),                          // 427: determined.api.v1.CreateGroupResponse
	(*UpdateGroupResponse)(nil),                          // 428: determined.api.v1.UpdateGroupResponse
	(*DeleteGroupResponse)(nil),                          // 429: determined.api.v1.DeleteGroupResponse
	(*GetPermissionsSummaryResponse)(nil),                // 430: determined.api.v1.GetPermissionsSummaryResponse
	(*GetGroupsAndUsersAssignedToWorkspaceResponse)(nil), // 431: determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceResponse
	(*GetRolesByIDResponse)(nil),                         // 432: determined.api.v1.GetRolesByIDResponse
	(*GetRolesAssignedToUserResponse)(nil),               // 433: determined.api.v1.GetRolesAssignedToUserResponse
	(*GetRolesAssignedToGroupResponse)(nil),              // 434: determined.api.v1.GetRolesAssignedToGroupResponse
	(*SearchRolesAssignableToScopeResponse)(nil),         // 435: determined.api.v1.SearchRolesAssignableToScopeResponse
	(*ListRolesResponse)(nil),                            // 436: determined.api.v1.ListRolesResponse
	(*AssignRolesResponse)(nil),                          // 437: determined.api.v1.AssignRolesResponse
	(*RemoveAssignmentsResponse)(nil),                    // 438: determined.api.v1.RemoveAssignmentsResponse
	(*PostUserActivityResponse)(nil),                     // 439: determined.api.v1.PostUserActivityResponse
	(*GetProjectsByUserActivityResponse)(nil),            // 440: determined.api.v1.GetProjectsByUserActivityResponse
	(*SearchExperimentsResponse)(nil),                    // 441: determined.api.v1.SearchExperimentsResponse
	(*BindRPToWorkspaceResponse)(nil),                    // 442: determined.api.v1.BindRPToWorkspaceResponse
	(*UnbindRPFromWorkspaceResponse)(nil),                // 443: determined.api.v1.UnbindRPFromWorkspaceResponse
	(*OverwriteRPWorkspaceBindingsResponse)(nil),         // 444: determined.api.v1.OverwriteRPWorkspaceBindingsResponse
	(*ListRPsBoundToWorkspaceResponse)(nil),              // 445: determined.api.v1.ListRPsBoundToWorkspaceResponse
	(*ListWorkspacesBoundToRPResponse)(nil),              // 446: determined.api.v1.ListWorkspacesBoundToRPResponse
	(*GetGenericTaskConfigResponse)(nil),                 // 447: determined.api.v1.GetGenericTaskConfigResponse
	(*KillGenericTaskResponse)(nil),                      // 448: determined.api.v1.KillGenericTaskResponse
	(*PauseGenericTaskResponse)(nil),                     // 449: determined.api.v1.PauseGenericTaskResponse
	(*UnpauseGenericTaskResponse)(nil),                   // 450: determined.api.v1.UnpauseGenericTaskResponse
	(*SearchRunsResponse)(nil),                           // 451: determined.api.v1.SearchRunsResponse
}
var file_determined_api_v1_api_proto_depIdxs = []int32{
	...
	225, // 225: determined.api.v1.Determined.SearchRuns:input_type -> determined.api.v1.SearchRunsRequest
	...
	364, // 364: determined.api.v1.Determined.GetPachydermRepoURL:output_type -> determined.api.v1.GetPachydermRepoURLResponse
	365, // 365: determined.api.v1.Determined.GetActiveTasksCount:output_type -> determined.api.v1.GetActiveTasksCountResponse
	366, // 366: determined.api.v1.Determined.GetTask:output_type -> determined.api.v1.GetTaskResponse
	367, // 367: determined.api.v1.Determined.GetTasks:output_type -> determined.api.v1.GetTasksResponse
	368, // 368: determined.api.v1.Determined.GetModel:output_type -> determined.api.v1.GetModelResponse
	369, // 369: determined.api.v1.Determined.PostModel:output_type -> determined.api.v1.PostModelResponse
	370, // 370: determined.api.v1.Determined.PatchModel:output_type -> determined.api.v1.PatchModelResponse
	371, // 371: determined.api.v1.Determined.ArchiveModel:output_type -> determined.api.v1.ArchiveModelResponse
	372, // 372: determined.api.v1.Determined.UnarchiveModel:output_type -> determined.api.v1.UnarchiveModelResponse
	373, // 373: determined.api.v1.Determined.MoveModel:output_type -> determined.api.v1.MoveModelResponse
	374, // 374: determined.api.v1.Determined.DeleteModel:output_type -> determined.api.v1.DeleteModelResponse
	375, // 375: determined.api.v1.Determined.GetModels:output_type -> determined.api.v1.GetModelsResponse
	376, // 376: determined.api.v1.Determined.GetModelLabels:output_type -> determined.api.v1.GetModelLabelsResponse
	377, // 377: determined.api.v1.Determined.GetModelVersion:output_type -> determined.api.v1.GetModelVersionResponse
	378, // 378: determined.api.v1.Determined.GetModelVersions:output_type -> determined.api.v1.GetModelVersionsResponse
	379, // 379: determined.api.v1.Determined.PostModelVersion:output_type -> determined.api.v1.PostModelVersionResponse
	380, // 380: determined.api.v1.Determined.PatchModelVersion:output_type -> determined.api.v1.PatchModelVersionResponse
	381, // 381: determined.api.v1.Determined.DeleteModelVersion:output_type -> determined.api.v1.DeleteModelVersionResponse
	382, // 382: determined.api.v1.Determined.GetTrialMetricsByModelVersion:output_type -> determined.api.v1.GetTrialMetricsByModelVersionResponse
	383, // 383: determined.api.v1.Determined.GetCheckpoint:output_type -> determined.api.v1.GetCheckpointResponse
	384, // 384: determined.api.v1.Determined.PostCheckpointMetadata:output_type -> determined.api.v1.PostCheckpointMetadataResponse
	385, // 385: determined.api.v1.Determined.CheckpointsRemoveFiles:output_type -> determined.api.v1.CheckpointsRemoveFilesResponse
	386, // 386: determined.api.v1.Determined.PatchCheckpoints:output_type -> determined.api.v1.PatchCheckpointsResponse
	387, // 387: determined.api.v1.Determined.DeleteCheckpoints:output_type -> determined.api.v1.DeleteCheckpointsResponse
	388, // 388: determined.api.v1.Determined.GetTrialMetricsByCheckpoint:output_type -> determined.api.v1.GetTrialMetricsByCheckpointResponse
	389, // 389: determined.api.v1.Determined.GetSearcherEvents:output_type -> determined.api.v1.GetSearcherEventsResponse
	390, // 390: determined.api.v1.Determined.PostSearcherOperations:output_type -> determined.api.v1.PostSearcherOperationsResponse
	391, // 391: determined.api.v1.Determined.ExpMetricNames:output_type -> determined.api.v1.ExpMetricNamesResponse
	392, // 392: determined.api.v1.Determined.MetricBatches:output_type -> determined.api.v1.MetricBatchesResponse
	393, // 393: determined.api.v1.Determined.TrialsSnapshot:output_type -> determined.api.v1.TrialsSnapshotResponse
	394, // 394: determined.api.v1.Determined.TrialsSample:output_type -> determined.api.v1.TrialsSampleResponse
	395, // 395: determined.api.v1.Determined.GetResourcePools:output_type -> determined.api.v1.GetResourcePoolsResponse
	396, // 396: determined.api.v1.Determined.ResourceAllocationRaw:output_type -> determined.api.v1.ResourceAllocationRawResponse
	397, // 397: determined.api.v1.Determined.ResourceAllocationAggregated:output_type -> determined.api.v1.ResourceAllocationAggregatedResponse
	398, // 398: determined.api.v1.Determined.GetWorkspace:output_type -> determined.api.v1.GetWorkspaceResponse
	399, // 399: determined.api.v1.Determined.GetWorkspaceProjects:output_type -> determined.api.v1.GetWorkspaceProjectsResponse
	400, // 400: determined.api.v1.Determined.GetWorkspaces:output_type -> determined.api.v1.GetWorkspacesResponse
	401, // 401: determined.api.v1.Determined.PostWorkspace:output_type -> determined.api.v1.PostWorkspaceResponse
	402, // 402: determined.api.v1.Determined.PatchWorkspace:output_type -> determined.api.v1.PatchWorkspaceResponse
	403, // 403: determined.api.v1.Determined.DeleteWorkspace:output_type -> determined.api.v1.DeleteWorkspaceResponse
	404, // 404: determined.api.v1.Determined.ArchiveWorkspace:output_type -> determined.api.v1.ArchiveWorkspaceResponse
	405, // 405: determined.api.v1.Determined.UnarchiveWorkspace:output_type -> determined.api.v1.UnarchiveWorkspaceResponse
	406, // 406: determined.api.v1.Determined.PinWorkspace:output_type -> determined.api.v1.PinWorkspaceResponse
	407, // 407: determined.api.v1.Determined.UnpinWorkspace:output_type -> determined.api.v1.UnpinWorkspaceResponse
	408, // 408: determined.api.v1.Determined.GetProject:output_type -> determined.api.v1.GetProjectResponse
	409, // 409: determined.api.v1.Determined.GetProjectColumns:output_type -> determined.api.v1.GetProjectColumnsResponse
	410, // 410: determined.api.v1.Determined.GetProjectNumericMetricsRange:output_type -> determined.api.v1.GetProjectNumericMetricsRangeResponse
	411, // 411: determined.api.v1.Determined.PostProject:output_type -> determined.api.v1.PostProjectResponse
	412, // 412: determined.api.v1.Determined.AddProjectNote:output_type -> determined.api.v1.AddProjectNoteResponse
	413, // 413: determined.api.v1.Determined.PutProjectNotes:output_type -> determined.api.v1.PutProjectNotesResponse
	414, // 414: determined.api.v1.Determined.PatchProject:output_type -> determined.api.v1.PatchProjectResponse
	415, // 415: determined.api.v1.Determined.DeleteProject:output_type -> determined.api.v1.DeleteProjectResponse
	416, // 416: determined.api.v1.Determined.ArchiveProject:output_type -> determined.api.v1.ArchiveProjectResponse
	417, // 417: determined.api.v1.Determined.UnarchiveProject:output_type -> determined.api.v1.UnarchiveProjectResponse
	418, // 418: determined.api.v1.Determined.MoveProject:output_type -> determined.api.v1.MoveProjectResponse
	419, // 419: determined.api.v1.Determined.MoveExperiment:output_type -> determined.api.v1.MoveExperimentResponse
	420, // 420: determined.api.v1.Determined.MoveExperiments:output_type -> determined.api.v1.MoveExperimentsResponse
	421, // 421: determined.api.v1.Determined.GetWebhooks:output_type -> determined.api.v1.GetWebhooksResponse
	422, // 422: determined.api.v1.Determined.PostWebhook:output_type -> determined.api.v1.PostWebhookResponse
	423, // 423: determined.api.v1.Determined.DeleteWebhook:output_type -> determined.api.v1.DeleteWebhookResponse
	424, // 424: determined.api.v1.Determined.TestWebhook:output_type -> determined.api.v1.TestWebhookResponse
	425, // 425: determined.api.v1.Determined.GetGroup:output_type -> determined.api.v1.GetGroupResponse
	426, // 426: determined.api.v1.Determined.GetGroups:output_type -> determined.api.v1.GetGroupsResponse
	427, // 427: determined.api.v1.Determined.CreateGroup:output_type -> determined.api.v1.CreateGroupResponse
	428, // 428: determined.api.v1.Determined.UpdateGroup:output_type -> determined.api.v1.UpdateGroupResponse
	429, // 429: determined.api.v1.Determined.DeleteGroup:output_type -> determined.api.v1.DeleteGroupResponse
	430, // 430: determined.api.v1.Determined.GetPermissionsSummary:output_type -> determined.api.v1.GetPermissionsSummaryResponse
	431, // 431: determined.api.v1.Determined.GetGroupsAndUsersAssignedToWorkspace:output_type -> determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceResponse
	432, // 432: determined.api.v1.Determined.GetRolesByID:output_type -> determined.api.v1.GetRolesByIDResponse
	433, // 433: determined.api.v1.Determined.GetRolesAssignedToUser:output_type -> determined.api.v1.GetRolesAssignedToUserResponse
	434, // 434: determined.api.v1.Determined.GetRolesAssignedToGroup:output_type -> determined.api.v1.GetRolesAssignedToGroupResponse
	435, // 435: determined.api.v1.Determined.SearchRolesAssignableToScope:output_type -> determined.api.v1.SearchRolesAssignableToScopeResponse
	436, // 436: determined.api.v1.Determined.ListRoles:output_type -> determined.api.v1.ListRolesResponse
	437, // 437: determined.api.v1.Determined.AssignRoles:output_type -> determined.api.v1.AssignRolesResponse
	438, // 438: determined.api.v1.Determined.RemoveAssignments:output_type -> determined.api.v1.RemoveAssignmentsResponse
	439, // 439: determined.api.v1.Determined.PostUserActivity:output_type -> determined.api.v1.PostUserActivityResponse
	440, // 440: determined.api.v1.Determined.GetProjectsByUserActivity:output_type -> determined.api.v1.GetProjectsByUserActivityResponse
	441, // 441: determined.api.v1.Determined.SearchExperiments:output_type -> determined.api.v1.SearchExperimentsResponse
	442, // 442: determined.api.v1.Determined.BindRPToWorkspace:output_type -> determined.api.v1.BindRPToWorkspaceResponse
	443, // 443: determined.api.v1.Determined.UnbindRPFromWorkspace:output_type -> determined.api.v1.UnbindRPFromWorkspaceResponse
	444, // 444: determined.api.v1.Determined.OverwriteRPWorkspaceBindings:output_type -> determined.api.v1.OverwriteRPWorkspaceBindingsResponse
	445, // 445: determined.api.v1.Determined.ListRPsBoundToWorkspace:output_type -> determined.api.v1.ListRPsBoundToWorkspaceResponse
	446, // 446: determined.api.v1.Determined.ListWorkspacesBoundToRP:output_type -> determined.api.v1.ListWorkspacesBoundToRPResponse
	447, // 447: determined.api.v1.Determined.GetGenericTaskConfig:output_type -> determined.api.v1.GetGenericTaskConfigResponse
	448, // 448: determined.api.v1.Determined.KillGenericTask:output_type -> determined.api.v1.KillGenericTaskResponse
	449, // 449: determined.api.v1.Determined.PauseGenericTask:output_type -> determined.api.v1.PauseGenericTaskResponse
	450, // 450: determined.api.v1.Determined.UnpauseGenericTask:output_type -> determined.api.v1.UnpauseGenericTaskResponse
	451, // 451: determined.api.v1.Determined.SearchRuns:output_type -> determined.api.v1.SearchRunsResponse
