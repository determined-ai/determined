...
var file_determined_api_v1_api_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xa7, 0x8c, 0x02, 0x0a, 0x0a, 0x44,
...
var file_determined_api_v1_api_proto_goTypes = []interface{}{
	...
	(*GetCheckpointRequest)(nil),                         // 141: determined.api.v1.GetCheckpointRequest
	(*PostCheckpointMetadataRequest)(nil),                // 142: determined.api.v1.PostCheckpointMetadataRequest
	(*CheckpointsRemoveFilesRequest)(nil),                // 143: determined.api.v1.CheckpointsRemoveFilesRequest
	(*PatchCheckpointsRequest)(nil),                      // 144: determined.api.v1.PatchCheckpointsRequest
	(*DeleteCheckpointsRequest)(nil),                     // 145: determined.api.v1.DeleteCheckpointsRequest
	(*GetSearcherEventsRequest)(nil),                     // 146: determined.api.v1.GetSearcherEventsRequest
	(*PostSearcherOperationsRequest)(nil),                // 147: determined.api.v1.PostSearcherOperationsRequest
	(*ExpMetricNamesRequest)(nil),                        // 148: determined.api.v1.ExpMetricNamesRequest
	(*MetricBatchesRequest)(nil),                         // 149: determined.api.v1.MetricBatchesRequest
	(*TrialsSnapshotRequest)(nil),                        // 150: determined.api.v1.TrialsSnapshotRequest
	(*TrialsSampleRequest)(nil),                          // 151: determined.api.v1.TrialsSampleRequest
	(*GetResourcePoolsRequest)(nil),                      // 152: determined.api.v1.GetResourcePoolsRequest
	(*ResourceAllocationRawRequest)(nil),                 // 153: determined.api.v1.ResourceAllocationRawRequest
	(*ResourceAllocationAggregatedRequest)(nil),          // 154: determined.api.v1.ResourceAllocationAggregatedRequest
	(*GetWorkspaceRequest)(nil),                          // 155: determined.api.v1.GetWorkspaceRequest
	(*GetWorkspaceProjectsRequest)(nil),                  // 156: determined.api.v1.GetWorkspaceProjectsRequest
	(*GetWorkspacesRequest)(nil),                         // 157: determined.api.v1.GetWorkspacesRequest
	(*PostWorkspaceRequest)(nil),                         // 158: determined.api.v1.PostWorkspaceRequest
	(*PatchWorkspaceRequest)(nil),                        // 159: determined.api.v1.PatchWorkspaceRequest
	(*DeleteWorkspaceRequest)(nil),                       // 160: determined.api.v1.DeleteWorkspaceRequest
	(*ArchiveWorkspaceRequest)(nil),                      // 161: determined.api.v1.ArchiveWorkspaceRequest
	(*UnarchiveWorkspaceRequest)(nil),                    // 162: determined.api.v1.UnarchiveWorkspaceRequest
	(*PinWorkspaceRequest)(nil),                          // 163: determined.api.v1.PinWorkspaceRequest
	(*UnpinWorkspaceRequest)(nil),                        // 164: determined.api.v1.UnpinWorkspaceRequest
	(*GetProjectRequest)(nil),                            // 165: determined.api.v1.GetProjectRequest
	(*GetProjectColumnsRequest)(nil),                     // 166: determined.api.v1.GetProjectColumnsRequest
	(*GetProjectNumericMetricsRangeRequest)(nil),         // 167: determined.api.v1.GetProjectNumericMetricsRangeRequest
	(*PostProjectRequest)(nil),                           // 168: determined.api.v1.PostProjectRequest
	(*AddProjectNoteRequest)(nil),                        // 169: determined.api.v1.AddProjectNoteRequest
	(*PutProjectNotesRequest)(nil),                       // 170: determined.api.v1.PutProjectNotesRequest
	(*PatchProjectRequest)(nil),                          // 171: determined.api.v1.PatchProjectRequest
	(*DeleteProjectRequest)(nil),                         // 172: determined.api.v1.DeleteProjectRequest
	(*ArchiveProjectRequest)(nil),                        // 173: determined.api.v1.ArchiveProjectRequest
	(*UnarchiveProjectRequest)(nil),                      // 174: determined.api.v1.UnarchiveProjectRequest
	(*MoveProjectRequest)(nil),                           // 175: determined.api.v1.MoveProjectRequest
	(*MoveExperimentRequest)(nil),                        // 176: determined.api.v1.MoveExperimentRequest
	(*MoveExperimentsRequest)(nil),                       // 177: determined.api.v1.MoveExperimentsRequest
	(*GetWebhooksRequest)(nil),                           // 178: determined.api.v1.GetWebhooksRequest
	(*PostWebhookRequest)(nil),                           // 179: determined.api.v1.PostWebhookRequest
	(*DeleteWebhookRequest)(nil),                         // 180: determined.api.v1.DeleteWebhookRequest
	(*TestWebhookRequest)(nil),                           // 181: determined.api.v1.TestWebhookRequest
	(*GetGroupRequest)(nil),                              // 182: determined.api.v1.GetGroupRequest
	(*GetGroupsRequest)(nil),                             // 183: determined.api.v1.GetGroupsRequest
	(*CreateGroupRequest)(nil),                           // 184: determined.api.v1.CreateGroupRequest
	(*UpdateGroupRequest)(nil),                           // 185: determined.api.v1.UpdateGroupRequest
	(*DeleteGroupRequest)(nil),                           // 186: determined.api.v1.DeleteGroupRequest
	(*GetPermissionsSummaryRequest)(nil),                 // 187: determined.api.v1.GetPermissionsSummaryRequest
	(*GetGroupsAndUsersAssignedToWorkspaceRequest)(nil),  // 188: determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceRequest
	(*GetRolesByIDRequest)(nil),                          // 189: determined.api.v1.GetRolesByIDRequest
	(*GetRolesAssignedToUserRequest)(nil),                // 190: determined.api.v1.GetRolesAssignedToUserRequest
	(*GetRolesAssignedToGroupRequest)(nil),               // 191: determined.api.v1.GetRolesAssignedToGroupRequest
	(*SearchRolesAssignableToScopeRequest)(nil),          // 192: determined.api.v1.SearchRolesAssignableToScopeRequest
	(*ListRolesRequest)(nil),                             // 193: determined.api.v1.ListRolesRequest
	(*AssignRolesRequest)(nil),                           // 194: determined.api.v1.AssignRolesRequest
	(*RemoveAssignmentsRequest)(nil),                     // 195: determined.api.v1.RemoveAssignmentsRequest
	(*PostUserActivityRequest)(nil),                      // 196: determined.api.v1.PostUserActivityRequest
	(*GetProjectsByUserActivityRequest)(nil),             // 197: determined.api.v1.GetProjectsByUserActivityRequest
	(*SearchExperimentsRequest)(nil),                     // 198: determined.api.v1.SearchExperimentsRequest
	(*BindRPToWorkspaceRequest)(nil),                     // 199: determined.api.v1.BindRPToWorkspaceRequest
	(*UnbindRPFromWorkspaceRequest)(nil),                 // 200: determined.api.v1.UnbindRPFromWorkspaceRequest
	(*OverwriteRPWorkspaceBindingsRequest)(nil),          // 201: determined.api.v1.OverwriteRPWorkspaceBindingsRequest
	(*ListRPsBoundToWorkspaceRequest)(nil),               // 202: determined.api.v1.ListRPsBoundToWorkspaceRequest
	(*ListWorkspacesBoundToRPRequest)(nil),               // 203: determined.api.v1.ListWorkspacesBoundToRPRequest
	(*LoginResponse)(nil),                                // 204: determined.api.v1.LoginResponse
	(*CurrentUserResponse)(nil),                          // 205: determined.api.v1.CurrentUserResponse
	(*LogoutResponse)(nil),                               // 206: determined.api.v1.LogoutResponse
	(*GetUsersResponse)(nil),                             // 207: determined.api.v1.GetUsersResponse
	(*GetUserSettingResponse)(nil),                       // 208: determined.api.v1.GetUserSettingResponse
	(*ResetUserSettingResponse)(nil),                     // 209: determined.api.v1.ResetUserSettingResponse
	(*PostUserSettingResponse)(nil),                      // 210: determined.api.v1.PostUserSettingResponse
	(*GetUserResponse)(nil),                              // 211: determined.api.v1.GetUserResponse
	(*GetUserByUsernameResponse)(nil),                    // 212: determined.api.v1.GetUserByUsernameResponse
	(*GetMeResponse)(nil),                                // 213: determined.api.v1.GetMeResponse
	(*PostUserResponse)(nil),                             // 214: determined.api.v1.PostUserResponse
	(*SetUserPasswordResponse)(nil),                      // 215: determined.api.v1.SetUserPasswordResponse
	(*PatchUserResponse)(nil),                            // 216: determined.api.v1.PatchUserResponse
	(*GetTelemetryResponse)(nil),                         // 217: determined.api.v1.GetTelemetryResponse
	(*GetMasterResponse)(nil),                            // 218: determined.api.v1.GetMasterResponse
	(*GetMasterConfigResponse)(nil),                      // 219: determined.api.v1.GetMasterConfigResponse
	...
	(*QueryTrialsResponse)(nil),                          // 257: determined.api.v1.QueryTrialsResponse
	(*UpdateTrialTagsResponse)(nil),                      // 258: determined.api.v1.UpdateTrialTagsResponse
	(*GetTrialsCollectionsResponse)(nil),                 // 259: determined.api.v1.GetTrialsCollectionsResponse
	(*CreateTrialsCollectionResponse)(nil),               // 260: determined.api.v1.CreateTrialsCollectionResponse
	(*PatchTrialsCollectionResponse)(nil),                // 261: determined.api.v1.PatchTrialsCollectionResponse
	(*DeleteTrialsCollectionResponse)(nil),               // 262: determined.api.v1.DeleteTrialsCollectionResponse
	(*CreateTrialResponse)(nil),                          // 263: determined.api.v1.CreateTrialResponse
	(*GetTrialResponse)(nil),                             // 264: determined.api.v1.GetTrialResponse
	(*GetTrialWorkloadsResponse)(nil),                    // 265: determined.api.v1.GetTrialWorkloadsResponse
	(*TrialLogsResponse)(nil),                            // 266: determined.api.v1.TrialLogsResponse
	(*TrialLogsFieldsResponse)(nil),                      // 267: determined.api.v1.TrialLogsFieldsResponse
	...
	(*GetMetricsResponse)(nil),                           // 275: determined.api.v1.GetMetricsResponse
	(*GetTrainingMetricsResponse)(nil),                   // 276: determined.api.v1.GetTrainingMetricsResponse
	(*GetValidationMetricsResponse)(nil),                 // 277: determined.api.v1.GetValidationMetricsResponse
	(*KillTrialResponse)(nil),                            // 278: determined.api.v1.KillTrialResponse
	(*GetTrialCheckpointsResponse)(nil),                  // 279: determined.api.v1.GetTrialCheckpointsResponse
	(*AllocationPreemptionSignalResponse)(nil),           // 280: determined.api.v1.AllocationPreemptionSignalResponse
	(*AllocationPendingPreemptionSignalResponse)(nil),    // 281: determined.api.v1.AllocationPendingPreemptionSignalResponse
	(*AckAllocationPreemptionSignalResponse)(nil),        // 282: determined.api.v1.AckAllocationPreemptionSignalResponse
	(*MarkAllocationResourcesDaemonResponse)(nil),        // 283: determined.api.v1.MarkAllocationResourcesDaemonResponse
	(*AllocationRendezvousInfoResponse)(nil),             // 284: determined.api.v1.AllocationRendezvousInfoResponse
	(*PostAllocationProxyAddressResponse)(nil),           // 285: determined.api.v1.PostAllocationProxyAddressResponse
	(*AllocationAllGatherResponse)(nil),                  // 286: determined.api.v1.AllocationAllGatherResponse
	(*NotifyContainerRunningResponse)(nil),               // 287: determined.api.v1.NotifyContainerRunningResponse
	(*GetCurrentTrialSearcherOperationResponse)(nil),     // 288: determined.api.v1.GetCurrentTrialSearcherOperationResponse
	(*CompleteTrialSearcherValidationResponse)(nil),      // 289: determined.api.v1.CompleteTrialSearcherValidationResponse
	(*ReportTrialSearcherEarlyExitResponse)(nil),         // 290: determined.api.v1.ReportTrialSearcherEarlyExitResponse
	(*ReportTrialProgressResponse)(nil),                  // 291: determined.api.v1.ReportTrialProgressResponse
	(*PostTrialRunnerMetadataResponse)(nil),              // 292: determined.api.v1.PostTrialRunnerMetadataResponse
	(*ReportTrialMetricsResponse)(nil),                   // 293: determined.api.v1.ReportTrialMetricsResponse
	(*ReportTrialTrainingMetricsResponse)(nil),           // 294: determined.api.v1.ReportTrialTrainingMetricsResponse
	(*ReportTrialValidationMetricsResponse)(nil),         // 295: determined.api.v1.ReportTrialValidationMetricsResponse
	(*ReportCheckpointResponse)(nil),                     // 296: determined.api.v1.ReportCheckpointResponse
	(*GetJobsResponse)(nil),                              // 297: determined.api.v1.GetJobsResponse
	(*GetJobsV2Response)(nil),                            // 298: determined.api.v1.GetJobsV2Response
	(*GetJobQueueStatsResponse)(nil),                     // 299: determined.api.v1.GetJobQueueStatsResponse
	(*UpdateJobQueueResponse)(nil),                       // 300: determined.api.v1.UpdateJobQueueResponse
	(*GetTemplatesResponse)(nil),                         // 301: determined.api.v1.GetTemplatesResponse
	(*GetTemplateResponse)(nil),                          // 302: determined.api.v1.GetTemplateResponse
	(*PutTemplateResponse)(nil),                          // 303: determined.api.v1.PutTemplateResponse
	(*PostTemplateResponse)(nil),                         // 304: determined.api.v1.PostTemplateResponse
	(*PatchTemplateConfigResponse)(nil),                  // 305: determined.api.v1.PatchTemplateConfigResponse
	(*DeleteTemplateResponse)(nil),                       // 306: determined.api.v1.DeleteTemplateResponse
	(*GetNotebooksResponse)(nil),                         // 307: determined.api.v1.GetNotebooksResponse
	(*GetNotebookResponse)(nil),                          // 308: determined.api.v1.GetNotebookResponse
	(*IdleNotebookResponse)(nil),                         // 309: determined.api.v1.IdleNotebookResponse
	(*KillNotebookResponse)(nil),                         // 310: determined.api.v1.KillNotebookResponse
	(*SetNotebookPriorityResponse)(nil),                  // 311: determined.api.v1.SetNotebookPriorityResponse
	(*LaunchNotebookResponse)(nil),                       // 312: determined.api.v1.LaunchNotebookResponse
	(*GetShellsResponse)(nil),                            // 313: determined.api.v1.GetShellsResponse
	(*GetShellResponse)(nil),                             // 314: determined.api.v1.GetShellResponse
	(*KillShellResponse)(nil),                            // 315: determined.api.v1.KillShellResponse
	(*SetShellPriorityResponse)(nil),                     // 316: determined.api.v1.SetShellPriorityResponse
	(*LaunchShellResponse)(nil),                          // 317: determined.api.v1.LaunchShellResponse
	(*GetCommandsResponse)(nil),                          // 318: determined.api.v1.GetCommandsResponse
	(*GetCommandResponse)(nil),                           // 319: determined.api.v1.GetCommandResponse
	(*KillCommandResponse)(nil),                          // 320: determined.api.v1.KillCommandResponse
	(*SetCommandPriorityResponse)(nil),                   // 321: determined.api.v1.SetCommandPriorityResponse
	(*LaunchCommandResponse)(nil),                        // 322: determined.api.v1.LaunchCommandResponse
	(*GetTensorboardsResponse)(nil),                      // 323: determined.api.v1.GetTensorboardsResponse
	(*GetTensorboardResponse)(nil),                       // 324: determined.api.v1.GetTensorboardResponse
	(*KillTensorboardResponse)(nil),                      // 325: determined.api.v1.KillTensorboardResponse
	(*SetTensorboardPriorityResponse)(nil),               // 326: determined.api.v1.SetTensorboardPriorityResponse
	(*LaunchTensorboardResponse)(nil),                    // 327: determined.api.v1.LaunchTensorboardResponse
	(*GetActiveTasksCountResponse)(nil),                  // 328: determined.api.v1.GetActiveTasksCountResponse
	(*GetTaskResponse)(nil),                              // 329: determined.api.v1.GetTaskResponse
	(*GetTasksResponse)(nil),                             // 330: determined.api.v1.GetTasksResponse
	(*GetModelResponse)(nil),                             // 331: determined.api.v1.GetModelResponse
	(*PostModelResponse)(nil),                            // 332: determined.api.v1.PostModelResponse
	(*PatchModelResponse)(nil),                           // 333: determined.api.v1.PatchModelResponse
	(*ArchiveModelResponse)(nil),                         // 334: determined.api.v1.ArchiveModelResponse
	(*UnarchiveModelResponse)(nil),                       // 335: determined.api.v1.UnarchiveModelResponse
	(*MoveModelResponse)(nil),                            // 336: determined.api.v1.MoveModelResponse
	(*DeleteModelResponse)(nil),                          // 337: determined.api.v1.DeleteModelResponse
	(*GetModelsResponse)(nil),                            // 338: determined.api.v1.GetModelsResponse
	(*GetModelLabelsResponse)(nil),                       // 339: determined.api.v1.GetModelLabelsResponse
	(*GetModelVersionResponse)(nil),                      // 340: determined.api.v1.GetModelVersionResponse
	(*GetModelVersionsResponse)(nil),                     // 341: determined.api.v1.GetModelVersionsResponse
	(*PostModelVersionResponse)(nil),                     // 342: determined.api.v1.PostModelVersionResponse
	(*PatchModelVersionResponse)(nil),                    // 343: determined.api.v1.PatchModelVersionResponse
	(*DeleteModelVersionResponse)(nil),                   // 344: determined.api.v1.DeleteModelVersionResponse
	(*GetCheckpointResponse)(nil),                        // 345: determined.api.v1.GetCheckpointResponse
	(*PostCheckpointMetadataResponse)(nil),               // 346: determined.api.v1.PostCheckpointMetadataResponse
	(*CheckpointsRemoveFilesResponse)(nil),               // 347: determined.api.v1.CheckpointsRemoveFilesResponse
	(*PatchCheckpointsResponse)(nil),                     // 348: determined.api.v1.PatchCheckpointsResponse
	(*DeleteCheckpointsResponse)(nil),                    // 349: determined.api.v1.DeleteCheckpointsResponse
	(*GetSearcherEventsResponse)(nil),                    // 350: determined.api.v1.GetSearcherEventsResponse
	(*PostSearcherOperationsResponse)(nil),               // 351: determined.api.v1.PostSearcherOperationsResponse
	(*ExpMetricNamesResponse)(nil),                       // 352: determined.api.v1.ExpMetricNamesResponse
	(*MetricBatchesResponse)(nil),                        // 353: determined.api.v1.MetricBatchesResponse
	(*TrialsSnapshotResponse)(nil),                       // 354: determined.api.v1.TrialsSnapshotResponse
	(*TrialsSampleResponse)(nil),                         // 355: determined.api.v1.TrialsSampleResponse
	(*GetResourcePoolsResponse)(nil),                     // 356: determined.api.v1.GetResourcePoolsResponse
	(*ResourceAllocationRawResponse)(nil),                // 357: determined.api.v1.ResourceAllocationRawResponse
	(*ResourceAllocationAggregatedResponse)(nil),         // 358: determined.api.v1.ResourceAllocationAggregatedResponse
	(*GetWorkspaceResponse)(nil),                         // 359: determined.api.v1.GetWorkspaceResponse
	(*GetWorkspaceProjectsResponse)(nil),                 // 360: determined.api.v1.GetWorkspaceProjectsResponse
	(*GetWorkspacesResponse)(nil),                        // 361: determined.api.v1.GetWorkspacesResponse
	(*PostWorkspaceResponse)(nil),                        // 362: determined.api.v1.PostWorkspaceResponse
	(*PatchWorkspaceResponse)(nil),                       // 363: determined.api.v1.PatchWorkspaceResponse
	(*DeleteWorkspaceResponse)(nil),                      // 364: determined.api.v1.DeleteWorkspaceResponse
	(*ArchiveWorkspaceResponse)(nil),                     // 365: determined.api.v1.ArchiveWorkspaceResponse
	(*UnarchiveWorkspaceResponse)(nil),                   // 366: determined.api.v1.UnarchiveWorkspaceResponse
	(*PinWorkspaceResponse)(nil),                         // 367: determined.api.v1.PinWorkspaceResponse
	(*UnpinWorkspaceResponse)(nil),                       // 368: determined.api.v1.UnpinWorkspaceResponse
	(*GetProjectResponse)(nil),                           // 369: determined.api.v1.GetProjectResponse
	(*GetProjectColumnsResponse)(nil),                    // 370: determined.api.v1.GetProjectColumnsResponse
	(*GetProjectNumericMetricsRangeResponse)(nil),        // 371: determined.api.v1.GetProjectNumericMetricsRangeResponse
	(*PostProjectResponse)(nil),                          // 372: determined.api.v1.PostProjectResponse
	(*AddProjectNoteResponse)(nil),                       // 373: determined.api.v1.AddProjectNoteResponse
	(*PutProjectNotesResponse)(nil),                      // 374: determined.api.v1.PutProjectNotesResponse
	(*PatchProjectResponse)(nil),                         // 375: determined.api.v1.PatchProjectResponse
	(*DeleteProjectResponse)(nil),                        // 376: determined.api.v1.DeleteProjectResponse
	(*ArchiveProjectResponse)(nil),                       // 377: determined.api.v1.ArchiveProjectResponse
	(*UnarchiveProjectResponse)(nil),                     // 378: determined.api.v1.UnarchiveProjectResponse
	(*MoveProjectResponse)(nil),                          // 379: determined.api.v1.MoveProjectResponse
	(*MoveExperimentResponse)(nil),                       // 380: determined.api.v1.MoveExperimentResponse
	(*MoveExperimentsResponse)(nil),                      // 381: determined.api.v1.MoveExperimentsResponse
	(*GetWebhooksResponse)(nil),                          // 382: determined.api.v1.GetWebhooksResponse
	(*PostWebhookResponse)(nil),                          // 383: determined.api.v1.PostWebhookResponse
	(*DeleteWebhookResponse)(nil),                        // 384: determined.api.v1.DeleteWebhookResponse
	(*TestWebhookResponse)(nil),                          // 385: determined.api.v1.TestWebhookResponse
	(*GetGroupResponse)(nil),                             // 386: determined.api.v1.GetGroupResponse
	(*GetGroupsResponse)(nil),                            // 387: determined.api.v1.GetGroupsResponse
	(*CreateGroupResponse)(nil),                          // 388: determined.api.v1.CreateGroupResponse
	(*UpdateGroupResponse)(nil),                          // 389: determined.api.v1.UpdateGroupResponse
	(*DeleteGroupResponse)(nil),                          // 390: determined.api.v1.DeleteGroupResponse
	(*GetPermissionsSummaryResponse)(nil),                // 391: determined.api.v1.GetPermissionsSummaryResponse
	(*GetGroupsAndUsersAssignedToWorkspaceResponse)(nil), // 392: determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceResponse
	(*GetRolesByIDResponse)(nil),                         // 393: determined.api.v1.GetRolesByIDResponse
	(*GetRolesAssignedToUserResponse)(nil),               // 394: determined.api.v1.GetRolesAssignedToUserResponse
	(*GetRolesAssignedToGroupResponse)(nil),              // 395: determined.api.v1.GetRolesAssignedToGroupResponse
	(*SearchRolesAssignableToScopeResponse)(nil),         // 396: determined.api.v1.SearchRolesAssignableToScopeResponse
	(*ListRolesResponse)(nil),                            // 397: determined.api.v1.ListRolesResponse
	(*AssignRolesResponse)(nil),                          // 398: determined.api.v1.AssignRolesResponse
	(*RemoveAssignmentsResponse)(nil),                    // 399: determined.api.v1.RemoveAssignmentsResponse
	(*PostUserActivityResponse)(nil),                     // 400: determined.api.v1.PostUserActivityResponse
	(*GetProjectsByUserActivityResponse)(nil),            // 401: determined.api.v1.GetProjectsByUserActivityResponse
	(*SearchExperimentsResponse)(nil),                    // 402: determined.api.v1.SearchExperimentsResponse
	(*BindRPToWorkspaceResponse)(nil),                    // 403: determined.api.v1.BindRPToWorkspaceResponse
	(*UnbindRPFromWorkspaceResponse)(nil),                // 404: determined.api.v1.UnbindRPFromWorkspaceResponse
	(*OverwriteRPWorkspaceBindingsResponse)(nil),         // 405: determined.api.v1.OverwriteRPWorkspaceBindingsResponse
	(*ListRPsBoundToWorkspaceResponse)(nil),              // 406: determined.api.v1.ListRPsBoundToWorkspaceResponse
	(*ListWorkspacesBoundToRPResponse)(nil),              // 407: determined.api.v1.ListWorkspacesBoundToRPResponse
}
var file_determined_api_v1_api_proto_depIdxs = []int32{
	...
	141, // 141: determined.api.v1.Determined.GetCheckpoint:input_type -> determined.api.v1.GetCheckpointRequest
	142, // 142: determined.api.v1.Determined.PostCheckpointMetadata:input_type -> determined.api.v1.PostCheckpointMetadataRequest
	143, // 143: determined.api.v1.Determined.CheckpointsRemoveFiles:input_type -> determined.api.v1.CheckpointsRemoveFilesRequest
	144, // 144: determined.api.v1.Determined.PatchCheckpoints:input_type -> determined.api.v1.PatchCheckpointsRequest
	145, // 145: determined.api.v1.Determined.DeleteCheckpoints:input_type -> determined.api.v1.DeleteCheckpointsRequest
	146, // 146: determined.api.v1.Determined.GetSearcherEvents:input_type -> determined.api.v1.GetSearcherEventsRequest
	147, // 147: determined.api.v1.Determined.PostSearcherOperations:input_type -> determined.api.v1.PostSearcherOperationsRequest
	148, // 148: determined.api.v1.Determined.ExpMetricNames:input_type -> determined.api.v1.ExpMetricNamesRequest
	149, // 149: determined.api.v1.Determined.MetricBatches:input_type -> determined.api.v1.MetricBatchesRequest
	150, // 150: determined.api.v1.Determined.TrialsSnapshot:input_type -> determined.api.v1.TrialsSnapshotRequest
	151, // 151: determined.api.v1.Determined.TrialsSample:input_type -> determined.api.v1.TrialsSampleRequest
	152, // 152: determined.api.v1.Determined.GetResourcePools:input_type -> determined.api.v1.GetResourcePoolsRequest
	153, // 153: determined.api.v1.Determined.ResourceAllocationRaw:input_type -> determined.api.v1.ResourceAllocationRawRequest
	154, // 154: determined.api.v1.Determined.ResourceAllocationAggregated:input_type -> determined.api.v1.ResourceAllocationAggregatedRequest
	155, // 155: determined.api.v1.Determined.GetWorkspace:input_type -> determined.api.v1.GetWorkspaceRequest
	156, // 156: determined.api.v1.Determined.GetWorkspaceProjects:input_type -> determined.api.v1.GetWorkspaceProjectsRequest
	157, // 157: determined.api.v1.Determined.GetWorkspaces:input_type -> determined.api.v1.GetWorkspacesRequest
	158, // 158: determined.api.v1.Determined.PostWorkspace:input_type -> determined.api.v1.PostWorkspaceRequest
	159, // 159: determined.api.v1.Determined.PatchWorkspace:input_type -> determined.api.v1.PatchWorkspaceRequest
	160, // 160: determined.api.v1.Determined.DeleteWorkspace:input_type -> determined.api.v1.DeleteWorkspaceRequest
	161, // 161: determined.api.v1.Determined.ArchiveWorkspace:input_type -> determined.api.v1.ArchiveWorkspaceRequest
	162, // 162: determined.api.v1.Determined.UnarchiveWorkspace:input_type -> determined.api.v1.UnarchiveWorkspaceRequest
	163, // 163: determined.api.v1.Determined.PinWorkspace:input_type -> determined.api.v1.PinWorkspaceRequest
	164, // 164: determined.api.v1.Determined.UnpinWorkspace:input_type -> determined.api.v1.UnpinWorkspaceRequest
	165, // 165: determined.api.v1.Determined.GetProject:input_type -> determined.api.v1.GetProjectRequest
	166, // 166: determined.api.v1.Determined.GetProjectColumns:input_type -> determined.api.v1.GetProjectColumnsRequest
	167, // 167: determined.api.v1.Determined.GetProjectNumericMetricsRange:input_type -> determined.api.v1.GetProjectNumericMetricsRangeRequest
	168, // 168: determined.api.v1.Determined.PostProject:input_type -> determined.api.v1.PostProjectRequest
	169, // 169: determined.api.v1.Determined.AddProjectNote:input_type -> determined.api.v1.AddProjectNoteRequest
	170, // 170: determined.api.v1.Determined.PutProjectNotes:input_type -> determined.api.v1.PutProjectNotesRequest
	171, // 171: determined.api.v1.Determined.PatchProject:input_type -> determined.api.v1.PatchProjectRequest
	172, // 172: determined.api.v1.Determined.DeleteProject:input_type -> determined.api.v1.DeleteProjectRequest
	173, // 173: determined.api.v1.Determined.ArchiveProject:input_type -> determined.api.v1.ArchiveProjectRequest
	174, // 174: determined.api.v1.Determined.UnarchiveProject:input_type -> determined.api.v1.UnarchiveProjectRequest
	175, // 175: determined.api.v1.Determined.MoveProject:input_type -> determined.api.v1.MoveProjectRequest
	176, // 176: determined.api.v1.Determined.MoveExperiment:input_type -> determined.api.v1.MoveExperimentRequest
	177, // 177: determined.api.v1.Determined.MoveExperiments:input_type -> determined.api.v1.MoveExperimentsRequest
	178, // 178: determined.api.v1.Determined.GetWebhooks:input_type -> determined.api.v1.GetWebhooksRequest
	179, // 179: determined.api.v1.Determined.PostWebhook:input_type -> determined.api.v1.PostWebhookRequest
	180, // 180: determined.api.v1.Determined.DeleteWebhook:input_type -> determined.api.v1.DeleteWebhookRequest
	181, // 181: determined.api.v1.Determined.TestWebhook:input_type -> determined.api.v1.TestWebhookRequest
	182, // 182: determined.api.v1.Determined.GetGroup:input_type -> determined.api.v1.GetGroupRequest
	183, // 183: determined.api.v1.Determined.GetGroups:input_type -> determined.api.v1.GetGroupsRequest
	184, // 184: determined.api.v1.Determined.CreateGroup:input_type -> determined.api.v1.CreateGroupRequest
	185, // 185: determined.api.v1.Determined.UpdateGroup:input_type -> determined.api.v1.UpdateGroupRequest
	186, // 186: determined.api.v1.Determined.DeleteGroup:input_type -> determined.api.v1.DeleteGroupRequest
	187, // 187: determined.api.v1.Determined.GetPermissionsSummary:input_type -> determined.api.v1.GetPermissionsSummaryRequest
	188, // 188: determined.api.v1.Determined.GetGroupsAndUsersAssignedToWorkspace:input_type -> determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceRequest
	189, // 189: determined.api.v1.Determined.GetRolesByID:input_type -> determined.api.v1.GetRolesByIDRequest
	190, // 190: determined.api.v1.Determined.GetRolesAssignedToUser:input_type -> determined.api.v1.GetRolesAssignedToUserRequest
	191, // 191: determined.api.v1.Determined.GetRolesAssignedToGroup:input_type -> determined.api.v1.GetRolesAssignedToGroupRequest
	192, // 192: determined.api.v1.Determined.SearchRolesAssignableToScope:input_type -> determined.api.v1.SearchRolesAssignableToScopeRequest
	193, // 193: determined.api.v1.Determined.ListRoles:input_type -> determined.api.v1.ListRolesRequest
	194, // 194: determined.api.v1.Determined.AssignRoles:input_type -> determined.api.v1.AssignRolesRequest
	195, // 195: determined.api.v1.Determined.RemoveAssignments:input_type -> determined.api.v1.RemoveAssignmentsRequest
	196, // 196: determined.api.v1.Determined.PostUserActivity:input_type -> determined.api.v1.PostUserActivityRequest
	197, // 197: determined.api.v1.Determined.GetProjectsByUserActivity:input_type -> determined.api.v1.GetProjectsByUserActivityRequest
	198, // 198: determined.api.v1.Determined.SearchExperiments:input_type -> determined.api.v1.SearchExperimentsRequest
	199, // 199: determined.api.v1.Determined.BindRPToWorkspace:input_type -> determined.api.v1.BindRPToWorkspaceRequest
	200, // 200: determined.api.v1.Determined.UnbindRPFromWorkspace:input_type -> determined.api.v1.UnbindRPFromWorkspaceRequest
	201, // 201: determined.api.v1.Determined.OverwriteRPWorkspaceBindings:input_type -> determined.api.v1.OverwriteRPWorkspaceBindingsRequest
	202, // 202: determined.api.v1.Determined.ListRPsBoundToWorkspace:input_type -> determined.api.v1.ListRPsBoundToWorkspaceRequest
	203, // 203: determined.api.v1.Determined.ListWorkspacesBoundToRP:input_type -> determined.api.v1.ListWorkspacesBoundToRPRequest
	204, // 204: determined.api.v1.Determined.Login:output_type -> determined.api.v1.LoginResponse
	205, // 205: determined.api.v1.Determined.CurrentUser:output_type -> determined.api.v1.CurrentUserResponse
	206, // 206: determined.api.v1.Determined.Logout:output_type -> determined.api.v1.LogoutResponse
	207, // 207: determined.api.v1.Determined.GetUsers:output_type -> determined.api.v1.GetUsersResponse
	208, // 208: determined.api.v1.Determined.GetUserSetting:output_type -> determined.api.v1.GetUserSettingResponse
	209, // 209: determined.api.v1.Determined.ResetUserSetting:output_type -> determined.api.v1.ResetUserSettingResponse
	210, // 210: determined.api.v1.Determined.PostUserSetting:output_type -> determined.api.v1.PostUserSettingResponse
	211, // 211: determined.api.v1.Determined.GetUser:output_type -> determined.api.v1.GetUserResponse
	212, // 212: determined.api.v1.Determined.GetUserByUsername:output_type -> determined.api.v1.GetUserByUsernameResponse
	213, // 213: determined.api.v1.Determined.GetMe:output_type -> determined.api.v1.GetMeResponse
	214, // 214: determined.api.v1.Determined.PostUser:output_type -> determined.api.v1.PostUserResponse
	215, // 215: determined.api.v1.Determined.SetUserPassword:output_type -> determined.api.v1.SetUserPasswordResponse
	216, // 216: determined.api.v1.Determined.PatchUser:output_type -> determined.api.v1.PatchUserResponse
	217, // 217: determined.api.v1.Determined.GetTelemetry:output_type -> determined.api.v1.GetTelemetryResponse
	218, // 218: determined.api.v1.Determined.GetMaster:output_type -> determined.api.v1.GetMasterResponse
	219, // 219: determined.api.v1.Determined.GetMasterConfig:output_type -> determined.api.v1.GetMasterConfigResponse
	...
	257, // 257: determined.api.v1.Determined.QueryTrials:output_type -> determined.api.v1.QueryTrialsResponse
	258, // 258: determined.api.v1.Determined.UpdateTrialTags:output_type -> determined.api.v1.UpdateTrialTagsResponse
	259, // 259: determined.api.v1.Determined.GetTrialsCollections:output_type -> determined.api.v1.GetTrialsCollectionsResponse
	260, // 260: determined.api.v1.Determined.CreateTrialsCollection:output_type -> determined.api.v1.CreateTrialsCollectionResponse
	261, // 261: determined.api.v1.Determined.PatchTrialsCollection:output_type -> determined.api.v1.PatchTrialsCollectionResponse
	262, // 262: determined.api.v1.Determined.DeleteTrialsCollection:output_type -> determined.api.v1.DeleteTrialsCollectionResponse
	263, // 263: determined.api.v1.Determined.CreateTrial:output_type -> determined.api.v1.CreateTrialResponse
	264, // 264: determined.api.v1.Determined.GetTrial:output_type -> determined.api.v1.GetTrialResponse
	265, // 265: determined.api.v1.Determined.GetTrialWorkloads:output_type -> determined.api.v1.GetTrialWorkloadsResponse
	266, // 266: determined.api.v1.Determined.TrialLogs:output_type -> determined.api.v1.TrialLogsResponse
	267, // 267: determined.api.v1.Determined.TrialLogsFields:output_type -> determined.api.v1.TrialLogsFieldsResponse
	...
	275, // 275: determined.api.v1.Determined.GetMetrics:output_type -> determined.api.v1.GetMetricsResponse
	276, // 276: determined.api.v1.Determined.GetTrainingMetrics:output_type -> determined.api.v1.GetTrainingMetricsResponse
	277, // 277: determined.api.v1.Determined.GetValidationMetrics:output_type -> determined.api.v1.GetValidationMetricsResponse
	278, // 278: determined.api.v1.Determined.KillTrial:output_type -> determined.api.v1.KillTrialResponse
	279, // 279: determined.api.v1.Determined.GetTrialCheckpoints:output_type -> determined.api.v1.GetTrialCheckpointsResponse
	280, // 280: determined.api.v1.Determined.AllocationPreemptionSignal:output_type -> determined.api.v1.AllocationPreemptionSignalResponse
	281, // 281: determined.api.v1.Determined.AllocationPendingPreemptionSignal:output_type -> determined.api.v1.AllocationPendingPreemptionSignalResponse
	282, // 282: determined.api.v1.Determined.AckAllocationPreemptionSignal:output_type -> determined.api.v1.AckAllocationPreemptionSignalResponse
	283, // 283: determined.api.v1.Determined.MarkAllocationResourcesDaemon:output_type -> determined.api.v1.MarkAllocationResourcesDaemonResponse
	284, // 284: determined.api.v1.Determined.AllocationRendezvousInfo:output_type -> determined.api.v1.AllocationRendezvousInfoResponse
	285, // 285: determined.api.v1.Determined.PostAllocationProxyAddress:output_type -> determined.api.v1.PostAllocationProxyAddressResponse
	286, // 286: determined.api.v1.Determined.AllocationAllGather:output_type -> determined.api.v1.AllocationAllGatherResponse
	287, // 287: determined.api.v1.Determined.NotifyContainerRunning:output_type -> determined.api.v1.NotifyContainerRunningResponse
	288, // 288: determined.api.v1.Determined.GetCurrentTrialSearcherOperation:output_type -> determined.api.v1.GetCurrentTrialSearcherOperationResponse
	289, // 289: determined.api.v1.Determined.CompleteTrialSearcherValidation:output_type -> determined.api.v1.CompleteTrialSearcherValidationResponse
	290, // 290: determined.api.v1.Determined.ReportTrialSearcherEarlyExit:output_type -> determined.api.v1.ReportTrialSearcherEarlyExitResponse
	291, // 291: determined.api.v1.Determined.ReportTrialProgress:output_type -> determined.api.v1.ReportTrialProgressResponse
	292, // 292: determined.api.v1.Determined.PostTrialRunnerMetadata:output_type -> determined.api.v1.PostTrialRunnerMetadataResponse
	293, // 293: determined.api.v1.Determined.ReportTrialMetrics:output_type -> determined.api.v1.ReportTrialMetricsResponse
	294, // 294: determined.api.v1.Determined.ReportTrialTrainingMetrics:output_type -> determined.api.v1.ReportTrialTrainingMetricsResponse
	295, // 295: determined.api.v1.Determined.ReportTrialValidationMetrics:output_type -> determined.api.v1.ReportTrialValidationMetricsResponse
	296, // 296: determined.api.v1.Determined.ReportCheckpoint:output_type -> determined.api.v1.ReportCheckpointResponse
	297, // 297: determined.api.v1.Determined.GetJobs:output_type -> determined.api.v1.GetJobsResponse
	298, // 298: determined.api.v1.Determined.GetJobsV2:output_type -> determined.api.v1.GetJobsV2Response
	299, // 299: determined.api.v1.Determined.GetJobQueueStats:output_type -> determined.api.v1.GetJobQueueStatsResponse
	300, // 300: determined.api.v1.Determined.UpdateJobQueue:output_type -> determined.api.v1.UpdateJobQueueResponse
	301, // 301: determined.api.v1.Determined.GetTemplates:output_type -> determined.api.v1.GetTemplatesResponse
	302, // 302: determined.api.v1.Determined.GetTemplate:output_type -> determined.api.v1.GetTemplateResponse
	303, // 303: determined.api.v1.Determined.PutTemplate:output_type -> determined.api.v1.PutTemplateResponse
	304, // 304: determined.api.v1.Determined.PostTemplate:output_type -> determined.api.v1.PostTemplateResponse
	305, // 305: determined.api.v1.Determined.PatchTemplateConfig:output_type -> determined.api.v1.PatchTemplateConfigResponse
	306, // 306: determined.api.v1.Determined.DeleteTemplate:output_type -> determined.api.v1.DeleteTemplateResponse
	307, // 307: determined.api.v1.Determined.GetNotebooks:output_type -> determined.api.v1.GetNotebooksResponse
	308, // 308: determined.api.v1.Determined.GetNotebook:output_type -> determined.api.v1.GetNotebookResponse
	309, // 309: determined.api.v1.Determined.IdleNotebook:output_type -> determined.api.v1.IdleNotebookResponse
	310, // 310: determined.api.v1.Determined.KillNotebook:output_type -> determined.api.v1.KillNotebookResponse
	311, // 311: determined.api.v1.Determined.SetNotebookPriority:output_type -> determined.api.v1.SetNotebookPriorityResponse
	312, // 312: determined.api.v1.Determined.LaunchNotebook:output_type -> determined.api.v1.LaunchNotebookResponse
	313, // 313: determined.api.v1.Determined.GetShells:output_type -> determined.api.v1.GetShellsResponse
	314, // 314: determined.api.v1.Determined.GetShell:output_type -> determined.api.v1.GetShellResponse
	315, // 315: determined.api.v1.Determined.KillShell:output_type -> determined.api.v1.KillShellResponse
	316, // 316: determined.api.v1.Determined.SetShellPriority:output_type -> determined.api.v1.SetShellPriorityResponse
	317, // 317: determined.api.v1.Determined.LaunchShell:output_type -> determined.api.v1.LaunchShellResponse
	318, // 318: determined.api.v1.Determined.GetCommands:output_type -> determined.api.v1.GetCommandsResponse
	319, // 319: determined.api.v1.Determined.GetCommand:output_type -> determined.api.v1.GetCommandResponse
	320, // 320: determined.api.v1.Determined.KillCommand:output_type -> determined.api.v1.KillCommandResponse
	321, // 321: determined.api.v1.Determined.SetCommandPriority:output_type -> determined.api.v1.SetCommandPriorityResponse
	322, // 322: determined.api.v1.Determined.LaunchCommand:output_type -> determined.api.v1.LaunchCommandResponse
	323, // 323: determined.api.v1.Determined.GetTensorboards:output_type -> determined.api.v1.GetTensorboardsResponse
	324, // 324: determined.api.v1.Determined.GetTensorboard:output_type -> determined.api.v1.GetTensorboardResponse
	325, // 325: determined.api.v1.Determined.KillTensorboard:output_type -> determined.api.v1.KillTensorboardResponse
	326, // 326: determined.api.v1.Determined.SetTensorboardPriority:output_type -> determined.api.v1.SetTensorboardPriorityResponse
	327, // 327: determined.api.v1.Determined.LaunchTensorboard:output_type -> determined.api.v1.LaunchTensorboardResponse
	328, // 328: determined.api.v1.Determined.GetActiveTasksCount:output_type -> determined.api.v1.GetActiveTasksCountResponse
	329, // 329: determined.api.v1.Determined.GetTask:output_type -> determined.api.v1.GetTaskResponse
	330, // 330: determined.api.v1.Determined.GetTasks:output_type -> determined.api.v1.GetTasksResponse
	331, // 331: determined.api.v1.Determined.GetModel:output_type -> determined.api.v1.GetModelResponse
	332, // 332: determined.api.v1.Determined.PostModel:output_type -> determined.api.v1.PostModelResponse
	333, // 333: determined.api.v1.Determined.PatchModel:output_type -> determined.api.v1.PatchModelResponse
	334, // 334: determined.api.v1.Determined.ArchiveModel:output_type -> determined.api.v1.ArchiveModelResponse
	335, // 335: determined.api.v1.Determined.UnarchiveModel:output_type -> determined.api.v1.UnarchiveModelResponse
	336, // 336: determined.api.v1.Determined.MoveModel:output_type -> determined.api.v1.MoveModelResponse
	337, // 337: determined.api.v1.Determined.DeleteModel:output_type -> determined.api.v1.DeleteModelResponse
	338, // 338: determined.api.v1.Determined.GetModels:output_type -> determined.api.v1.GetModelsResponse
	339, // 339: determined.api.v1.Determined.GetModelLabels:output_type -> determined.api.v1.GetModelLabelsResponse
	340, // 340: determined.api.v1.Determined.GetModelVersion:output_type -> determined.api.v1.GetModelVersionResponse
	341, // 341: determined.api.v1.Determined.GetModelVersions:output_type -> determined.api.v1.GetModelVersionsResponse
	342, // 342: determined.api.v1.Determined.PostModelVersion:output_type -> determined.api.v1.PostModelVersionResponse
	343, // 343: determined.api.v1.Determined.PatchModelVersion:output_type -> determined.api.v1.PatchModelVersionResponse
	344, // 344: determined.api.v1.Determined.DeleteModelVersion:output_type -> determined.api.v1.DeleteModelVersionResponse
	345, // 345: determined.api.v1.Determined.GetCheckpoint:output_type -> determined.api.v1.GetCheckpointResponse
	346, // 346: determined.api.v1.Determined.PostCheckpointMetadata:output_type -> determined.api.v1.PostCheckpointMetadataResponse
	347, // 347: determined.api.v1.Determined.CheckpointsRemoveFiles:output_type -> determined.api.v1.CheckpointsRemoveFilesResponse
	348, // 348: determined.api.v1.Determined.PatchCheckpoints:output_type -> determined.api.v1.PatchCheckpointsResponse
	349, // 349: determined.api.v1.Determined.DeleteCheckpoints:output_type -> determined.api.v1.DeleteCheckpointsResponse
	350, // 350: determined.api.v1.Determined.GetSearcherEvents:output_type -> determined.api.v1.GetSearcherEventsResponse
	351, // 351: determined.api.v1.Determined.PostSearcherOperations:output_type -> determined.api.v1.PostSearcherOperationsResponse
	352, // 352: determined.api.v1.Determined.ExpMetricNames:output_type -> determined.api.v1.ExpMetricNamesResponse
	353, // 353: determined.api.v1.Determined.MetricBatches:output_type -> determined.api.v1.MetricBatchesResponse
	354, // 354: determined.api.v1.Determined.TrialsSnapshot:output_type -> determined.api.v1.TrialsSnapshotResponse
	355, // 355: determined.api.v1.Determined.TrialsSample:output_type -> determined.api.v1.TrialsSampleResponse
	356, // 356: determined.api.v1.Determined.GetResourcePools:output_type -> determined.api.v1.GetResourcePoolsResponse
	357, // 357: determined.api.v1.Determined.ResourceAllocationRaw:output_type -> determined.api.v1.ResourceAllocationRawResponse
	358, // 358: determined.api.v1.Determined.ResourceAllocationAggregated:output_type -> determined.api.v1.ResourceAllocationAggregatedResponse
	359, // 359: determined.api.v1.Determined.GetWorkspace:output_type -> determined.api.v1.GetWorkspaceResponse
	360, // 360: determined.api.v1.Determined.GetWorkspaceProjects:output_type -> determined.api.v1.GetWorkspaceProjectsResponse
	361, // 361: determined.api.v1.Determined.GetWorkspaces:output_type -> determined.api.v1.GetWorkspacesResponse
	362, // 362: determined.api.v1.Determined.PostWorkspace:output_type -> determined.api.v1.PostWorkspaceResponse
	363, // 363: determined.api.v1.Determined.PatchWorkspace:output_type -> determined.api.v1.PatchWorkspaceResponse
	364, // 364: determined.api.v1.Determined.DeleteWorkspace:output_type -> determined.api.v1.DeleteWorkspaceResponse
	365, // 365: determined.api.v1.Determined.ArchiveWorkspace:output_type -> determined.api.v1.ArchiveWorkspaceResponse
	366, // 366: determined.api.v1.Determined.UnarchiveWorkspace:output_type -> determined.api.v1.UnarchiveWorkspaceResponse
	367, // 367: determined.api.v1.Determined.PinWorkspace:output_type -> determined.api.v1.PinWorkspaceResponse
	368, // 368: determined.api.v1.Determined.UnpinWorkspace:output_type -> determined.api.v1.UnpinWorkspaceResponse
	369, // 369: determined.api.v1.Determined.GetProject:output_type -> determined.api.v1.GetProjectResponse
	370, // 370: determined.api.v1.Determined.GetProjectColumns:output_type -> determined.api.v1.GetProjectColumnsResponse
	371, // 371: determined.api.v1.Determined.GetProjectNumericMetricsRange:output_type -> determined.api.v1.GetProjectNumericMetricsRangeResponse
	372, // 372: determined.api.v1.Determined.PostProject:output_type -> determined.api.v1.PostProjectResponse
	373, // 373: determined.api.v1.Determined.AddProjectNote:output_type -> determined.api.v1.AddProjectNoteResponse
	374, // 374: determined.api.v1.Determined.PutProjectNotes:output_type -> determined.api.v1.PutProjectNotesResponse
	375, // 375: determined.api.v1.Determined.PatchProject:output_type -> determined.api.v1.PatchProjectResponse
	376, // 376: determined.api.v1.Determined.DeleteProject:output_type -> determined.api.v1.DeleteProjectResponse
	377, // 377: determined.api.v1.Determined.ArchiveProject:output_type -> determined.api.v1.ArchiveProjectResponse
	378, // 378: determined.api.v1.Determined.UnarchiveProject:output_type -> determined.api.v1.UnarchiveProjectResponse
	379, // 379: determined.api.v1.Determined.MoveProject:output_type -> determined.api.v1.MoveProjectResponse
	380, // 380: determined.api.v1.Determined.MoveExperiment:output_type -> determined.api.v1.MoveExperimentResponse
	381, // 381: determined.api.v1.Determined.MoveExperiments:output_type -> determined.api.v1.MoveExperimentsResponse
	382, // 382: determined.api.v1.Determined.GetWebhooks:output_type -> determined.api.v1.GetWebhooksResponse
	383, // 383: determined.api.v1.Determined.PostWebhook:output_type -> determined.api.v1.PostWebhookResponse
	384, // 384: determined.api.v1.Determined.DeleteWebhook:output_type -> determined.api.v1.DeleteWebhookResponse
	385, // 385: determined.api.v1.Determined.TestWebhook:output_type -> determined.api.v1.TestWebhookResponse
	386, // 386: determined.api.v1.Determined.GetGroup:output_type -> determined.api.v1.GetGroupResponse
	387, // 387: determined.api.v1.Determined.GetGroups:output_type -> determined.api.v1.GetGroupsResponse
	388, // 388: determined.api.v1.Determined.CreateGroup:output_type -> determined.api.v1.CreateGroupResponse
	389, // 389: determined.api.v1.Determined.UpdateGroup:output_type -> determined.api.v1.UpdateGroupResponse
	390, // 390: determined.api.v1.Determined.DeleteGroup:output_type -> determined.api.v1.DeleteGroupResponse
	391, // 391: determined.api.v1.Determined.GetPermissionsSummary:output_type -> determined.api.v1.GetPermissionsSummaryResponse
	392, // 392: determined.api.v1.Determined.GetGroupsAndUsersAssignedToWorkspace:output_type -> determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceResponse
	393, // 393: determined.api.v1.Determined.GetRolesByID:output_type -> determined.api.v1.GetRolesByIDResponse
	394, // 394: determined.api.v1.Determined.GetRolesAssignedToUser:output_type -> determined.api.v1.GetRolesAssignedToUserResponse
	395, // 395: determined.api.v1.Determined.GetRolesAssignedToGroup:output_type -> determined.api.v1.GetRolesAssignedToGroupResponse
	396, // 396: determined.api.v1.Determined.SearchRolesAssignableToScope:output_type -> determined.api.v1.SearchRolesAssignableToScopeResponse
	397, // 397: determined.api.v1.Determined.ListRoles:output_type -> determined.api.v1.ListRolesResponse
	398, // 398: determined.api.v1.Determined.AssignRoles:output_type -> determined.api.v1.AssignRolesResponse
	399, // 399: determined.api.v1.Determined.RemoveAssignments:output_type -> determined.api.v1.RemoveAssignmentsResponse
	400, // 400: determined.api.v1.Determined.PostUserActivity:output_type -> determined.api.v1.PostUserActivityResponse
	401, // 401: determined.api.v1.Determined.GetProjectsByUserActivity:output_type -> determined.api.v1.GetProjectsByUserActivityResponse
	402, // 402: determined.api.v1.Determined.SearchExperiments:output_type -> determined.api.v1.SearchExperimentsResponse
	403, // 403: determined.api.v1.Determined.BindRPToWorkspace:output_type -> determined.api.v1.BindRPToWorkspaceResponse
	404, // 404: determined.api.v1.Determined.UnbindRPFromWorkspace:output_type -> determined.api.v1.UnbindRPFromWorkspaceResponse
	405, // 405: determined.api.v1.Determined.OverwriteRPWorkspaceBindings:output_type -> determined.api.v1.OverwriteRPWorkspaceBindingsResponse
	406, // 406: determined.api.v1.Determined.ListRPsBoundToWorkspace:output_type -> determined.api.v1.ListRPsBoundToWorkspaceResponse
	407, // 407: determined.api.v1.Determined.ListWorkspacesBoundToRP:output_type -> determined.api.v1.ListWorkspacesBoundToRPResponse
