...
var file_determined_api_v1_api_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0xc6, 0xec, 0x01, 0x0a, 0x0a, 0x44,
	...
	,
	...
	0x63, 0x74, 0x73, 0x42, 0xda, 0x07, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62, 0x2e, 0x63,
...
var file_determined_api_v1_api_proto_goTypes = []interface{}{
	...
	(*TransferRolesRequest)(nil),                         // 177: determined.api.v1.TransferRolesRequest
	...
	(*TransferRolesResponse)(nil),                        // 358: determined.api.v1.TransferRolesResponse
...
var file_determined_api_v1_api_proto_depIdxs = []int32{
	...
	177, // 177: determined.api.v1.Determined.TransferRoles:input_type -> determined.api.v1.TransferRolesRequest
	...
	358, // 358: determined.api.v1.Determined.TransferRoles:output_type -> determined.api.v1.TransferRolesResponse
...
type DeterminedClient interface {
	...
	// TransferRoles changes a set of role assignments to the system.
	TransferRoles(ctx context.Context, in *TransferRolesRequest, opts ...grpc.CallOption) (*TransferRolesResponse, error)
...
func (c *determinedClient) TransferRoles(ctx context.Context, in *TransferRolesRequest, opts ...grpc.CallOption) (*TransferRolesResponse, error) {
	out := new(TransferRolesResponse)
	err := c.cc.Invoke(ctx, "/determined.api.v1.Determined/TransferRoles", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type DeterminedServer interface {
	...
	// TransferRoles changes a set of role assignments to the system.
	TransferRoles(context.Context, *TransferRolesRequest) (*TransferRolesResponse, error)
	// RemoveAssignments removes a set of role assignments from the system.
...
func (*UnimplementedDeterminedServer) TransferRoles(context.Context, *TransferRolesRequest) (*TransferRolesResponse, error) {
	return nil, status.Errorf(codes.Unimplemented, "method TransferRoles not implemented")
}
...
func _Determined_TransferRoles_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(TransferRolesRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(DeterminedServer).TransferRoles(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/determined.api.v1.Determined/TransferRoles",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(DeterminedServer).TransferRoles(ctx, req.(*TransferRolesRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var _Determined_serviceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		{
			MethodName: "TransferRoles",
			Handler:    _Determined_TransferRoles_Handler,
		},
		{
