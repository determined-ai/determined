...
var file_determined_api_v1_api_proto_rawDesc = []byte{
	...
	0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x32, 0x89, 0x81, 0x02, 0x0a, 0x0a, 0x44,
...
var file_determined_api_v1_api_proto_goTypes = []interface{}{
	...
	(*LoginResponse)(nil),                                // 197: determined.api.v1.LoginResponse
	(*CurrentUserResponse)(nil),                          // 198: determined.api.v1.CurrentUserResponse
	(*LogoutResponse)(nil),                               // 199: determined.api.v1.LogoutResponse
	(*GetUsersResponse)(nil),                             // 200: determined.api.v1.GetUsersResponse
	(*GetUserSettingResponse)(nil),                       // 201: determined.api.v1.GetUserSettingResponse
	(*ResetUserSettingResponse)(nil),                     // 202: determined.api.v1.ResetUserSettingResponse
	(*PostUserSettingResponse)(nil),                      // 203: determined.api.v1.PostUserSettingResponse
	(*GetUserResponse)(nil),                              // 204: determined.api.v1.GetUserResponse
	(*GetUserByUsernameResponse)(nil),                    // 205: determined.api.v1.GetUserByUsernameResponse
	(*GetMeResponse)(nil),                                // 206: determined.api.v1.GetMeResponse
	(*PostUserResponse)(nil),                             // 207: determined.api.v1.PostUserResponse
	(*SetUserPasswordResponse)(nil),                      // 208: determined.api.v1.SetUserPasswordResponse
	(*PatchUserResponse)(nil),                            // 209: determined.api.v1.PatchUserResponse
	(*GetTelemetryResponse)(nil),                         // 210: determined.api.v1.GetTelemetryResponse
	(*GetMasterResponse)(nil),                            // 211: determined.api.v1.GetMasterResponse
	(*GetMasterConfigResponse)(nil),                      // 212: determined.api.v1.GetMasterConfigResponse
	(*MasterLogsResponse)(nil),                           // 213: determined.api.v1.MasterLogsResponse
	(*GetAgentsResponse)(nil),                            // 214: determined.api.v1.GetAgentsResponse
	(*GetAgentResponse)(nil),                             // 215: determined.api.v1.GetAgentResponse
	(*GetSlotsResponse)(nil),                             // 216: determined.api.v1.GetSlotsResponse
	(*GetSlotResponse)(nil),                              // 217: determined.api.v1.GetSlotResponse
	(*EnableAgentResponse)(nil),                          // 218: determined.api.v1.EnableAgentResponse
	(*DisableAgentResponse)(nil),                         // 219: determined.api.v1.DisableAgentResponse
	(*EnableSlotResponse)(nil),                           // 220: determined.api.v1.EnableSlotResponse
	(*DisableSlotResponse)(nil),                          // 221: determined.api.v1.DisableSlotResponse
	(*CreateExperimentResponse)(nil),                     // 222: determined.api.v1.CreateExperimentResponse
	(*GetExperimentResponse)(nil),                        // 223: determined.api.v1.GetExperimentResponse
	(*GetExperimentsResponse)(nil),                       // 224: determined.api.v1.GetExperimentsResponse
	(*GetModelDefResponse)(nil),                          // 225: determined.api.v1.GetModelDefResponse
	(*GetModelDefTreeResponse)(nil),                      // 226: determined.api.v1.GetModelDefTreeResponse
	(*GetModelDefFileResponse)(nil),                      // 227: determined.api.v1.GetModelDefFileResponse
	(*GetExperimentLabelsResponse)(nil),                  // 228: determined.api.v1.GetExperimentLabelsResponse
	(*GetExperimentValidationHistoryResponse)(nil),       // 229: determined.api.v1.GetExperimentValidationHistoryResponse
	(*ActivateExperimentResponse)(nil),                   // 230: determined.api.v1.ActivateExperimentResponse
	(*ActivateExperimentsResponse)(nil),                  // 231: determined.api.v1.ActivateExperimentsResponse
	(*PauseExperimentResponse)(nil),                      // 232: determined.api.v1.PauseExperimentResponse
	(*PauseExperimentsResponse)(nil),                     // 233: determined.api.v1.PauseExperimentsResponse
	(*CancelExperimentResponse)(nil),                     // 234: determined.api.v1.CancelExperimentResponse
	(*CancelExperimentsResponse)(nil),                    // 235: determined.api.v1.CancelExperimentsResponse
	(*KillExperimentResponse)(nil),                       // 236: determined.api.v1.KillExperimentResponse
	(*KillExperimentsResponse)(nil),                      // 237: determined.api.v1.KillExperimentsResponse
	(*ArchiveExperimentResponse)(nil),                    // 238: determined.api.v1.ArchiveExperimentResponse
	(*ArchiveExperimentsResponse)(nil),                   // 239: determined.api.v1.ArchiveExperimentsResponse
	(*UnarchiveExperimentResponse)(nil),                  // 240: determined.api.v1.UnarchiveExperimentResponse
	(*UnarchiveExperimentsResponse)(nil),                 // 241: determined.api.v1.UnarchiveExperimentsResponse
	(*PatchExperimentResponse)(nil),                      // 242: determined.api.v1.PatchExperimentResponse
	(*DeleteExperimentsResponse)(nil),                    // 243: determined.api.v1.DeleteExperimentsResponse
	(*DeleteExperimentResponse)(nil),                     // 244: determined.api.v1.DeleteExperimentResponse
	(*GetBestSearcherValidationMetricResponse)(nil),      // 245: determined.api.v1.GetBestSearcherValidationMetricResponse
	(*GetExperimentCheckpointsResponse)(nil),             // 246: determined.api.v1.GetExperimentCheckpointsResponse
	(*PreviewHPSearchResponse)(nil),                      // 247: determined.api.v1.PreviewHPSearchResponse
	(*GetExperimentTrialsResponse)(nil),                  // 248: determined.api.v1.GetExperimentTrialsResponse
	(*CompareTrialsResponse)(nil),                        // 249: determined.api.v1.CompareTrialsResponse
	(*QueryTrialsResponse)(nil),                          // 250: determined.api.v1.QueryTrialsResponse
	(*UpdateTrialTagsResponse)(nil),                      // 251: determined.api.v1.UpdateTrialTagsResponse
	(*GetTrialsCollectionsResponse)(nil),                 // 252: determined.api.v1.GetTrialsCollectionsResponse
	(*CreateTrialsCollectionResponse)(nil),               // 253: determined.api.v1.CreateTrialsCollectionResponse
	(*PatchTrialsCollectionResponse)(nil),                // 254: determined.api.v1.PatchTrialsCollectionResponse
	(*DeleteTrialsCollectionResponse)(nil),               // 255: determined.api.v1.DeleteTrialsCollectionResponse
	...
	(*SummarizeTrialResponse)(nil),                       // 261: determined.api.v1.SummarizeTrialResponse
	...
	(*PostProjectResponse)(nil),                          // 363: determined.api.v1.PostProjectResponse
	(*AddProjectNoteResponse)(nil),                       // 364: determined.api.v1.AddProjectNoteResponse
	(*PutProjectNotesResponse)(nil),                      // 365: determined.api.v1.PutProjectNotesResponse
	(*PatchProjectResponse)(nil),                         // 366: determined.api.v1.PatchProjectResponse
	(*DeleteProjectResponse)(nil),                        // 367: determined.api.v1.DeleteProjectResponse
	(*ArchiveProjectResponse)(nil),                       // 368: determined.api.v1.ArchiveProjectResponse
	(*UnarchiveProjectResponse)(nil),                     // 369: determined.api.v1.UnarchiveProjectResponse
	(*MoveProjectResponse)(nil),                          // 370: determined.api.v1.MoveProjectResponse
	(*MoveExperimentResponse)(nil),                       // 371: determined.api.v1.MoveExperimentResponse
	(*MoveExperimentsResponse)(nil),                      // 372: determined.api.v1.MoveExperimentsResponse
	(*GetWebhooksResponse)(nil),                          // 373: determined.api.v1.GetWebhooksResponse
	(*PostWebhookResponse)(nil),                          // 374: determined.api.v1.PostWebhookResponse
	(*DeleteWebhookResponse)(nil),                        // 375: determined.api.v1.DeleteWebhookResponse
	(*TestWebhookResponse)(nil),                          // 376: determined.api.v1.TestWebhookResponse
	(*GetGroupResponse)(nil),                             // 377: determined.api.v1.GetGroupResponse
	(*GetGroupsResponse)(nil),                            // 378: determined.api.v1.GetGroupsResponse
	(*CreateGroupResponse)(nil),                          // 379: determined.api.v1.CreateGroupResponse
	(*UpdateGroupResponse)(nil),                          // 380: determined.api.v1.UpdateGroupResponse
	(*DeleteGroupResponse)(nil),                          // 381: determined.api.v1.DeleteGroupResponse
	(*GetPermissionsSummaryResponse)(nil),                // 382: determined.api.v1.GetPermissionsSummaryResponse
	(*GetGroupsAndUsersAssignedToWorkspaceResponse)(nil), // 383: determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceResponse
	(*GetRolesByIDResponse)(nil),                         // 384: determined.api.v1.GetRolesByIDResponse
	(*GetRolesAssignedToUserResponse)(nil),               // 385: determined.api.v1.GetRolesAssignedToUserResponse
	(*GetRolesAssignedToGroupResponse)(nil),              // 386: determined.api.v1.GetRolesAssignedToGroupResponse
	(*SearchRolesAssignableToScopeResponse)(nil),         // 387: determined.api.v1.SearchRolesAssignableToScopeResponse
	(*ListRolesResponse)(nil),                            // 388: determined.api.v1.ListRolesResponse
	(*AssignRolesResponse)(nil),                          // 389: determined.api.v1.AssignRolesResponse
	(*RemoveAssignmentsResponse)(nil),                    // 390: determined.api.v1.RemoveAssignmentsResponse
	(*PostUserActivityResponse)(nil),                     // 391: determined.api.v1.PostUserActivityResponse
	(*GetProjectsByUserActivityResponse)(nil),            // 392: determined.api.v1.GetProjectsByUserActivityResponse
	(*SearchExperimentsResponse)(nil),                    // 393: determined.api.v1.SearchExperimentsResponse
}
var file_determined_api_v1_api_proto_depIdxs = []int32{
	...
	197, // 197: determined.api.v1.Determined.Login:output_type -> determined.api.v1.LoginResponse
	198, // 198: determined.api.v1.Determined.CurrentUser:output_type -> determined.api.v1.CurrentUserResponse
	199, // 199: determined.api.v1.Determined.Logout:output_type -> determined.api.v1.LogoutResponse
	200, // 200: determined.api.v1.Determined.GetUsers:output_type -> determined.api.v1.GetUsersResponse
	201, // 201: determined.api.v1.Determined.GetUserSetting:output_type -> determined.api.v1.GetUserSettingResponse
	202, // 202: determined.api.v1.Determined.ResetUserSetting:output_type -> determined.api.v1.ResetUserSettingResponse
	203, // 203: determined.api.v1.Determined.PostUserSetting:output_type -> determined.api.v1.PostUserSettingResponse
	204, // 204: determined.api.v1.Determined.GetUser:output_type -> determined.api.v1.GetUserResponse
	205, // 205: determined.api.v1.Determined.GetUserByUsername:output_type -> determined.api.v1.GetUserByUsernameResponse
	206, // 206: determined.api.v1.Determined.GetMe:output_type -> determined.api.v1.GetMeResponse
	207, // 207: determined.api.v1.Determined.PostUser:output_type -> determined.api.v1.PostUserResponse
	208, // 208: determined.api.v1.Determined.SetUserPassword:output_type -> determined.api.v1.SetUserPasswordResponse
	209, // 209: determined.api.v1.Determined.PatchUser:output_type -> determined.api.v1.PatchUserResponse
	210, // 210: determined.api.v1.Determined.GetTelemetry:output_type -> determined.api.v1.GetTelemetryResponse
	211, // 211: determined.api.v1.Determined.GetMaster:output_type -> determined.api.v1.GetMasterResponse
	212, // 212: determined.api.v1.Determined.GetMasterConfig:output_type -> determined.api.v1.GetMasterConfigResponse
	213, // 213: determined.api.v1.Determined.MasterLogs:output_type -> determined.api.v1.MasterLogsResponse
	214, // 214: determined.api.v1.Determined.GetAgents:output_type -> determined.api.v1.GetAgentsResponse
	215, // 215: determined.api.v1.Determined.GetAgent:output_type -> determined.api.v1.GetAgentResponse
	216, // 216: determined.api.v1.Determined.GetSlots:output_type -> determined.api.v1.GetSlotsResponse
	217, // 217: determined.api.v1.Determined.GetSlot:output_type -> determined.api.v1.GetSlotResponse
	218, // 218: determined.api.v1.Determined.EnableAgent:output_type -> determined.api.v1.EnableAgentResponse
	219, // 219: determined.api.v1.Determined.DisableAgent:output_type -> determined.api.v1.DisableAgentResponse
	220, // 220: determined.api.v1.Determined.EnableSlot:output_type -> determined.api.v1.EnableSlotResponse
	221, // 221: determined.api.v1.Determined.DisableSlot:output_type -> determined.api.v1.DisableSlotResponse
	222, // 222: determined.api.v1.Determined.CreateExperiment:output_type -> determined.api.v1.CreateExperimentResponse
	223, // 223: determined.api.v1.Determined.GetExperiment:output_type -> determined.api.v1.GetExperimentResponse
	224, // 224: determined.api.v1.Determined.GetExperiments:output_type -> determined.api.v1.GetExperimentsResponse
	225, // 225: determined.api.v1.Determined.GetModelDef:output_type -> determined.api.v1.GetModelDefResponse
	226, // 226: determined.api.v1.Determined.GetModelDefTree:output_type -> determined.api.v1.GetModelDefTreeResponse
	227, // 227: determined.api.v1.Determined.GetModelDefFile:output_type -> determined.api.v1.GetModelDefFileResponse
	228, // 228: determined.api.v1.Determined.GetExperimentLabels:output_type -> determined.api.v1.GetExperimentLabelsResponse
	229, // 229: determined.api.v1.Determined.GetExperimentValidationHistory:output_type -> determined.api.v1.GetExperimentValidationHistoryResponse
	230, // 230: determined.api.v1.Determined.ActivateExperiment:output_type -> determined.api.v1.ActivateExperimentResponse
	231, // 231: determined.api.v1.Determined.ActivateExperiments:output_type -> determined.api.v1.ActivateExperimentsResponse
	232, // 232: determined.api.v1.Determined.PauseExperiment:output_type -> determined.api.v1.PauseExperimentResponse
	233, // 233: determined.api.v1.Determined.PauseExperiments:output_type -> determined.api.v1.PauseExperimentsResponse
	234, // 234: determined.api.v1.Determined.CancelExperiment:output_type -> determined.api.v1.CancelExperimentResponse
	235, // 235: determined.api.v1.Determined.CancelExperiments:output_type -> determined.api.v1.CancelExperimentsResponse
	236, // 236: determined.api.v1.Determined.KillExperiment:output_type -> determined.api.v1.KillExperimentResponse
	237, // 237: determined.api.v1.Determined.KillExperiments:output_type -> determined.api.v1.KillExperimentsResponse
	238, // 238: determined.api.v1.Determined.ArchiveExperiment:output_type -> determined.api.v1.ArchiveExperimentResponse
	239, // 239: determined.api.v1.Determined.ArchiveExperiments:output_type -> determined.api.v1.ArchiveExperimentsResponse
	240, // 240: determined.api.v1.Determined.UnarchiveExperiment:output_type -> determined.api.v1.UnarchiveExperimentResponse
	241, // 241: determined.api.v1.Determined.UnarchiveExperiments:output_type -> determined.api.v1.UnarchiveExperimentsResponse
	242, // 242: determined.api.v1.Determined.PatchExperiment:output_type -> determined.api.v1.PatchExperimentResponse
	243, // 243: determined.api.v1.Determined.DeleteExperiments:output_type -> determined.api.v1.DeleteExperimentsResponse
	244, // 244: determined.api.v1.Determined.DeleteExperiment:output_type -> determined.api.v1.DeleteExperimentResponse
	245, // 245: determined.api.v1.Determined.GetBestSearcherValidationMetric:output_type -> determined.api.v1.GetBestSearcherValidationMetricResponse
	246, // 246: determined.api.v1.Determined.GetExperimentCheckpoints:output_type -> determined.api.v1.GetExperimentCheckpointsResponse
	247, // 247: determined.api.v1.Determined.PreviewHPSearch:output_type -> determined.api.v1.PreviewHPSearchResponse
	248, // 248: determined.api.v1.Determined.GetExperimentTrials:output_type -> determined.api.v1.GetExperimentTrialsResponse
	249, // 249: determined.api.v1.Determined.CompareTrials:output_type -> determined.api.v1.CompareTrialsResponse
	250, // 250: determined.api.v1.Determined.QueryTrials:output_type -> determined.api.v1.QueryTrialsResponse
	251, // 251: determined.api.v1.Determined.UpdateTrialTags:output_type -> determined.api.v1.UpdateTrialTagsResponse
	252, // 252: determined.api.v1.Determined.GetTrialsCollections:output_type -> determined.api.v1.GetTrialsCollectionsResponse
	253, // 253: determined.api.v1.Determined.CreateTrialsCollection:output_type -> determined.api.v1.CreateTrialsCollectionResponse
	254, // 254: determined.api.v1.Determined.PatchTrialsCollection:output_type -> determined.api.v1.PatchTrialsCollectionResponse
	255, // 255: determined.api.v1.Determined.DeleteTrialsCollection:output_type -> determined.api.v1.DeleteTrialsCollectionResponse
	...
	261, // 261: determined.api.v1.Determined.SummarizeTrial:output_type -> determined.api.v1.SummarizeTrialResponse
	...
	363, // 363: determined.api.v1.Determined.PostProject:output_type -> determined.api.v1.PostProjectResponse
	364, // 364: determined.api.v1.Determined.AddProjectNote:output_type -> determined.api.v1.AddProjectNoteResponse
	365, // 365: determined.api.v1.Determined.PutProjectNotes:output_type -> determined.api.v1.PutProjectNotesResponse
	366, // 366: determined.api.v1.Determined.PatchProject:output_type -> determined.api.v1.PatchProjectResponse
	367, // 367: determined.api.v1.Determined.DeleteProject:output_type -> determined.api.v1.DeleteProjectResponse
	368, // 368: determined.api.v1.Determined.ArchiveProject:output_type -> determined.api.v1.ArchiveProjectResponse
	369, // 369: determined.api.v1.Determined.UnarchiveProject:output_type -> determined.api.v1.UnarchiveProjectResponse
	370, // 370: determined.api.v1.Determined.MoveProject:output_type -> determined.api.v1.MoveProjectResponse
	371, // 371: determined.api.v1.Determined.MoveExperiment:output_type -> determined.api.v1.MoveExperimentResponse
	372, // 372: determined.api.v1.Determined.MoveExperiments:output_type -> determined.api.v1.MoveExperimentsResponse
	373, // 373: determined.api.v1.Determined.GetWebhooks:output_type -> determined.api.v1.GetWebhooksResponse
	374, // 374: determined.api.v1.Determined.PostWebhook:output_type -> determined.api.v1.PostWebhookResponse
	375, // 375: determined.api.v1.Determined.DeleteWebhook:output_type -> determined.api.v1.DeleteWebhookResponse
	376, // 376: determined.api.v1.Determined.TestWebhook:output_type -> determined.api.v1.TestWebhookResponse
	377, // 377: determined.api.v1.Determined.GetGroup:output_type -> determined.api.v1.GetGroupResponse
	378, // 378: determined.api.v1.Determined.GetGroups:output_type -> determined.api.v1.GetGroupsResponse
	379, // 379: determined.api.v1.Determined.CreateGroup:output_type -> determined.api.v1.CreateGroupResponse
	380, // 380: determined.api.v1.Determined.UpdateGroup:output_type -> determined.api.v1.UpdateGroupResponse
	381, // 381: determined.api.v1.Determined.DeleteGroup:output_type -> determined.api.v1.DeleteGroupResponse
	382, // 382: determined.api.v1.Determined.GetPermissionsSummary:output_type -> determined.api.v1.GetPermissionsSummaryResponse
	383, // 383: determined.api.v1.Determined.GetGroupsAndUsersAssignedToWorkspace:output_type -> determined.api.v1.GetGroupsAndUsersAssignedToWorkspaceResponse
	384, // 384: determined.api.v1.Determined.GetRolesByID:output_type -> determined.api.v1.GetRolesByIDResponse
	385, // 385: determined.api.v1.Determined.GetRolesAssignedToUser:output_type -> determined.api.v1.GetRolesAssignedToUserResponse
	386, // 386: determined.api.v1.Determined.GetRolesAssignedToGroup:output_type -> determined.api.v1.GetRolesAssignedToGroupResponse
	387, // 387: determined.api.v1.Determined.SearchRolesAssignableToScope:output_type -> determined.api.v1.SearchRolesAssignableToScopeResponse
	388, // 388: determined.api.v1.Determined.ListRoles:output_type -> determined.api.v1.ListRolesResponse
	389, // 389: determined.api.v1.Determined.AssignRoles:output_type -> determined.api.v1.AssignRolesResponse
	390, // 390: determined.api.v1.Determined.RemoveAssignments:output_type -> determined.api.v1.RemoveAssignmentsResponse
	391, // 391: determined.api.v1.Determined.PostUserActivity:output_type -> determined.api.v1.PostUserActivityResponse
	392, // 392: determined.api.v1.Determined.GetProjectsByUserActivity:output_type -> determined.api.v1.GetProjectsByUserActivityResponse
	393, // 393: determined.api.v1.Determined.SearchExperiments:output_type -> determined.api.v1.SearchExperimentsResponse
