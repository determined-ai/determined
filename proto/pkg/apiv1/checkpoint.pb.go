...
func (x *GetTrialMetricsBySourceInfoCheckpointResponse) GetMetrics() []*trialv1.MetricsReport {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_determined_api_v1_checkpoint_proto_rawDesc = []byte{
	...
	0x74, 0x79, 0x70, 0x65, 0x22, 0x7e, 0x0a, 0x2d, 0x47, 0x65, 0x74, 0x54, 0x72, 0x69, 0x61, 0x6c,
...
var file_determined_api_v1_checkpoint_proto_depIdxs = []int32{
	...
	15, // 5: determined.api.v1.GetTrialMetricsBySourceInfoCheckpointResponse.metrics:type_name -> determined.trial.v1.MetricsReport
