...
type ReportTrialProgressRequest struct {
	...
	// Indicator for if the passed progress is raw and we want to skip any calculation by searcher.
	// Default to false.
	IsRaw bool `protobuf:"varint,3,opt,name=isRaw,proto3" json:"isRaw,omitempty"`
}
...
var file_determined_api_v1_trial_proto_rawDesc = []byte{
	...
	0x79, 0x45, 0x78, 0x69, 0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x86, 0x01,
	...
	0x65, 0x73, 0x73, 0x12, 0x14, 0x0a, 0x05, 0x69, 0x73, 0x52, 0x61, 0x77, 0x18, 0x03, 0x20, 0x01,
	0x28, 0x08, 0x52, 0x05, 0x69, 0x73, 0x52, 0x61, 0x77, 0x3a, 0x1b, 0x92, 0x41, 0x18, 0x0a, 0x16,
