...
var file_determined_api_v1_trial_proto_rawDesc = []byte{
	...
	0x69, 0x63, 0x73, 0xd2, 0x01, 0x05, 0x74, 0x72, 0x69, 0x61, 0x6c, 0x22, 0x88, 0x03, 0x0a, 0x14,
	...
	0x65, 0x12, 0x2f, 0x0a, 0x06, 0x78, 0x5f, 0x61, 0x78, 0x69, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28,
	0x0e, 0x32, 0x18, 0x2e, 0x64, 0x65, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x65, 0x64, 0x2e, 0x61,
	0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x58, 0x41, 0x78, 0x69, 0x73, 0x52, 0x05, 0x78, 0x41, 0x78,
	0x69, 0x73, 0x3a, 0x22, 0x92, 0x41, 0x1f, 0x0a, 0x1d, 0xd2, 0x01, 0x0e, 0x6d, 0x61, 0x78, 0x5f,
	...
	0x53, 0x43, 0x41, 0x4c, 0x45, 0x5f, 0x4c, 0x4f, 0x47, 0x10, 0x02, 0x2a, 0x42, 0x0a, 0x05, 0x58,
	...
	0x0a, 0x0b, 0x58, 0x5f, 0x41, 0x58, 0x49, 0x53, 0x5f, 0x54, 0x49, 0x4d, 0x45, 0x10, 0x02, 0x42,
...
var file_determined_api_v1_trial_proto_depIdxs = []int32{
	...
	86,  // 2: determined.api.v1.SummarizedMetric.type:type_name -> determined.api.v1.MetricType
	87,  // 3: determined.api.v1.WorkloadContainer.training:type_name -> determined.trial.v1.MetricsWorkload
	87,  // 4: determined.api.v1.WorkloadContainer.validation:type_name -> determined.trial.v1.MetricsWorkload
	88,  // 5: determined.api.v1.WorkloadContainer.checkpoint:type_name -> determined.trial.v1.CheckpointWorkload
	89,  // 6: determined.api.v1.ColumnFilter.filter:type_name -> determined.common.v1.DoubleFieldFilter
	2,   // 7: determined.api.v1.TrialSorter.namespace:type_name -> determined.api.v1.TrialSorter.Namespace
	90,  // 8: determined.api.v1.TrialSorter.order_by:type_name -> determined.api.v1.OrderBy
	8,   // 9: determined.api.v1.TrialFilters.validation_metrics:type_name -> determined.api.v1.ColumnFilter
	8,   // 10: determined.api.v1.TrialFilters.training_metrics:type_name -> determined.api.v1.ColumnFilter
	8,   // 11: determined.api.v1.TrialFilters.hparams:type_name -> determined.api.v1.ColumnFilter
	9,   // 12: determined.api.v1.TrialFilters.tags:type_name -> determined.api.v1.TrialTag
	82,  // 13: determined.api.v1.TrialFilters.rank_within_exp:type_name -> determined.api.v1.TrialFilters.RankWithinExp
	91,  // 14: determined.api.v1.TrialFilters.start_time:type_name -> determined.common.v1.TimestampFieldFilter
	91,  // 15: determined.api.v1.TrialFilters.end_time:type_name -> determined.common.v1.TimestampFieldFilter
	92,  // 16: determined.api.v1.TrialFilters.states:type_name -> determined.trial.v1.State
	89,  // 17: determined.api.v1.TrialFilters.searcher_metric_value:type_name -> determined.common.v1.DoubleFieldFilter
	11,  // 18: determined.api.v1.QueryTrialsRequest.filters:type_name -> determined.api.v1.TrialFilters
	10,  // 19: determined.api.v1.QueryTrialsRequest.sorter:type_name -> determined.api.v1.TrialSorter
	92,  // 20: determined.api.v1.AugmentedTrial.state:type_name -> determined.trial.v1.State
	93,  // 21: determined.api.v1.AugmentedTrial.hparams:type_name -> google.protobuf.Struct
	93,  // 22: determined.api.v1.AugmentedTrial.training_metrics:type_name -> google.protobuf.Struct
	93,  // 23: determined.api.v1.AugmentedTrial.validation_metrics:type_name -> google.protobuf.Struct
	93,  // 24: determined.api.v1.AugmentedTrial.tags:type_name -> google.protobuf.Struct
	94,  // 25: determined.api.v1.AugmentedTrial.start_time:type_name -> google.protobuf.Timestamp
	94,  // 26: determined.api.v1.AugmentedTrial.end_time:type_name -> google.protobuf.Timestamp
	13,  // 27: determined.api.v1.QueryTrialsResponse.trials:type_name -> determined.api.v1.AugmentedTrial
	9,   // 28: determined.api.v1.TrialPatch.add_tag:type_name -> determined.api.v1.TrialTag
	9,   // 29: determined.api.v1.TrialPatch.remove_tag:type_name -> determined.api.v1.TrialTag
	11,  // 30: determined.api.v1.UpdateTrialTagsRequest.filters:type_name -> determined.api.v1.TrialFilters
	83,  // 31: determined.api.v1.UpdateTrialTagsRequest.trial:type_name -> determined.api.v1.UpdateTrialTagsRequest.Ids
	15,  // 32: determined.api.v1.UpdateTrialTagsRequest.patch:type_name -> determined.api.v1.TrialPatch
	11,  // 33: determined.api.v1.TrialsCollection.filters:type_name -> determined.api.v1.TrialFilters
	10,  // 34: determined.api.v1.TrialsCollection.sorter:type_name -> determined.api.v1.TrialSorter
	18,  // 35: determined.api.v1.GetTrialsCollectionsResponse.collections:type_name -> determined.api.v1.TrialsCollection
	11,  // 36: determined.api.v1.CreateTrialsCollectionRequest.filters:type_name -> determined.api.v1.TrialFilters
	10,  // 37: determined.api.v1.CreateTrialsCollectionRequest.sorter:type_name -> determined.api.v1.TrialSorter
	18,  // 38: determined.api.v1.CreateTrialsCollectionResponse.collection:type_name -> determined.api.v1.TrialsCollection
	11,  // 39: determined.api.v1.PatchTrialsCollectionRequest.filters:type_name -> determined.api.v1.TrialFilters
	10,  // 40: determined.api.v1.PatchTrialsCollectionRequest.sorter:type_name -> determined.api.v1.TrialSorter
	18,  // 41: determined.api.v1.PatchTrialsCollectionResponse.collection:type_name -> determined.api.v1.TrialsCollection
	95,  // 42: determined.api.v1.TrialLogsRequest.levels:type_name -> determined.log.v1.LogLevel
	94,  // 43: determined.api.v1.TrialLogsRequest.timestamp_before:type_name -> google.protobuf.Timestamp
	94,  // 44: determined.api.v1.TrialLogsRequest.timestamp_after:type_name -> google.protobuf.Timestamp
	90,  // 45: determined.api.v1.TrialLogsRequest.order_by:type_name -> determined.api.v1.OrderBy
	94,  // 46: determined.api.v1.TrialLogsResponse.timestamp:type_name -> google.protobuf.Timestamp
	95,  // 47: determined.api.v1.TrialLogsResponse.level:type_name -> determined.log.v1.LogLevel
	3,   // 48: determined.api.v1.GetTrialCheckpointsRequest.sort_by:type_name -> determined.api.v1.GetTrialCheckpointsRequest.SortBy
	90,  // 49: determined.api.v1.GetTrialCheckpointsRequest.order_by:type_name -> determined.api.v1.OrderBy
	96,  // 50: determined.api.v1.GetTrialCheckpointsRequest.states:type_name -> determined.checkpoint.v1.State
	97,  // 51: determined.api.v1.GetTrialCheckpointsResponse.checkpoints:type_name -> determined.checkpoint.v1.Checkpoint
	98,  // 52: determined.api.v1.GetTrialCheckpointsResponse.pagination:type_name -> determined.api.v1.Pagination
	4,   // 53: determined.api.v1.GetExperimentTrialsRequest.sort_by:type_name -> determined.api.v1.GetExperimentTrialsRequest.SortBy
	90,  // 54: determined.api.v1.GetExperimentTrialsRequest.order_by:type_name -> determined.api.v1.OrderBy
	99,  // 55: determined.api.v1.GetExperimentTrialsRequest.states:type_name -> determined.experiment.v1.State
	100, // 56: determined.api.v1.GetExperimentTrialsResponse.trials:type_name -> determined.trial.v1.Trial
	98,  // 57: determined.api.v1.GetExperimentTrialsResponse.pagination:type_name -> determined.api.v1.Pagination
	100, // 58: determined.api.v1.GetTrialResponse.trial:type_name -> determined.trial.v1.Trial
	90,  // 59: determined.api.v1.GetTrialWorkloadsRequest.order_by:type_name -> determined.api.v1.OrderBy
	5,   // 60: determined.api.v1.GetTrialWorkloadsRequest.filter:type_name -> determined.api.v1.GetTrialWorkloadsRequest.FilterOption
	86,  // 61: determined.api.v1.GetTrialWorkloadsRequest.metric_type:type_name -> determined.api.v1.MetricType
	7,   // 62: determined.api.v1.GetTrialWorkloadsResponse.workloads:type_name -> determined.api.v1.WorkloadContainer
	98,  // 63: determined.api.v1.GetTrialWorkloadsResponse.pagination:type_name -> determined.api.v1.Pagination
	101, // 64: determined.api.v1.GetTrialProfilerMetricsRequest.labels:type_name -> determined.trial.v1.TrialProfilerMetricLabels
	102, // 65: determined.api.v1.GetTrialProfilerMetricsResponse.batch:type_name -> determined.trial.v1.TrialProfilerMetricsBatch
	101, // 66: determined.api.v1.GetTrialProfilerAvailableSeriesResponse.labels:type_name -> determined.trial.v1.TrialProfilerMetricLabels
	102, // 67: determined.api.v1.PostTrialProfilerMetricsBatchRequest.batches:type_name -> determined.trial.v1.TrialProfilerMetricsBatch
	86,  // 68: determined.api.v1.SummarizeTrialRequest.metric_type:type_name -> determined.api.v1.MetricType
	0,   // 69: determined.api.v1.SummarizeTrialRequest.scale:type_name -> determined.api.v1.Scale
	100, // 70: determined.api.v1.SummarizeTrialResponse.trial:type_name -> determined.trial.v1.Trial
	6,   // 71: determined.api.v1.SummarizeTrialResponse.metrics:type_name -> determined.api.v1.SummarizedMetric
	100, // 72: determined.api.v1.ComparableTrial.trial:type_name -> determined.trial.v1.Trial
	6,   // 73: determined.api.v1.ComparableTrial.metrics:type_name -> determined.api.v1.SummarizedMetric
	86,  // 74: determined.api.v1.CompareTrialsRequest.metric_type:type_name -> determined.api.v1.MetricType
	0,   // 75: determined.api.v1.CompareTrialsRequest.scale:type_name -> determined.api.v1.Scale
	1,   // 76: determined.api.v1.CompareTrialsRequest.x_axis:type_name -> determined.api.v1.XAxis
