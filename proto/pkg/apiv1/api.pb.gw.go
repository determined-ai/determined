...
var (
	...
	pattern_Determined_PutExperimentsRetainLogs_0 = runtime.MustPattern(runtime.NewPattern(1, []int{2, 0, 2, 1, 2, 2, 2, 3}, []string{"api", "v1", "experiments", "retain_logs"}, "", runtime.AssumeColonVerbOpt(true)))
