...
type GetProjectColumnsResponse struct {
	...
	General []projectv1.GeneralColumn `protobuf:"varint,1,rep,packed,name=general,proto3,enum=determined.project.v1.GeneralColumn" json:"general,omitempty"`
	// List of hyperparameters.
	Hyperparameters []string `protobuf:"bytes,2,rep,name=hyperparameters,proto3" json:"hyperparameters,omitempty"`
	// List of metrics.
...
func (x *GetProjectColumnsResponse) GetGeneral() []projectv1.GeneralColumn {
	if x != nil {
		return x.General
	}
	return nil
...
func (x *GetProjectColumnsResponse) GetHyperparameters() []string {
	if x != nil {
...
func (x *GetProjectColumnsResponse) GetMetrics() []string {
	if x != nil {
		return x.Metrics
	}
	return nil
...
var file_determined_api_v1_project_proto_rawDesc = []byte{
	...
	,
	...
	0x6f, 0x6a, 0x65, 0x63, 0x74, 0x73, 0x42, 0x35, 0x5a, 0x33, 0x67, 0x69, 0x74, 0x68, 0x75, 0x62,
...
var file_determined_api_v1_project_proto_goTypes = []interface{}{
	...
	(projectv1.GeneralColumn)(0),              // 23: determined.project.v1.GeneralColumn
	(*projectv1.Note)(nil),                    // 24: determined.project.v1.Note
	(*projectv1.PatchProject)(nil),            // 25: determined.project.v1.PatchProject
}
var file_determined_api_v1_project_proto_depIdxs = []int32{
	...
	23, // 1: determined.api.v1.GetProjectColumnsResponse.general:type_name -> determined.project.v1.GeneralColumn
	22, // 2: determined.api.v1.PostProjectResponse.project:type_name -> determined.project.v1.Project
	24, // 3: determined.api.v1.AddProjectNoteRequest.note:type_name -> determined.project.v1.Note
	24, // 4: determined.api.v1.AddProjectNoteResponse.notes:type_name -> determined.project.v1.Note
	24, // 5: determined.api.v1.PutProjectNotesRequest.notes:type_name -> determined.project.v1.Note
	24, // 6: determined.api.v1.PutProjectNotesResponse.notes:type_name -> determined.project.v1.Note
	25, // 7: determined.api.v1.PatchProjectRequest.project:type_name -> determined.project.v1.PatchProject
	22, // 8: determined.api.v1.PatchProjectResponse.project:type_name -> determined.project.v1.Project
	22, // 9: determined.api.v1.GetProjectsByUserActivityResponse.projects:type_name -> determined.project.v1.Project
