...
// versions:
// source: determined/job/v2/job.proto
...
func (Type) Descriptor() protoreflect.EnumDescriptor {
	return file_determined_job_v2_job_proto_enumTypes[0].Descriptor()
}

func (Type) Type() protoreflect.EnumType {
	return &file_determined_job_v2_job_proto_enumTypes[0]
}
...
func (Type) EnumDescriptor() ([]byte, []int) {
	return file_determined_job_v2_job_proto_rawDescGZIP(), []int{0}
}
...
func (State) Descriptor() protoreflect.EnumDescriptor {
	return file_determined_job_v2_job_proto_enumTypes[1].Descriptor()
}

func (State) Type() protoreflect.EnumType {
	return &file_determined_job_v2_job_proto_enumTypes[1]
}
...
func (State) EnumDescriptor() ([]byte, []int) {
	return file_determined_job_v2_job_proto_rawDescGZIP(), []int{1}
}
...
type JobSummary struct {
	...
	State State `protobuf:"varint,1,opt,name=state,proto3,enum=determined.job.v2.State" json:"state,omitempty"`
...
func (x *JobSummary) Reset() {
	*x = JobSummary{}
	if protoimpl.UnsafeEnabled {
		mi := &file_determined_job_v2_job_proto_msgTypes[0]
...
type LimitedJob struct {
	...
	// Job type.
	Type Type `protobuf:"varint,2,opt,name=type,proto3,enum=determined.job.v2.Type" json:"type,omitempty"`
	...
	IsPreemptible bool `protobuf:"varint,4,opt,name=is_preemptible,json=isPreemptible,proto3" json:"is_preemptible,omitempty"`
	...
	RequestedSlots int32 `protobuf:"varint,8,opt,name=requested_slots,json=requestedSlots,proto3" json:"requested_slots,omitempty"`
	// Number of allocated slots.
	AllocatedSlots int32 `protobuf:"varint,9,opt,name=allocated_slots,json=allocatedSlots,proto3" json:"allocated_slots,omitempty"`
	// Job's progress from 0 to 1.
	Progress float32 `protobuf:"fixed32,10,opt,name=progress,proto3" json:"progress,omitempty"`
	// Job's workspace id.
	WorkspaceId int32 `protobuf:"varint,11,opt,name=workspace_id,json=workspaceId,proto3" json:"workspace_id,omitempty"`
}

func (x *LimitedJob) Reset() {
	*x = LimitedJob{}
	if protoimpl.UnsafeEnabled {
		mi := &file_determined_job_v2_job_proto_msgTypes[1]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (x *Job) Reset() {
	*x = Job{}
	if protoimpl.UnsafeEnabled {
		mi := &file_determined_job_v2_job_proto_msgTypes[2]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*Job) Descriptor() ([]byte, []int) {
	return file_determined_job_v2_job_proto_rawDescGZIP(), []int{2}
}
...
func (x *RBACJob) Reset() {
	*x = RBACJob{}
	if protoimpl.UnsafeEnabled {
		mi := &file_determined_job_v2_job_proto_msgTypes[3]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*RBACJob) Descriptor() ([]byte, []int) {
	return file_determined_job_v2_job_proto_rawDescGZIP(), []int{3}
}
...
func (x *QueueControl) Reset() {
	*x = QueueControl{}
	if protoimpl.UnsafeEnabled {
		mi := &file_determined_job_v2_job_proto_msgTypes[4]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueueControl) Descriptor() ([]byte, []int) {
	return file_determined_job_v2_job_proto_rawDescGZIP(), []int{4}
}
...
type QueueControl_ResourcePool struct {
	...
	ResourcePool string `protobuf:"bytes,2,opt,name=resource_pool,json=resourcePool,proto3,oneof"`
}

type QueueControl_Priority struct {
	// The desired job priority in priority scheduler.
	Priority int32 `protobuf:"varint,3,opt,name=priority,proto3,oneof"`
}

type QueueControl_Weight struct {
	// The desired job weight in fairshare scheduler.
	Weight float32 `protobuf:"fixed32,4,opt,name=weight,proto3,oneof"`
}
...
func (x *QueueStats) Reset() {
	*x = QueueStats{}
	if protoimpl.UnsafeEnabled {
		mi := &file_determined_job_v2_job_proto_msgTypes[5]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*QueueStats) Descriptor() ([]byte, []int) {
	return file_determined_job_v2_job_proto_rawDescGZIP(), []int{5}
}
...
func (x *AggregateQueueStats) Reset() {
	*x = AggregateQueueStats{}
	if protoimpl.UnsafeEnabled {
		mi := &file_determined_job_v2_job_proto_msgTypes[6]
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		ms.StoreMessageInfo(mi)
	}
}
...
func (*AggregateQueueStats) Descriptor() ([]byte, []int) {
	return file_determined_job_v2_job_proto_rawDescGZIP(), []int{6}
}
...
var File_determined_job_v2_job_proto protoreflect.FileDescriptor

var file_determined_job_v2_job_proto_rawDesc = []byte{
	0x0a, 0x1b, 0x64, 0x65, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x65, 0x64, 0x2f, 0x6a, 0x6f, 0x62,
	0x2f, 0x76, 0x32, 0x2f, 0x6a, 0x6f, 0x62, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x64,
	0x65, 0x74, 0x65, 0x72, 0x6d, 0x69, 0x6e, 0x65, 0x64, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x76, 0x32,
	...
	0x6d, 0x69, 0x6e, 0x65, 0x64, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x76, 0x32, 0x2e, 0x4a, 0x6f, 0x62,
	...
	0x76, 0x32, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x23, 0x0a,
	0x0d, 0x72, 0x65, 0x73, 0x6f, 0x75, 0x72, 0x63, 0x65, 0x5f, 0x70, 0x6f, 0x6f, 0x6c, 0x18, 0x03,
	...
	0x69, 0x62, 0x6c, 0x65, 0x18, 0x04, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x69, 0x73, 0x50, 0x72,
	...
	0x06, 0x20, 0x01, 0x28, 0x01, 0x52, 0x06, 0x77, 0x65, 0x69, 0x67, 0x68, 0x74, 0x12, 0x15, 0x0a,
	...
	0x64, 0x5f, 0x73, 0x6c, 0x6f, 0x74, 0x73, 0x18, 0x08, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x72,
	...
	0x18, 0x09, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0e, 0x61, 0x6c, 0x6c, 0x6f, 0x63, 0x61, 0x74, 0x65,
	0x64, 0x53, 0x6c, 0x6f, 0x74, 0x73, 0x12, 0x1a, 0x0a, 0x08, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x18, 0x0a, 0x20, 0x01, 0x28, 0x02, 0x52, 0x08, 0x70, 0x72, 0x6f, 0x67, 0x72, 0x65,
	0x73, 0x73, 0x12, 0x21, 0x0a, 0x0c, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70, 0x61, 0x63, 0x65, 0x5f,
	0x69, 0x64, 0x18, 0x0b, 0x20, 0x01, 0x28, 0x05, 0x52, 0x0b, 0x77, 0x6f, 0x72, 0x6b, 0x73, 0x70,
	...
	0x72, 0x6d, 0x69, 0x6e, 0x65, 0x64, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x76, 0x32, 0x2e, 0x4a, 0x6f,
	...
	0x2e, 0x76, 0x32, 0x2e, 0x54, 0x79, 0x70, 0x65, 0x52, 0x04, 0x74, 0x79, 0x70, 0x65, 0x12, 0x43,
	...
	0x50, 0x6f, 0x6f, 0x6c, 0x12, 0x25, 0x0a, 0x0e, 0x69, 0x73, 0x5f, 0x70, 0x72, 0x65, 0x65, 0x6d,
	0x70, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x18, 0x06, 0x20, 0x01, 0x28, 0x08, 0x52, 0x0d, 0x69, 0x73,
	0x50, 0x72, 0x65, 0x65, 0x6d, 0x70, 0x74, 0x69, 0x62, 0x6c, 0x65, 0x12, 0x1a, 0x0a, 0x08, 0x70,
	...
	,
	...
	0x72, 0x6d, 0x69, 0x6e, 0x65, 0x64, 0x2e, 0x6a, 0x6f, 0x62, 0x2e, 0x76, 0x32, 0x2e, 0x4c, 0x69,
	0x6d, 0x69, 0x74, 0x65, 0x64, 0x4a, 0x6f, 0x62, 0x48, 0x00, 0x52, 0x07, 0x6c, 0x69, 0x6d, 0x69,
	0x74, 0x65, 0x64, 0x42, 0x05, 0x0a, 0x03, 0x6a, 0x6f, 0x62, 0x22, 0xa7, 0x01, 0x0a, 0x0c, 0x51,
	...
	,
	...
	0x0e, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65, 0x64, 0x43, 0x6f, 0x75, 0x6e, 0x74, 0x3a,
	0x26, 0x92, 0x41, 0x23, 0x0a, 0x21, 0xd2, 0x01, 0x0c, 0x71, 0x75, 0x65, 0x75, 0x65, 0x64, 0x5f,
	0x63, 0x6f, 0x75, 0x6e, 0x74, 0xd2, 0x01, 0x0f, 0x73, 0x63, 0x68, 0x65, 0x64, 0x75, 0x6c, 0x65,
	0x64, 0x5f, 0x63, 0x6f, 0x75, 0x6e, 0x74, 0x22, 0x72, 0x0a, 0x13, 0x41, 0x67, 0x67, 0x72, 0x65,
	0x67, 0x61, 0x74, 0x65, 0x51, 0x75, 0x65, 0x75, 0x65, 0x53, 0x74, 0x61, 0x74, 0x73, 0x12, 0x21,
	...
	,
	...
	0x5f, 0x51, 0x55, 0x45, 0x55, 0x45, 0x44, 0x10, 0x01, 0x12, 0x13, 0x0a, 0x0f, 0x53, 0x54, 0x41,
	0x54, 0x45, 0x5f, 0x53, 0x43, 0x48, 0x45, 0x44, 0x55, 0x4c, 0x45, 0x44, 0x10, 0x02, 0x12, 0x1e,
	0x0a, 0x1a, 0x53, 0x54, 0x41, 0x54, 0x45, 0x5f, 0x53, 0x43, 0x48, 0x45, 0x44, 0x55, 0x4c, 0x45,
	0x44, 0x5f, 0x42, 0x41, 0x43, 0x4b, 0x46, 0x49, 0x4c, 0x4c, 0x45, 0x44, 0x10, 0x03, 0x42, 0x35,
	...
	0x6a, 0x6f, 0x62, 0x76, 0x32, 0x62, 0x06, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x33,
}

var (
	file_determined_job_v2_job_proto_rawDescOnce sync.Once
	file_determined_job_v2_job_proto_rawDescData = file_determined_job_v2_job_proto_rawDesc
)

func file_determined_job_v2_job_proto_rawDescGZIP() []byte {
	file_determined_job_v2_job_proto_rawDescOnce.Do(func() {
		file_determined_job_v2_job_proto_rawDescData = protoimpl.X.CompressGZIP(file_determined_job_v2_job_proto_rawDescData)
	})
	return file_determined_job_v2_job_proto_rawDescData
}

var file_determined_job_v2_job_proto_enumTypes = make([]protoimpl.EnumInfo, 2)
var file_determined_job_v2_job_proto_msgTypes = make([]protoimpl.MessageInfo, 7)
var file_determined_job_v2_job_proto_goTypes = []interface{}{
	(Type)(0),                   // 0: determined.job.v2.Type
	(State)(0),                  // 1: determined.job.v2.State
	(*JobSummary)(nil),          // 2: determined.job.v2.JobSummary
	(*LimitedJob)(nil),          // 3: determined.job.v2.LimitedJob
	(*Job)(nil),                 // 4: determined.job.v2.Job
	(*RBACJob)(nil),             // 5: determined.job.v2.RBACJob
	(*QueueControl)(nil),        // 6: determined.job.v2.QueueControl
	(*QueueStats)(nil),          // 7: determined.job.v2.QueueStats
	(*AggregateQueueStats)(nil), // 8: determined.job.v2.AggregateQueueStats
	(*timestamp.Timestamp)(nil), // 9: google.protobuf.Timestamp
}
var file_determined_job_v2_job_proto_depIdxs = []int32{
	1, // 0: determined.job.v2.JobSummary.state:type_name -> determined.job.v2.State
	2, // 1: determined.job.v2.LimitedJob.summary:type_name -> determined.job.v2.JobSummary
	0, // 2: determined.job.v2.LimitedJob.type:type_name -> determined.job.v2.Type
	2, // 3: determined.job.v2.Job.summary:type_name -> determined.job.v2.JobSummary
	0, // 4: determined.job.v2.Job.type:type_name -> determined.job.v2.Type
	9, // 5: determined.job.v2.Job.submission_time:type_name -> google.protobuf.Timestamp
	4, // 6: determined.job.v2.RBACJob.full:type_name -> determined.job.v2.Job
	3, // 7: determined.job.v2.RBACJob.limited:type_name -> determined.job.v2.LimitedJob
...
func init() { file_determined_job_v2_job_proto_init() }
func file_determined_job_v2_job_proto_init() {
	if File_determined_job_v2_job_proto != nil {
		return
	}
	if !protoimpl.UnsafeEnabled {
		file_determined_job_v2_job_proto_msgTypes[0].Exporter = func(v interface{}, i int) interface{} {
		...
		file_determined_job_v2_job_proto_msgTypes[1].Exporter = func(v interface{}, i int) interface{} {
		...
		file_determined_job_v2_job_proto_msgTypes[2].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*Job); i {
			case 0:
				return &v.state
			case 1:
		...
		file_determined_job_v2_job_proto_msgTypes[3].Exporter = func(v interface{}, i int) interface{} {
		...
		file_determined_job_v2_job_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
		...
		file_determined_job_v2_job_proto_msgTypes[5].Exporter = func(v interface{}, i int) interface{} {
		...
		file_determined_job_v2_job_proto_msgTypes[6].Exporter = func(v interface{}, i int) interface{} {
	...
	file_determined_job_v2_job_proto_msgTypes[3].OneofWrappers = []interface{}{
		(*RBACJob_Full)(nil),
		(*RBACJob_Limited)(nil),
	}
	file_determined_job_v2_job_proto_msgTypes[4].OneofWrappers = []interface{}{
	...
	out := protoimpl.TypeBuilder{
		File: protoimpl.DescBuilder{
			...
			RawDescriptor: file_determined_job_v2_job_proto_rawDesc,
			NumEnums:      2,
			NumMessages:   7,
			NumExtensions: 0,
			NumServices:   0,
		},
		GoTypes:           file_determined_job_v2_job_proto_goTypes,
		DependencyIndexes: file_determined_job_v2_job_proto_depIdxs,
		EnumInfos:         file_determined_job_v2_job_proto_enumTypes,
		MessageInfos:      file_determined_job_v2_job_proto_msgTypes,
	}.Build()
	File_determined_job_v2_job_proto = out.File
	file_determined_job_v2_job_proto_rawDesc = nil
	file_determined_job_v2_job_proto_goTypes = nil
	file_determined_job_v2_job_proto_depIdxs = nil
}
