...
type LongLivedTokenInfo struct {
	state         protoimpl.MessageState
	sizeCache     protoimpl.SizeCache
	unknownFields protoimpl.UnknownFields
...
func (x *LongLivedTokenInfo) Reset() {
	*x = LongLivedTokenInfo{}
	if protoimpl.UnsafeEnabled {
...
func (x *LongLivedTokenInfo) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*LongLivedTokenInfo) ProtoMessage() {}

func (x *LongLivedTokenInfo) ProtoReflect() protoreflect.Message {
	mi := &file_determined_user_v1_user_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use LongLivedTokenInfo.ProtoReflect.Descriptor instead.
func (*LongLivedTokenInfo) Descriptor() ([]byte, []int) {
	return file_determined_user_v1_user_proto_rawDescGZIP(), []int{4}
}

func (x *LongLivedTokenInfo) GetId() int32 {
	if x != nil {
		return x.Id
	}
	return 0
...
func (x *LongLivedTokenInfo) GetUserId() int32 {
	if x != nil {
		return x.UserId
	}
	return 0
...
func (x *LongLivedTokenInfo) GetExpiresAt() *timestamp.Timestamp {
	if x != nil {
		return x.ExpiresAt
	}
	return nil
...
func (x *LongLivedTokenInfo) GetCreatedAt() *timestamp.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
var file_determined_user_v1_user_proto_rawDesc = []byte{
	...
	0x03, 0x6b, 0x65, 0x79, 0x22, 0xbf, 0x01, 0x0a, 0x12, 0x4c, 0x6f, 0x6e, 0x67, 0x4c, 0x69, 0x76,
	0x65, 0x64, 0x54, 0x6f, 0x6b, 0x65, 0x6e, 0x49, 0x6e, 0x66, 0x6f, 0x12, 0x0e, 0x0a, 0x02, 0x69,
	...
	0x09, 0x63, 0x72, 0x65, 0x61, 0x74, 0x65, 0x64, 0x41, 0x74, 0x3a, 0x0a, 0x92, 0x41, 0x07, 0x0a,
...
var file_determined_user_v1_user_proto_goTypes = []interface{}{
	...
	(*LongLivedTokenInfo)(nil),  // 6: determined.user.v1.LongLivedTokenInfo
...
var file_determined_user_v1_user_proto_depIdxs = []int32{
	...
	7, // 1: determined.user.v1.User.modified_at:type_name -> google.protobuf.Timestamp
	7, // 2: determined.user.v1.User.last_auth_at:type_name -> google.protobuf.Timestamp
	8, // 3: determined.user.v1.PatchUser.admin:type_name -> google.protobuf.BoolValue
	8, // 4: determined.user.v1.PatchUser.active:type_name -> google.protobuf.BoolValue
	4, // 5: determined.user.v1.PatchUser.agent_user_group:type_name -> determined.user.v1.AgentUserGroup
	7, // 6: determined.user.v1.LongLivedTokenInfo.expires_at:type_name -> google.protobuf.Timestamp
	7, // 7: determined.user.v1.LongLivedTokenInfo.created_at:type_name -> google.protobuf.Timestamp
...
func file_determined_user_v1_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_determined_user_v1_user_proto_msgTypes[4].Exporter = func(v interface{}, i int) interface{} {
			switch v := v.(*LongLivedTokenInfo); i {
			case 0:
				return &v.state
			case 1:
				return &v.sizeCache
